...
import (
	...
	"github.com/appwrite/sdk-for-cli/internal/client"
	"github.com/appwrite/sdk-for-cli/internal/cmd/services"
...
// lazy construction would add complexity to generated code for no measurable
// gain.
func NewRootCommand() *cobra.Command {
	root := &cobra.Command{
		Use:     "appwrite",
		Short:   "Appwrite is an open-source self-hosted backend server that abstracts and simplifies complex and repetitive development tasks behind a very simple REST API",
		Version: app.Version,
