...
//
// Ports the Collection interface (attributes.ts:109), reduced to the three
...
//
// Ports getConfirmation (attributes.ts:147). --force is checked by the caller
...
//
// Ports Promise.allSettled: a failure does not cancel the rest, because the
