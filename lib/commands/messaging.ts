...
export const messagingListMessages = async ({
  queries,
  search,
  total,
  parseOutput = true,
  ...
  sdk = undefined,
  console: showConsole,
}: MessagingListMessagesRequestParams): Promise<any> => {
...
export const messagingCreateEmail = async ({
  messageId,
  subject,
  content,
  topics,
  ...
  overrideForCli = false,
  sdk = undefined,
}: MessagingCreateEmailRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const messagingUpdateEmail = async ({
  messageId,
  topics,
  users,
  targets,
  ...
  overrideForCli = false,
  sdk = undefined,
}: MessagingUpdateEmailRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/messaging/messages/email/{messageId}".replace(
    "{messageId}",
    messageId,
  );
  let payload = {};
...
export const messagingCreatePush = async ({
  messageId,
  title,
  body,
  topics,
  ...
  overrideForCli = false,
  sdk = undefined,
}: MessagingCreatePushRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const messagingUpdatePush = async ({
  messageId,
  topics,
  users,
  targets,
  ...
  overrideForCli = false,
  sdk = undefined,
}: MessagingUpdatePushRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/messaging/messages/push/{messageId}".replace(
    "{messageId}",
    messageId,
  );
  let payload = {};
...
export const messagingCreateSMS = async ({
  messageId,
  content,
  topics,
  users,
  ...
  overrideForCli = false,
  sdk = undefined,
}: MessagingCreateSMSRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const messagingUpdateSMS = async ({
  messageId,
  topics,
  users,
  targets,
  ...
  overrideForCli = false,
  sdk = undefined,
}: MessagingUpdateSMSRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/messaging/messages/sms/{messageId}".replace(
    "{messageId}",
    messageId,
  );
  let payload = {};
...
export const messagingGetMessage = async ({
  messageId,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
  console: showConsole,
}: MessagingGetMessageRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/messaging/messages/{messageId}".replace(
    "{messageId}",
    messageId,
  );
  let payload = {};
...
export const messagingDelete = async ({
  messageId,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: MessagingDeleteRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/messaging/messages/{messageId}".replace(
    "{messageId}",
    messageId,
...
export const messagingListMessageLogs = async ({
  messageId,
  queries,
  total,
  parseOutput = true,
  ...
  sdk = undefined,
  console: showConsole,
}: MessagingListMessageLogsRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/messaging/messages/{messageId}/logs".replace(
    "{messageId}",
    messageId,
  );
  let payload = {};
...
export const messagingListTargets = async ({
  messageId,
  queries,
  total,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: MessagingListTargetsRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/messaging/messages/{messageId}/targets".replace(
    "{messageId}",
    messageId,
  );
  let payload = {};
...
export const messagingListProviders = async ({
  queries,
  search,
  total,
  parseOutput = true,
  ...
  sdk = undefined,
  console: showConsole,
}: MessagingListProvidersRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const messagingCreateAPNSProvider = async ({
  providerId,
  name,
  authKey,
  authKeyId,
  ...
  overrideForCli = false,
  sdk = undefined,
}: MessagingCreateAPNSProviderRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const messagingUpdateAPNSProvider = async ({
  providerId,
  name,
  enabled,
  authKey,
  ...
  overrideForCli = false,
  sdk = undefined,
}: MessagingUpdateAPNSProviderRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/messaging/providers/apns/{providerId}".replace(
    "{providerId}",
    providerId,
  );
  let payload = {};
...
export const messagingCreateFCMProvider = async ({
  providerId,
  name,
  serviceAccountJSON,
  enabled,
  ...
  overrideForCli = false,
  sdk = undefined,
}: MessagingCreateFCMProviderRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const messagingUpdateFCMProvider = async ({
  providerId,
  name,
  enabled,
  serviceAccountJSON,
  ...
  overrideForCli = false,
  sdk = undefined,
}: MessagingUpdateFCMProviderRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/messaging/providers/fcm/{providerId}".replace(
    "{providerId}",
    providerId,
  );
  let payload = {};
...
export const messagingCreateMailgunProvider = async ({
  providerId,
  name,
  apiKey,
  domain,
  ...
  overrideForCli = false,
  sdk = undefined,
}: MessagingCreateMailgunProviderRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const messagingUpdateMailgunProvider = async ({
  providerId,
  name,
  apiKey,
  domain,
  ...
  overrideForCli = false,
  sdk = undefined,
}: MessagingUpdateMailgunProviderRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/messaging/providers/mailgun/{providerId}".replace(
    "{providerId}",
    providerId,
  );
  let payload = {};
...
export const messagingCreateMsg91Provider = async ({
  providerId,
  name,
  templateId,
  senderId,
  ...
  overrideForCli = false,
  sdk = undefined,
}: MessagingCreateMsg91ProviderRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const messagingUpdateMsg91Provider = async ({
  providerId,
  name,
  enabled,
  templateId,
  ...
  overrideForCli = false,
  sdk = undefined,
}: MessagingUpdateMsg91ProviderRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/messaging/providers/msg91/{providerId}".replace(
    "{providerId}",
    providerId,
  );
  let payload = {};
...
export const messagingCreateResendProvider = async ({
  providerId,
  name,
  apiKey,
  fromName,
  ...
  overrideForCli = false,
  sdk = undefined,
}: MessagingCreateResendProviderRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const messagingUpdateResendProvider = async ({
  providerId,
  name,
  enabled,
  apiKey,
  ...
  overrideForCli = false,
  sdk = undefined,
}: MessagingUpdateResendProviderRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/messaging/providers/resend/{providerId}".replace(
    "{providerId}",
    providerId,
  );
  let payload = {};
...
export const messagingCreateSendgridProvider = async ({
  providerId,
  name,
  apiKey,
  fromName,
  ...
  overrideForCli = false,
  sdk = undefined,
}: MessagingCreateSendgridProviderRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const messagingUpdateSendgridProvider = async ({
  providerId,
  name,
  enabled,
  apiKey,
  ...
  overrideForCli = false,
  sdk = undefined,
}: MessagingUpdateSendgridProviderRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/messaging/providers/sendgrid/{providerId}".replace(
    "{providerId}",
    providerId,
  );
  let payload = {};
...
export const messagingCreateSMTPProvider = async ({
  providerId,
  name,
  host,
  port,
  ...
  overrideForCli = false,
  sdk = undefined,
}: MessagingCreateSMTPProviderRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const messagingUpdateSMTPProvider = async ({
  providerId,
  name,
  host,
  port,
  ...
  overrideForCli = false,
  sdk = undefined,
}: MessagingUpdateSMTPProviderRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/messaging/providers/smtp/{providerId}".replace(
    "{providerId}",
    providerId,
  );
  let payload = {};
...
export const messagingCreateTelesignProvider = async ({
  providerId,
  name,
  from,
  customerId,
  ...
  overrideForCli = false,
  sdk = undefined,
}: MessagingCreateTelesignProviderRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const messagingUpdateTelesignProvider = async ({
  providerId,
  name,
  enabled,
  customerId,
  ...
  overrideForCli = false,
  sdk = undefined,
}: MessagingUpdateTelesignProviderRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/messaging/providers/telesign/{providerId}".replace(
    "{providerId}",
    providerId,
  );
  let payload = {};
...
export const messagingCreateTextmagicProvider = async ({
  providerId,
  name,
  from,
  username,
  ...
  overrideForCli = false,
  sdk = undefined,
}: MessagingCreateTextmagicProviderRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const messagingUpdateTextmagicProvider = async ({
  providerId,
  name,
  enabled,
  username,
  ...
  overrideForCli = false,
  sdk = undefined,
}: MessagingUpdateTextmagicProviderRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/messaging/providers/textmagic/{providerId}".replace(
    "{providerId}",
    providerId,
  );
  let payload = {};
...
export const messagingCreateTwilioProvider = async ({
  providerId,
  name,
  from,
  accountSid,
  ...
  overrideForCli = false,
  sdk = undefined,
}: MessagingCreateTwilioProviderRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const messagingUpdateTwilioProvider = async ({
  providerId,
  name,
  enabled,
  accountSid,
  ...
  overrideForCli = false,
  sdk = undefined,
}: MessagingUpdateTwilioProviderRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/messaging/providers/twilio/{providerId}".replace(
    "{providerId}",
    providerId,
  );
  let payload = {};
...
export const messagingCreateVonageProvider = async ({
  providerId,
  name,
  from,
  apiKey,
  ...
  overrideForCli = false,
  sdk = undefined,
}: MessagingCreateVonageProviderRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const messagingUpdateVonageProvider = async ({
  providerId,
  name,
  enabled,
  apiKey,
  ...
  overrideForCli = false,
  sdk = undefined,
}: MessagingUpdateVonageProviderRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/messaging/providers/vonage/{providerId}".replace(
    "{providerId}",
    providerId,
  );
  let payload = {};
...
export const messagingGetProvider = async ({
  providerId,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
  console: showConsole,
}: MessagingGetProviderRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/messaging/providers/{providerId}".replace(
    "{providerId}",
    providerId,
  );
  let payload = {};
...
export const messagingDeleteProvider = async ({
  providerId,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: MessagingDeleteProviderRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/messaging/providers/{providerId}".replace(
    "{providerId}",
    providerId,
...
export const messagingListProviderLogs = async ({
  providerId,
  queries,
  total,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: MessagingListProviderLogsRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/messaging/providers/{providerId}/logs".replace(
    "{providerId}",
    providerId,
  );
  let payload = {};
...
export const messagingListSubscriberLogs = async ({
  subscriberId,
  queries,
  total,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: MessagingListSubscriberLogsRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/messaging/subscribers/{subscriberId}/logs".replace(
    "{subscriberId}",
    subscriberId,
  );
  let payload = {};
...
export const messagingListTopics = async ({
  queries,
  search,
  total,
  parseOutput = true,
  ...
  sdk = undefined,
  console: showConsole,
}: MessagingListTopicsRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const messagingCreateTopic = async ({
  topicId,
  name,
  subscribe,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: MessagingCreateTopicRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/messaging/topics";
  let payload = {};
...
export const messagingGetTopic = async ({
  topicId,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
  console: showConsole,
}: MessagingGetTopicRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const messagingUpdateTopic = async ({
  topicId,
  name,
  subscribe,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: MessagingUpdateTopicRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/messaging/topics/{topicId}".replace("{topicId}", topicId);
  let payload = {};
  if (typeof name !== "undefined") {
...
export const messagingDeleteTopic = async ({
  topicId,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: MessagingDeleteTopicRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/messaging/topics/{topicId}".replace("{topicId}", topicId);
  let payload = {};
...
export const messagingListTopicLogs = async ({
  topicId,
  queries,
  total,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: MessagingListTopicLogsRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/messaging/topics/{topicId}/logs".replace(
    "{topicId}",
    topicId,
  );
  let payload = {};
...
export const messagingListSubscribers = async ({
  topicId,
  queries,
  search,
  total,
  ...
  sdk = undefined,
  console: showConsole,
}: MessagingListSubscribersRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/messaging/topics/{topicId}/subscribers".replace(
    "{topicId}",
    topicId,
  );
  let payload = {};
...
export const messagingCreateSubscriber = async ({
  topicId,
  subscriberId,
  targetId,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: MessagingCreateSubscriberRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/messaging/topics/{topicId}/subscribers".replace(
    "{topicId}",
    topicId,
...
export const messagingGetSubscriber = async ({
  topicId,
  subscriberId,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: MessagingGetSubscriberRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const messagingDeleteSubscriber = async ({
  topicId,
  subscriberId,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: MessagingDeleteSubscriberRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/messaging/topics/{topicId}/subscribers/{subscriberId}"
    .replace("{topicId}", topicId)
    .replace("{subscriberId}", subscriberId);
