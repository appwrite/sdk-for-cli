...
account
    ...
    .requiredOption(`--userId <userId>`, `Unique Id. Choose your own unique ID or pass the string 'ID.unique()' to auto generate it. Valid chars are a-z, A-Z, 0-9, period, hyphen, and underscore. Can't start with a special char. Max length is 36 chars.`)
