...
export const tablesDBList = async ({
  queries,
  search,
  total,
  parseOutput = true,
  ...
  sdk = undefined,
  console: showConsole,
}: TablesDBListRequestParams): Promise<any> => {
...
export const tablesDBCreate = async ({
  databaseId,
  name,
  enabled,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: TablesDBCreateRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/tablesdb";
  let payload = {};
...
export const tablesDBListTransactions = async ({
  queries,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
  console: showConsole,
}: TablesDBListTransactionsRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const tablesDBCreateTransaction = async ({
  ttl,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: TablesDBCreateTransactionRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/tablesdb/transactions";
  let payload = {};
...
export const tablesDBGetTransaction = async ({
  transactionId,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
  console: showConsole,
}: TablesDBGetTransactionRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/tablesdb/transactions/{transactionId}".replace(
    "{transactionId}",
    transactionId,
  );
  let payload = {};
...
export const tablesDBUpdateTransaction = async ({
  transactionId,
  commit,
  rollback,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: TablesDBUpdateTransactionRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/tablesdb/transactions/{transactionId}".replace(
    "{transactionId}",
    transactionId,
...
export const tablesDBDeleteTransaction = async ({
  transactionId,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: TablesDBDeleteTransactionRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/tablesdb/transactions/{transactionId}".replace(
    "{transactionId}",
    transactionId,
...
export const tablesDBCreateOperations = async ({
  transactionId,
  operations,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: TablesDBCreateOperationsRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/tablesdb/transactions/{transactionId}/operations".replace(
    "{transactionId}",
    transactionId,
  );
  let payload = {};
...
export const tablesDBListUsage = async ({
  range,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
  console: showConsole,
}: TablesDBListUsageRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const tablesDBGet = async ({
  databaseId,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
  console: showConsole,
}: TablesDBGetRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const tablesDBUpdate = async ({
  databaseId,
  name,
  enabled,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: TablesDBUpdateRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/tablesdb/{databaseId}".replace("{databaseId}", databaseId);
  let payload = {};
  if (typeof name !== "undefined") {
...
export const tablesDBDelete = async ({
  databaseId,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: TablesDBDeleteRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/tablesdb/{databaseId}".replace("{databaseId}", databaseId);
  let payload = {};
...
export const tablesDBListTables = async ({
  databaseId,
  queries,
  search,
  total,
  ...
  sdk = undefined,
  console: showConsole,
}: TablesDBListTablesRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/tablesdb/{databaseId}/tables".replace(
    "{databaseId}",
    databaseId,
  );
  let payload = {};
...
export const tablesDBCreateTable = async ({
  databaseId,
  tableId,
  name,
  permissions,
  ...
  overrideForCli = false,
  sdk = undefined,
}: TablesDBCreateTableRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/tablesdb/{databaseId}/tables".replace(
    "{databaseId}",
    databaseId,
...
export const tablesDBGetTable = async ({
  databaseId,
  tableId,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
  console: showConsole,
}: TablesDBGetTableRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const tablesDBUpdateTable = async ({
  databaseId,
  tableId,
  name,
  permissions,
  ...
  overrideForCli = false,
  sdk = undefined,
}: TablesDBUpdateTableRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/tablesdb/{databaseId}/tables/{tableId}"
    .replace("{databaseId}", databaseId)
    .replace("{tableId}", tableId);
...
export const tablesDBDeleteTable = async ({
  databaseId,
  tableId,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: TablesDBDeleteTableRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/tablesdb/{databaseId}/tables/{tableId}"
    .replace("{databaseId}", databaseId)
    .replace("{tableId}", tableId);
...
export const tablesDBListColumns = async ({
  databaseId,
  tableId,
  queries,
  total,
  ...
  sdk = undefined,
  console: showConsole,
}: TablesDBListColumnsRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const tablesDBCreateBooleanColumn = async ({
  databaseId,
  tableId,
  key,
  required,
  ...
  overrideForCli = false,
  sdk = undefined,
}: TablesDBCreateBooleanColumnRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const tablesDBUpdateBooleanColumn = async ({
  databaseId,
  tableId,
  key,
  required,
  ...
  overrideForCli = false,
  sdk = undefined,
}: TablesDBUpdateBooleanColumnRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const tablesDBCreateDatetimeColumn = async ({
  databaseId,
  tableId,
  key,
  required,
  ...
  overrideForCli = false,
  sdk = undefined,
}: TablesDBCreateDatetimeColumnRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const tablesDBUpdateDatetimeColumn = async ({
  databaseId,
  tableId,
  key,
  required,
  ...
  overrideForCli = false,
  sdk = undefined,
}: TablesDBUpdateDatetimeColumnRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const tablesDBCreateEmailColumn = async ({
  databaseId,
  tableId,
  key,
  required,
  ...
  overrideForCli = false,
  sdk = undefined,
}: TablesDBCreateEmailColumnRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const tablesDBUpdateEmailColumn = async ({
  databaseId,
  tableId,
  key,
  required,
  ...
  overrideForCli = false,
  sdk = undefined,
}: TablesDBUpdateEmailColumnRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const tablesDBCreateEnumColumn = async ({
  databaseId,
  tableId,
  key,
  elements,
  ...
  overrideForCli = false,
  sdk = undefined,
}: TablesDBCreateEnumColumnRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const tablesDBUpdateEnumColumn = async ({
  databaseId,
  tableId,
  key,
  elements,
  ...
  overrideForCli = false,
  sdk = undefined,
}: TablesDBUpdateEnumColumnRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const tablesDBCreateFloatColumn = async ({
  databaseId,
  tableId,
  key,
  required,
  ...
  overrideForCli = false,
  sdk = undefined,
}: TablesDBCreateFloatColumnRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const tablesDBUpdateFloatColumn = async ({
  databaseId,
  tableId,
  key,
  required,
  ...
  overrideForCli = false,
  sdk = undefined,
}: TablesDBUpdateFloatColumnRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const tablesDBCreateIntegerColumn = async ({
  databaseId,
  tableId,
  key,
  required,
  ...
  overrideForCli = false,
  sdk = undefined,
}: TablesDBCreateIntegerColumnRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const tablesDBUpdateIntegerColumn = async ({
  databaseId,
  tableId,
  key,
  required,
  ...
  overrideForCli = false,
  sdk = undefined,
}: TablesDBUpdateIntegerColumnRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const tablesDBCreateIpColumn = async ({
  databaseId,
  tableId,
  key,
  required,
  ...
  overrideForCli = false,
  sdk = undefined,
}: TablesDBCreateIpColumnRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const tablesDBUpdateIpColumn = async ({
  databaseId,
  tableId,
  key,
  required,
  ...
  overrideForCli = false,
  sdk = undefined,
}: TablesDBUpdateIpColumnRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const tablesDBCreateLineColumn = async ({
  databaseId,
  tableId,
  key,
  required,
  ...
  overrideForCli = false,
  sdk = undefined,
}: TablesDBCreateLineColumnRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const tablesDBUpdateLineColumn = async ({
  databaseId,
  tableId,
  key,
  required,
  ...
  overrideForCli = false,
  sdk = undefined,
}: TablesDBUpdateLineColumnRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const tablesDBCreatePointColumn = async ({
  databaseId,
  tableId,
  key,
  required,
  ...
  overrideForCli = false,
  sdk = undefined,
}: TablesDBCreatePointColumnRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const tablesDBUpdatePointColumn = async ({
  databaseId,
  tableId,
  key,
  required,
  ...
  overrideForCli = false,
  sdk = undefined,
}: TablesDBUpdatePointColumnRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const tablesDBCreatePolygonColumn = async ({
  databaseId,
  tableId,
  key,
  required,
  ...
  overrideForCli = false,
  sdk = undefined,
}: TablesDBCreatePolygonColumnRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const tablesDBUpdatePolygonColumn = async ({
  databaseId,
  tableId,
  key,
  required,
  ...
  overrideForCli = false,
  sdk = undefined,
}: TablesDBUpdatePolygonColumnRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const tablesDBCreateRelationshipColumn = async ({
  databaseId,
  tableId,
  relatedTableId,
  type,
  ...
  overrideForCli = false,
  sdk = undefined,
}: TablesDBCreateRelationshipColumnRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const tablesDBCreateStringColumn = async ({
  databaseId,
  tableId,
  key,
  size,
  ...
  overrideForCli = false,
  sdk = undefined,
}: TablesDBCreateStringColumnRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const tablesDBUpdateStringColumn = async ({
  databaseId,
  tableId,
  key,
  required,
  ...
  overrideForCli = false,
  sdk = undefined,
}: TablesDBUpdateStringColumnRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const tablesDBCreateUrlColumn = async ({
  databaseId,
  tableId,
  key,
  required,
  ...
  overrideForCli = false,
  sdk = undefined,
}: TablesDBCreateUrlColumnRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const tablesDBUpdateUrlColumn = async ({
  databaseId,
  tableId,
  key,
  required,
  ...
  overrideForCli = false,
  sdk = undefined,
}: TablesDBUpdateUrlColumnRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const tablesDBGetColumn = async ({
  databaseId,
  tableId,
  key,
  parseOutput = true,
  ...
  sdk = undefined,
  console: showConsole,
}: TablesDBGetColumnRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const tablesDBDeleteColumn = async ({
  databaseId,
  tableId,
  key,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: TablesDBDeleteColumnRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/tablesdb/{databaseId}/tables/{tableId}/columns/{key}"
    .replace("{databaseId}", databaseId)
    .replace("{tableId}", tableId)
...
export const tablesDBUpdateRelationshipColumn = async ({
  databaseId,
  tableId,
  key,
  onDelete,
  ...
  overrideForCli = false,
  sdk = undefined,
}: TablesDBUpdateRelationshipColumnRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath =
...
export const tablesDBListIndexes = async ({
  databaseId,
  tableId,
  queries,
  total,
  ...
  sdk = undefined,
  console: showConsole,
}: TablesDBListIndexesRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const tablesDBCreateIndex = async ({
  databaseId,
  tableId,
  key,
  type,
  ...
  overrideForCli = false,
  sdk = undefined,
}: TablesDBCreateIndexRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/tablesdb/{databaseId}/tables/{tableId}/indexes"
    .replace("{databaseId}", databaseId)
    .replace("{tableId}", tableId);
...
export const tablesDBGetIndex = async ({
  databaseId,
  tableId,
  key,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: TablesDBGetIndexRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const tablesDBDeleteIndex = async ({
  databaseId,
  tableId,
  key,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: TablesDBDeleteIndexRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/tablesdb/{databaseId}/tables/{tableId}/indexes/{key}"
    .replace("{databaseId}", databaseId)
    .replace("{tableId}", tableId)
...
export const tablesDBListTableLogs = async ({
  databaseId,
  tableId,
  queries,
  parseOutput = true,
  ...
  sdk = undefined,
  console: showConsole,
}: TablesDBListTableLogsRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const tablesDBListRows = async ({
  databaseId,
  tableId,
  queries,
  transactionId,
  ...
  sdk = undefined,
  console: showConsole,
}: TablesDBListRowsRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const tablesDBCreateRow = async ({
  databaseId,
  tableId,
  rowId,
  data,
  ...
  overrideForCli = false,
  sdk = undefined,
}: TablesDBCreateRowRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/tablesdb/{databaseId}/tables/{tableId}/rows"
    .replace("{databaseId}", databaseId)
    .replace("{tableId}", tableId);
...
export const tablesDBCreateRows = async ({
  databaseId,
  tableId,
  rows,
  transactionId,
  ...
  overrideForCli = false,
  sdk = undefined,
}: TablesDBCreateRowsRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/tablesdb/{databaseId}/tables/{tableId}/rows"
    .replace("{databaseId}", databaseId)
    .replace("{tableId}", tableId);
...
export const tablesDBUpsertRows = async ({
  databaseId,
  tableId,
  rows,
  transactionId,
  ...
  overrideForCli = false,
  sdk = undefined,
}: TablesDBUpsertRowsRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/tablesdb/{databaseId}/tables/{tableId}/rows"
    .replace("{databaseId}", databaseId)
    .replace("{tableId}", tableId);
...
export const tablesDBUpdateRows = async ({
  databaseId,
  tableId,
  data,
  queries,
  ...
  overrideForCli = false,
  sdk = undefined,
}: TablesDBUpdateRowsRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/tablesdb/{databaseId}/tables/{tableId}/rows"
    .replace("{databaseId}", databaseId)
    .replace("{tableId}", tableId);
...
export const tablesDBDeleteRows = async ({
  databaseId,
  tableId,
  queries,
  transactionId,
  ...
  overrideForCli = false,
  sdk = undefined,
}: TablesDBDeleteRowsRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/tablesdb/{databaseId}/tables/{tableId}/rows"
    .replace("{databaseId}", databaseId)
    .replace("{tableId}", tableId);
...
export const tablesDBGetRow = async ({
  databaseId,
  tableId,
  rowId,
  queries,
  ...
  sdk = undefined,
  console: showConsole,
}: TablesDBGetRowRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const tablesDBUpsertRow = async ({
  databaseId,
  tableId,
  rowId,
  data,
  ...
  overrideForCli = false,
  sdk = undefined,
}: TablesDBUpsertRowRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/tablesdb/{databaseId}/tables/{tableId}/rows/{rowId}"
    .replace("{databaseId}", databaseId)
    .replace("{tableId}", tableId)
...
export const tablesDBUpdateRow = async ({
  databaseId,
  tableId,
  rowId,
  data,
  ...
  overrideForCli = false,
  sdk = undefined,
}: TablesDBUpdateRowRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/tablesdb/{databaseId}/tables/{tableId}/rows/{rowId}"
    .replace("{databaseId}", databaseId)
    .replace("{tableId}", tableId)
...
export const tablesDBDeleteRow = async ({
  databaseId,
  tableId,
  rowId,
  transactionId,
  ...
  overrideForCli = false,
  sdk = undefined,
}: TablesDBDeleteRowRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/tablesdb/{databaseId}/tables/{tableId}/rows/{rowId}"
    .replace("{databaseId}", databaseId)
    .replace("{tableId}", tableId)
...
export const tablesDBListRowLogs = async ({
  databaseId,
  tableId,
  rowId,
  queries,
  ...
  sdk = undefined,
  console: showConsole,
}: TablesDBListRowLogsRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const tablesDBDecrementRowColumn = async ({
  databaseId,
  tableId,
  rowId,
  column,
  ...
  overrideForCli = false,
  sdk = undefined,
}: TablesDBDecrementRowColumnRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath =
...
export const tablesDBIncrementRowColumn = async ({
  databaseId,
  tableId,
  rowId,
  column,
  ...
  overrideForCli = false,
  sdk = undefined,
}: TablesDBIncrementRowColumnRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath =
...
export const tablesDBGetTableUsage = async ({
  databaseId,
  tableId,
  range,
  parseOutput = true,
  ...
  sdk = undefined,
  console: showConsole,
}: TablesDBGetTableUsageRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const tablesDBGetUsage = async ({
  databaseId,
  range,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: TablesDBGetUsageRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/tablesdb/{databaseId}/usage".replace(
    "{databaseId}",
    databaseId,
  );
  let payload = {};
