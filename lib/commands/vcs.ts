...
export const vcsCreateRepositoryDetection = async ({
  installationId,
  ...
  sdk = undefined,
}: VcsCreateRepositoryDetectionRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/vcs/github/installations/{installationId}/detections".replace(
    "{installationId}",
    installationId,
  );
  let payload = {};
...
export const vcsListRepositories = async ({
  installationId,
  type,
  search,
  queries,
  ...
  overrideForCli = false,
  sdk = undefined,
}: VcsListRepositoriesRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath =
...
export const vcsCreateRepository = async ({
  installationId,
  name,
  xprivate,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: VcsCreateRepositoryRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath =
    "/vcs/github/installations/{installationId}/providerRepositories".replace(
      "{installationId}",
...
export const vcsGetRepository = async ({
  installationId,
  providerRepositoryId,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: VcsGetRepositoryRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath =
...
export const vcsListRepositoryBranches = async ({
  installationId,
  providerRepositoryId,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: VcsListRepositoryBranchesRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath =
...
export const vcsGetRepositoryContents = async ({
  installationId,
  providerRepositoryId,
  providerRootDirectory,
  providerReference,
  ...
  overrideForCli = false,
  sdk = undefined,
}: VcsGetRepositoryContentsRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath =
...
export const vcsUpdateExternalDeployments = async ({
  installationId,
  repositoryId,
  ...
  overrideForCli = false,
  sdk = undefined,
}: VcsUpdateExternalDeploymentsRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath =
...
export const vcsListInstallations = async ({
  queries,
  search,
  total,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: VcsListInstallationsRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const vcsGetInstallation = async ({
  installationId,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: VcsGetInstallationRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/vcs/installations/{installationId}".replace(
    "{installationId}",
    installationId,
  );
  let payload = {};
...
export const vcsDeleteInstallation = async ({
  installationId,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: VcsDeleteInstallationRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/vcs/installations/{installationId}".replace(
    "{installationId}",
    installationId,
...
vcs
  ...
  .requiredOption(
    `--provider-pull-request-id <provider-pull-request-id>`,
