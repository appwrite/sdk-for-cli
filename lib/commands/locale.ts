...
export const localeGet = async ({
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: LocaleGetRequestParams): Promise<any> => {
...
export const localeListCodes = async ({
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: LocaleListCodesRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const localeListContinents = async ({
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: LocaleListContinentsRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const localeListCountries = async ({
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: LocaleListCountriesRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const localeListCountriesEU = async ({
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: LocaleListCountriesEURequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const localeListCountriesPhones = async ({
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: LocaleListCountriesPhonesRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const localeListCurrencies = async ({
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: LocaleListCurrenciesRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const localeListLanguages = async ({
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: LocaleListLanguagesRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
