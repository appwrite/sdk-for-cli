...
export const projectsList = async ({
  ...
  sdk = undefined,
  console: showConsole,
}: ProjectsListRequestParams): Promise<any> => {
...
export const projectsCreate = async ({
  ...
  overrideForCli = false,
  sdk = undefined,
}: ProjectsCreateRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForConsole() : sdk;
  let apiPath = "/projects";
  let payload = {};
...
export const projectsGet = async ({
  ...
  sdk = undefined,
  console: showConsole,
}: ProjectsGetRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForConsole() : sdk;
...
export const projectsUpdate = async ({
  ...
  overrideForCli = false,
  sdk = undefined,
}: ProjectsUpdateRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForConsole() : sdk;
  let apiPath = "/projects/{projectId}".replace("{projectId}", projectId);
  let payload = {};
  if (typeof name !== "undefined") {
...
export const projectsDelete = async ({
  ...
  overrideForCli = false,
  sdk = undefined,
}: ProjectsDeleteRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForConsole() : sdk;
  let apiPath = "/projects/{projectId}".replace("{projectId}", projectId);
  let payload = {};
...
export const projectsUpdateAPIStatus = async ({
  projectId,
  api,
  status,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: ProjectsUpdateAPIStatusRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForConsole() : sdk;
...
export const projectsUpdateAPIStatusAll = async ({
  projectId,
  status,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: ProjectsUpdateAPIStatusAllRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForConsole() : sdk;
  let apiPath = "/projects/{projectId}/api/all".replace(
    "{projectId}",
    projectId,
  );
  let payload = {};
...
export const projectsUpdateAuthDuration = async ({
  projectId,
  duration,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: ProjectsUpdateAuthDurationRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForConsole() : sdk;
  let apiPath = "/projects/{projectId}/auth/duration".replace(
    "{projectId}",
    projectId,
  );
  let payload = {};
...
export const projectsUpdateAuthLimit = async ({
  projectId,
  limit,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: ProjectsUpdateAuthLimitRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForConsole() : sdk;
  let apiPath = "/projects/{projectId}/auth/limit".replace(
    "{projectId}",
    projectId,
  );
  let payload = {};
...
export const projectsUpdateAuthSessionsLimit = async ({
  projectId,
  limit,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: ProjectsUpdateAuthSessionsLimitRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForConsole() : sdk;
  let apiPath = "/projects/{projectId}/auth/max-sessions".replace(
    "{projectId}",
    projectId,
  );
  let payload = {};
...
export const projectsUpdateMembershipsPrivacy = async ({
  projectId,
  userName,
  userEmail,
  mfa,
  ...
  overrideForCli = false,
  sdk = undefined,
}: ProjectsUpdateMembershipsPrivacyRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForConsole() : sdk;
  let apiPath = "/projects/{projectId}/auth/memberships-privacy".replace(
    "{projectId}",
    projectId,
  );
  let payload = {};
...
export const projectsUpdateMockNumbers = async ({
  projectId,
  numbers,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: ProjectsUpdateMockNumbersRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForConsole() : sdk;
  let apiPath = "/projects/{projectId}/auth/mock-numbers".replace(
    "{projectId}",
    projectId,
  );
  let payload = {};
...
export const projectsUpdateAuthPasswordDictionary = async ({
  projectId,
  enabled,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: ProjectsUpdateAuthPasswordDictionaryRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForConsole() : sdk;
  let apiPath = "/projects/{projectId}/auth/password-dictionary".replace(
    "{projectId}",
    projectId,
  );
  let payload = {};
...
export const projectsUpdateAuthPasswordHistory = async ({
  projectId,
  limit,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: ProjectsUpdateAuthPasswordHistoryRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForConsole() : sdk;
  let apiPath = "/projects/{projectId}/auth/password-history".replace(
    "{projectId}",
    projectId,
  );
  let payload = {};
...
export const projectsUpdatePersonalDataCheck = async ({
  projectId,
  enabled,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: ProjectsUpdatePersonalDataCheckRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForConsole() : sdk;
  let apiPath = "/projects/{projectId}/auth/personal-data".replace(
    "{projectId}",
    projectId,
  );
  let payload = {};
...
export const projectsUpdateSessionAlerts = async ({
  projectId,
  alerts,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: ProjectsUpdateSessionAlertsRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForConsole() : sdk;
  let apiPath = "/projects/{projectId}/auth/session-alerts".replace(
    "{projectId}",
    projectId,
  );
  let payload = {};
...
export const projectsUpdateSessionInvalidation = async ({
  projectId,
  enabled,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: ProjectsUpdateSessionInvalidationRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForConsole() : sdk;
  let apiPath = "/projects/{projectId}/auth/session-invalidation".replace(
    "{projectId}",
    projectId,
  );
  let payload = {};
...
export const projectsUpdateAuthStatus = async ({
  projectId,
  method,
  status,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: ProjectsUpdateAuthStatusRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForConsole() : sdk;
...
export const projectsListDevKeys = async ({
  projectId,
  queries,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
  console: showConsole,
}: ProjectsListDevKeysRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForConsole() : sdk;
  let apiPath = "/projects/{projectId}/dev-keys".replace(
    "{projectId}",
    projectId,
  );
  let payload = {};
...
export const projectsCreateDevKey = async ({
  projectId,
  name,
  expire,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: ProjectsCreateDevKeyRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForConsole() : sdk;
  let apiPath = "/projects/{projectId}/dev-keys".replace(
    "{projectId}",
    projectId,
...
export const projectsGetDevKey = async ({
  projectId,
  keyId,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
  console: showConsole,
}: ProjectsGetDevKeyRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForConsole() : sdk;
...
export const projectsUpdateDevKey = async ({
  projectId,
  keyId,
  name,
  expire,
  ...
  overrideForCli = false,
  sdk = undefined,
}: ProjectsUpdateDevKeyRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForConsole() : sdk;
  let apiPath = "/projects/{projectId}/dev-keys/{keyId}"
    .replace("{projectId}", projectId)
    .replace("{keyId}", keyId);
...
export const projectsDeleteDevKey = async ({
  projectId,
  keyId,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: ProjectsDeleteDevKeyRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForConsole() : sdk;
  let apiPath = "/projects/{projectId}/dev-keys/{keyId}"
    .replace("{projectId}", projectId)
    .replace("{keyId}", keyId);
...
export const projectsCreateJWT = async ({
  projectId,
  scopes,
  duration,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: ProjectsCreateJWTRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForConsole() : sdk;
...
export const projectsListKeys = async ({
  projectId,
  total,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
  console: showConsole,
}: ProjectsListKeysRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForConsole() : sdk;
...
export const projectsCreateKey = async ({
  projectId,
  name,
  scopes,
  expire,
  ...
  overrideForCli = false,
  sdk = undefined,
}: ProjectsCreateKeyRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForConsole() : sdk;
  let apiPath = "/projects/{projectId}/keys".replace("{projectId}", projectId);
  let payload = {};
  if (typeof name !== "undefined") {
...
export const projectsGetKey = async ({
  projectId,
  keyId,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
  console: showConsole,
}: ProjectsGetKeyRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForConsole() : sdk;
...
export const projectsUpdateKey = async ({
  projectId,
  keyId,
  name,
  scopes,
  ...
  overrideForCli = false,
  sdk = undefined,
}: ProjectsUpdateKeyRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForConsole() : sdk;
  let apiPath = "/projects/{projectId}/keys/{keyId}"
    .replace("{projectId}", projectId)
    .replace("{keyId}", keyId);
...
export const projectsDeleteKey = async ({
  projectId,
  keyId,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: ProjectsDeleteKeyRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForConsole() : sdk;
  let apiPath = "/projects/{projectId}/keys/{keyId}"
    .replace("{projectId}", projectId)
    .replace("{keyId}", keyId);
...
export const projectsUpdateOAuth2 = async ({
  projectId,
  provider,
  appId,
  secret,
  ...
  overrideForCli = false,
  sdk = undefined,
}: ProjectsUpdateOAuth2RequestParams): Promise<any> => {
  let client = !sdk ? await sdkForConsole() : sdk;
  let apiPath = "/projects/{projectId}/oauth2".replace(
    "{projectId}",
    projectId,
  );
  let payload = {};
...
export const projectsListPlatforms = async ({
  projectId,
  total,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
  console: showConsole,
}: ProjectsListPlatformsRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForConsole() : sdk;
  let apiPath = "/projects/{projectId}/platforms".replace(
    "{projectId}",
    projectId,
  );
  let payload = {};
...
export const projectsCreatePlatform = async ({
  projectId,
  type,
  name,
  key,
  ...
  overrideForCli = false,
  sdk = undefined,
}: ProjectsCreatePlatformRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForConsole() : sdk;
  let apiPath = "/projects/{projectId}/platforms".replace(
    "{projectId}",
    projectId,
...
export const projectsGetPlatform = async ({
  projectId,
  platformId,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
  console: showConsole,
}: ProjectsGetPlatformRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForConsole() : sdk;
...
export const projectsUpdatePlatform = async ({
  projectId,
  platformId,
  name,
  key,
  ...
  overrideForCli = false,
  sdk = undefined,
}: ProjectsUpdatePlatformRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForConsole() : sdk;
  let apiPath = "/projects/{projectId}/platforms/{platformId}"
    .replace("{projectId}", projectId)
    .replace("{platformId}", platformId);
...
export const projectsDeletePlatform = async ({
  projectId,
  platformId,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: ProjectsDeletePlatformRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForConsole() : sdk;
  let apiPath = "/projects/{projectId}/platforms/{platformId}"
    .replace("{projectId}", projectId)
    .replace("{platformId}", platformId);
...
export const projectsUpdateServiceStatus = async ({
  projectId,
  service,
  status,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: ProjectsUpdateServiceStatusRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForConsole() : sdk;
  let apiPath = "/projects/{projectId}/service".replace(
    "{projectId}",
    projectId,
  );
  let payload = {};
...
export const projectsUpdateServiceStatusAll = async ({
  projectId,
  status,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: ProjectsUpdateServiceStatusAllRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForConsole() : sdk;
  let apiPath = "/projects/{projectId}/service/all".replace(
    "{projectId}",
    projectId,
  );
  let payload = {};
...
export const projectsUpdateSMTP = async ({
  projectId,
  enabled,
  senderName,
  senderEmail,
  ...
  overrideForCli = false,
  sdk = undefined,
}: ProjectsUpdateSMTPRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForConsole() : sdk;
...
export const projectsCreateSMTPTest = async ({
  projectId,
  emails,
  senderName,
  senderEmail,
  ...
  overrideForCli = false,
  sdk = undefined,
}: ProjectsCreateSMTPTestRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForConsole() : sdk;
  let apiPath = "/projects/{projectId}/smtp/tests".replace(
    "{projectId}",
    projectId,
  );
  let payload = {};
...
export const projectsUpdateTeam = async ({
  projectId,
  teamId,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: ProjectsUpdateTeamRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForConsole() : sdk;
...
export const projectsGetEmailTemplate = async ({
  projectId,
  type,
  locale,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: ProjectsGetEmailTemplateRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForConsole() : sdk;
...
export const projectsUpdateEmailTemplate = async ({
  projectId,
  type,
  locale,
  subject,
  ...
  overrideForCli = false,
  sdk = undefined,
}: ProjectsUpdateEmailTemplateRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForConsole() : sdk;
  let apiPath = "/projects/{projectId}/templates/email/{type}/{locale}"
    .replace("{projectId}", projectId)
    .replace("{type}", type)
...
export const projectsDeleteEmailTemplate = async ({
  projectId,
  type,
  locale,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: ProjectsDeleteEmailTemplateRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForConsole() : sdk;
  let apiPath = "/projects/{projectId}/templates/email/{type}/{locale}"
    .replace("{projectId}", projectId)
    .replace("{type}", type)
...
export const projectsGetSMSTemplate = async ({
  projectId,
  type,
  locale,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: ProjectsGetSMSTemplateRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForConsole() : sdk;
...
export const projectsUpdateSMSTemplate = async ({
  projectId,
  type,
  locale,
  message,
  ...
  overrideForCli = false,
  sdk = undefined,
}: ProjectsUpdateSMSTemplateRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForConsole() : sdk;
  let apiPath = "/projects/{projectId}/templates/sms/{type}/{locale}"
    .replace("{projectId}", projectId)
    .replace("{type}", type)
...
export const projectsDeleteSMSTemplate = async ({
  projectId,
  type,
  locale,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: ProjectsDeleteSMSTemplateRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForConsole() : sdk;
  let apiPath = "/projects/{projectId}/templates/sms/{type}/{locale}"
    .replace("{projectId}", projectId)
    .replace("{type}", type)
...
export const projectsListWebhooks = async ({
  projectId,
  total,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
  console: showConsole,
}: ProjectsListWebhooksRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForConsole() : sdk;
  let apiPath = "/projects/{projectId}/webhooks".replace(
    "{projectId}",
    projectId,
  );
  let payload = {};
...
export const projectsCreateWebhook = async ({
  projectId,
  name,
  events,
  url,
  ...
  overrideForCli = false,
  sdk = undefined,
}: ProjectsCreateWebhookRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForConsole() : sdk;
  let apiPath = "/projects/{projectId}/webhooks".replace(
    "{projectId}",
    projectId,
...
export const projectsGetWebhook = async ({
  projectId,
  webhookId,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
  console: showConsole,
}: ProjectsGetWebhookRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForConsole() : sdk;
...
export const projectsUpdateWebhook = async ({
  projectId,
  webhookId,
  name,
  events,
  ...
  overrideForCli = false,
  sdk = undefined,
}: ProjectsUpdateWebhookRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForConsole() : sdk;
  let apiPath = "/projects/{projectId}/webhooks/{webhookId}"
    .replace("{projectId}", projectId)
    .replace("{webhookId}", webhookId);
...
export const projectsDeleteWebhook = async ({
  projectId,
  webhookId,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: ProjectsDeleteWebhookRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForConsole() : sdk;
  let apiPath = "/projects/{projectId}/webhooks/{webhookId}"
    .replace("{projectId}", projectId)
    .replace("{webhookId}", webhookId);
...
export const projectsUpdateWebhookSignature = async ({
  projectId,
  webhookId,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: ProjectsUpdateWebhookSignatureRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForConsole() : sdk;
