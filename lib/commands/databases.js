...
const databasesListCollections = async ({databaseId,queries,search,parseOutput = true, overrideForCli = false, sdk = undefined, console}) => {
    console.warn('Warning: This command is deprecated since 1.8.0. Please use "tables list" instead.');
    let client = !sdk ? await sdkForProject() :
    sdk;
...
const databasesCreateCollection = async ({databaseId,collectionId,name,permissions,documentSecurity,enabled,parseOutput = true, overrideForCli = false, sdk = undefined}) => {
    console.warn('Warning: This command is deprecated since 1.8.0. Please use "tables create" instead.');
    let client = !sdk ? await sdkForProject() :
    sdk;
    let apiPath = '/databases/{databaseId}/collections'.replace('{databaseId}', databaseId);
    let payload = {};
...
const databasesGetCollection = async ({databaseId,collectionId,parseOutput = true, overrideForCli = false, sdk = undefined, console}) => {
    console.warn('Warning: This command is deprecated since 1.8.0. Please use "tables get" instead.');
    let client = !sdk ? await sdkForProject() :
    sdk;
...
const databasesUpdateCollection = async ({databaseId,collectionId,name,permissions,documentSecurity,enabled,parseOutput = true, overrideForCli = false, sdk = undefined}) => {
    console.warn('Warning: This command is deprecated since 1.8.0. Please use "tables update" instead.');
    let client = !sdk ? await sdkForProject() :
    sdk;
    let apiPath = '/databases/{databaseId}/collections/{collectionId}'.replace('{databaseId}', databaseId).replace('{collectionId}', collectionId);
    let payload = {};
...
const databasesDeleteCollection = async ({databaseId,collectionId,parseOutput = true, overrideForCli = false, sdk = undefined}) => {
    console.warn('Warning: This command is deprecated since 1.8.0. Please use "tables delete" instead.');
    let client = !sdk ? await sdkForProject() :
    sdk;
    let apiPath = '/databases/{databaseId}/collections/{collectionId}'.replace('{databaseId}', databaseId).replace('{collectionId}', collectionId);
    let payload = {};
...
const databasesListAttributes = async ({databaseId,collectionId,queries,parseOutput = true, overrideForCli = false, sdk = undefined, console}) => {
    console.warn('Warning: This command is deprecated since 1.8.0. Please use "tables list-columns" instead.');
    let client = !sdk ? await sdkForProject() :
    sdk;
...
const databasesCreateBooleanAttribute = async ({databaseId,collectionId,key,required,xdefault,array,parseOutput = true, overrideForCli = false, sdk = undefined}) => {
    console.warn('Warning: This command is deprecated since 1.8.0. Please use "tables create-boolean-column" instead.');
    let client = !sdk ? await sdkForProject() :
    sdk;
...
const databasesUpdateBooleanAttribute = async ({databaseId,collectionId,key,required,xdefault,newKey,parseOutput = true, overrideForCli = false, sdk = undefined}) => {
    console.warn('Warning: This command is deprecated since 1.8.0. Please use "tables update-boolean-column" instead.');
    let client = !sdk ? await sdkForProject() :
    sdk;
...
const databasesCreateDatetimeAttribute = async ({databaseId,collectionId,key,required,xdefault,array,parseOutput = true, overrideForCli = false, sdk = undefined}) => {
    console.warn('Warning: This command is deprecated since 1.8.0. Please use "tables create-datetime-column" instead.');
    let client = !sdk ? await sdkForProject() :
    sdk;
...
const databasesUpdateDatetimeAttribute = async ({databaseId,collectionId,key,required,xdefault,newKey,parseOutput = true, overrideForCli = false, sdk = undefined}) => {
    console.warn('Warning: This command is deprecated since 1.8.0. Please use "tables update-datetime-column" instead.');
    let client = !sdk ? await sdkForProject() :
    sdk;
...
const databasesCreateEmailAttribute = async ({databaseId,collectionId,key,required,xdefault,array,parseOutput = true, overrideForCli = false, sdk = undefined}) => {
    console.warn('Warning: This command is deprecated since 1.8.0. Please use "tables create-email-column" instead.');
    let client = !sdk ? await sdkForProject() :
    sdk;
...
const databasesUpdateEmailAttribute = async ({databaseId,collectionId,key,required,xdefault,newKey,parseOutput = true, overrideForCli = false, sdk = undefined}) => {
    console.warn('Warning: This command is deprecated since 1.8.0. Please use "tables update-email-column" instead.');
    let client = !sdk ? await sdkForProject() :
    sdk;
...
const databasesCreateEnumAttribute = async ({databaseId,collectionId,key,elements,required,xdefault,array,parseOutput = true, overrideForCli = false, sdk = undefined}) => {
    console.warn('Warning: This command is deprecated since 1.8.0. Please use "tables create-enum-column" instead.');
    let client = !sdk ? await sdkForProject() :
    sdk;
...
const databasesUpdateEnumAttribute = async ({databaseId,collectionId,key,elements,required,xdefault,newKey,parseOutput = true, overrideForCli = false, sdk = undefined}) => {
    console.warn('Warning: This command is deprecated since 1.8.0. Please use "tables update-enum-column" instead.');
    let client = !sdk ? await sdkForProject() :
    sdk;
...
const databasesCreateFloatAttribute = async ({databaseId,collectionId,key,required,min,max,xdefault,array,parseOutput = true, overrideForCli = false, sdk = undefined}) => {
    console.warn('Warning: This command is deprecated since 1.8.0. Please use "tables create-float-column" instead.');
    let client = !sdk ? await sdkForProject() :
    sdk;
...
const databasesUpdateFloatAttribute = async ({databaseId,collectionId,key,required,xdefault,min,max,newKey,parseOutput = true, overrideForCli = false, sdk = undefined}) => {
    console.warn('Warning: This command is deprecated since 1.8.0. Please use "tables update-float-column" instead.');
    let client = !sdk ? await sdkForProject() :
    sdk;
...
const databasesCreateIntegerAttribute = async ({databaseId,collectionId,key,required,min,max,xdefault,array,parseOutput = true, overrideForCli = false, sdk = undefined}) => {
    console.warn('Warning: This command is deprecated since 1.8.0. Please use "tables create-integer-column" instead.');
    let client = !sdk ? await sdkForProject() :
    sdk;
...
const databasesUpdateIntegerAttribute = async ({databaseId,collectionId,key,required,xdefault,min,max,newKey,parseOutput = true, overrideForCli = false, sdk = undefined}) => {
    console.warn('Warning: This command is deprecated since 1.8.0. Please use "tables update-integer-column" instead.');
    let client = !sdk ? await sdkForProject() :
    sdk;
...
const databasesCreateIpAttribute = async ({databaseId,collectionId,key,required,xdefault,array,parseOutput = true, overrideForCli = false, sdk = undefined}) => {
    console.warn('Warning: This command is deprecated since 1.8.0. Please use "tables create-ip-column" instead.');
    let client = !sdk ? await sdkForProject() :
    sdk;
...
const databasesUpdateIpAttribute = async ({databaseId,collectionId,key,required,xdefault,newKey,parseOutput = true, overrideForCli = false, sdk = undefined}) => {
    console.warn('Warning: This command is deprecated since 1.8.0. Please use "tables update-ip-column" instead.');
    let client = !sdk ? await sdkForProject() :
    sdk;
...
const databasesCreateRelationshipAttribute = async ({databaseId,collectionId,relatedCollectionId,type,twoWay,key,twoWayKey,onDelete,parseOutput = true, overrideForCli = false, sdk = undefined}) => {
    console.warn('Warning: This command is deprecated since 1.8.0. Please use "tables create-relationship-column" instead.');
    let client = !sdk ? await sdkForProject() :
    sdk;
...
const databasesCreateStringAttribute = async ({databaseId,collectionId,key,size,required,xdefault,array,encrypt,parseOutput = true, overrideForCli = false, sdk = undefined}) => {
    console.warn('Warning: This command is deprecated since 1.8.0. Please use "tables create-string-column" instead.');
    let client = !sdk ? await sdkForProject() :
    sdk;
...
const databasesUpdateStringAttribute = async ({databaseId,collectionId,key,required,xdefault,size,newKey,parseOutput = true, overrideForCli = false, sdk = undefined}) => {
    console.warn('Warning: This command is deprecated since 1.8.0. Please use "tables update-string-column" instead.');
    let client = !sdk ? await sdkForProject() :
    sdk;
...
const databasesCreateUrlAttribute = async ({databaseId,collectionId,key,required,xdefault,array,parseOutput = true, overrideForCli = false, sdk = undefined}) => {
    console.warn('Warning: This command is deprecated since 1.8.0. Please use "tables create-url-column" instead.');
    let client = !sdk ? await sdkForProject() :
    sdk;
...
const databasesUpdateUrlAttribute = async ({databaseId,collectionId,key,required,xdefault,newKey,parseOutput = true, overrideForCli = false, sdk = undefined}) => {
    console.warn('Warning: This command is deprecated since 1.8.0. Please use "tables update-url-column" instead.');
    let client = !sdk ? await sdkForProject() :
    sdk;
...
const databasesGetAttribute = async ({databaseId,collectionId,key,parseOutput = true, overrideForCli = false, sdk = undefined}) => {
    console.warn('Warning: This command is deprecated since 1.8.0. Please use "tables get-column" instead.');
    let client = !sdk ? await sdkForProject() :
    sdk;
...
const databasesDeleteAttribute = async ({databaseId,collectionId,key,parseOutput = true, overrideForCli = false, sdk = undefined}) => {
    console.warn('Warning: This command is deprecated since 1.8.0. Please use "tables delete-column" instead.');
    let client = !sdk ? await sdkForProject() :
    sdk;
    let apiPath = '/databases/{databaseId}/collections/{collectionId}/attributes/{key}'.replace('{databaseId}', databaseId).replace('{collectionId}', collectionId).replace('{key}', key);
    let payload = {};
...
const databasesUpdateRelationshipAttribute = async ({databaseId,collectionId,key,onDelete,newKey,parseOutput = true, overrideForCli = false, sdk = undefined}) => {
    console.warn('Warning: This command is deprecated since 1.8.0. Please use "tables update-relationship-column" instead.');
    let client = !sdk ? await sdkForProject() :
    sdk;
...
const databasesListDocuments = async ({databaseId,collectionId,queries,parseOutput = true, overrideForCli = false, sdk = undefined, console}) => {
    console.warn('Warning: This command is deprecated since 1.8.0. Please use "tables list-rows" instead.');
    let client = !sdk ? await sdkForProject() :
    sdk;
...
const databasesCreateDocument = async ({databaseId,collectionId,documentId,data,permissions,parseOutput = true, overrideForCli = false, sdk = undefined}) => {
    console.warn('Warning: This command is deprecated since 1.8.0. Please use "tables create-row" instead.');
    let client = !sdk ? await sdkForProject() :
    sdk;
    let apiPath = '/databases/{databaseId}/collections/{collectionId}/documents'.replace('{databaseId}', databaseId).replace('{collectionId}', collectionId);
    let payload = {};
 ...
 */
const databasesUpsertDocuments = async ({databaseId,collectionId,parseOutput = true, overrideForCli = false, sdk = undefined}) => {
    console.warn('Warning: This command is deprecated since 1.8.0. Please use "tables upsert-rows" instead.');
    let client = !sdk ? await sdkForProject() :
    sdk;
    let apiPath = '/databases/{databaseId}/collections/{collectionId}/documents'.replace('{databaseId}', databaseId).replace('{collectionId}', collectionId);
    let payload = {};
...
const databasesUpdateDocuments = async ({databaseId,collectionId,data,queries,parseOutput = true, overrideForCli = false, sdk = undefined}) => {
    console.warn('Warning: This command is deprecated since 1.8.0. Please use "tables update-rows" instead.');
    let client = !sdk ? await sdkForProject() :
    sdk;
    let apiPath = '/databases/{databaseId}/collections/{collectionId}/documents'.replace('{databaseId}', databaseId).replace('{collectionId}', collectionId);
    let payload = {};
...
const databasesDeleteDocuments = async ({databaseId,collectionId,queries,parseOutput = true, overrideForCli = false, sdk = undefined}) => {
    console.warn('Warning: This command is deprecated since 1.8.0. Please use "tables delete-rows" instead.');
    let client = !sdk ? await sdkForProject() :
    sdk;
    let apiPath = '/databases/{databaseId}/collections/{collectionId}/documents'.replace('{databaseId}', databaseId).replace('{collectionId}', collectionId);
    let payload = {};
...
const databasesGetDocument = async ({databaseId,collectionId,documentId,queries,parseOutput = true, overrideForCli = false, sdk = undefined, console}) => {
    console.warn('Warning: This command is deprecated since 1.8.0. Please use "tables get-row" instead.');
    let client = !sdk ? await sdkForProject() :
    sdk;
 ...
 */
const databasesUpsertDocument = async ({databaseId,collectionId,documentId,parseOutput = true, overrideForCli = false, sdk = undefined}) => {
    console.warn('Warning: This command is deprecated since 1.8.0. Please use "tables upsert-row" instead.');
    let client = !sdk ? await sdkForProject() :
    sdk;
    let apiPath = '/databases/{databaseId}/collections/{collectionId}/documents/{documentId}'.replace('{databaseId}', databaseId).replace('{collectionId}', collectionId).replace('{documentId}', documentId);
    let payload = {};
...
const databasesUpdateDocument = async ({databaseId,collectionId,documentId,data,permissions,parseOutput = true, overrideForCli = false, sdk = undefined}) => {
    console.warn('Warning: This command is deprecated since 1.8.0. Please use "tables update-row" instead.');
    let client = !sdk ? await sdkForProject() :
    sdk;
    let apiPath = '/databases/{databaseId}/collections/{collectionId}/documents/{documentId}'.replace('{databaseId}', databaseId).replace('{collectionId}', collectionId).replace('{documentId}', documentId);
    let payload = {};
...
const databasesDeleteDocument = async ({databaseId,collectionId,documentId,parseOutput = true, overrideForCli = false, sdk = undefined}) => {
    console.warn('Warning: This command is deprecated since 1.8.0. Please use "tables delete-row" instead.');
    let client = !sdk ? await sdkForProject() :
    sdk;
    let apiPath = '/databases/{databaseId}/collections/{collectionId}/documents/{documentId}'.replace('{databaseId}', databaseId).replace('{collectionId}', collectionId).replace('{documentId}', documentId);
    let payload = {};
...
const databasesListDocumentLogs = async ({databaseId,collectionId,documentId,queries,parseOutput = true, overrideForCli = false, sdk = undefined}) => {
    console.warn('Warning: This command is deprecated since 1.8.0. Please use "tables list-logs" instead.');
    let client = !sdk ? await sdkForProject() :
    sdk;
...
const databasesDecrementDocumentAttribute = async ({databaseId,collectionId,documentId,attribute,value,min,parseOutput = true, overrideForCli = false, sdk = undefined}) => {
    console.warn('Warning: This command is deprecated since 1.8.0. Please use "tables decrement-row-column" instead.');
    let client = !sdk ? await sdkForProject() :
    sdk;
...
const databasesIncrementDocumentAttribute = async ({databaseId,collectionId,documentId,attribute,value,max,parseOutput = true, overrideForCli = false, sdk = undefined}) => {
    console.warn('Warning: This command is deprecated since 1.8.0. Please use "tables increment-row-column" instead.');
    let client = !sdk ? await sdkForProject() :
    sdk;
...
const databasesListIndexes = async ({databaseId,collectionId,queries,parseOutput = true, overrideForCli = false, sdk = undefined, console}) => {
    console.warn('Warning: This command is deprecated since 1.8.0. Please use "tables list-indexes" instead.');
    let client = !sdk ? await sdkForProject() :
    sdk;
...
const databasesCreateIndex = async ({databaseId,collectionId,key,type,attributes,orders,lengths,parseOutput = true, overrideForCli = false, sdk = undefined}) => {
    console.warn('Warning: This command is deprecated since 1.8.0. Please use "tables create-index" instead.');
    let client = !sdk ? await sdkForProject() :
    sdk;
    let apiPath = '/databases/{databaseId}/collections/{collectionId}/indexes'.replace('{databaseId}', databaseId).replace('{collectionId}', collectionId);
    let payload = {};
...
const databasesGetIndex = async ({databaseId,collectionId,key,parseOutput = true, overrideForCli = false, sdk = undefined}) => {
    console.warn('Warning: This command is deprecated since 1.8.0. Please use "tables get-index" instead.');
    let client = !sdk ? await sdkForProject() :
    sdk;
...
const databasesDeleteIndex = async ({databaseId,collectionId,key,parseOutput = true, overrideForCli = false, sdk = undefined}) => {
    console.warn('Warning: This command is deprecated since 1.8.0. Please use "tables delete-index" instead.');
    let client = !sdk ? await sdkForProject() :
    sdk;
    let apiPath = '/databases/{databaseId}/collections/{collectionId}/indexes/{key}'.replace('{databaseId}', databaseId).replace('{collectionId}', collectionId).replace('{key}', key);
    let payload = {};
...
const databasesGetCollectionUsage = async ({databaseId,collectionId,range,parseOutput = true, overrideForCli = false, sdk = undefined}) => {
    console.warn('Warning: This command is deprecated since 1.8.0. Please use "tables get-usage" instead.');
    let client = !sdk ? await sdkForProject() :
    sdk;
...
databases
    ...
    .description(`[**DEPRECATED** - This command is deprecated. Please use 'tables list' instead] Get a list of all collections that belong to the provided databaseId. You can use the search parameter to filter your results.`)
    .requiredOption(`--database-id <database-id>`, `Database ID.`)
...
databases
    ...
    .description(`[**DEPRECATED** - This command is deprecated. Please use 'tables create' instead] Create a new Collection. Before using this route, you should create a new database resource using either a [server integration](https://appwrite.io/docs/server/databases#databasesCreateCollection) API or directly from your database console.`)
    .requiredOption(`--database-id <database-id>`, `Database ID.`)
...
databases
    ...
    .description(`[**DEPRECATED** - This command is deprecated. Please use 'tables get' instead] Get a collection by its unique ID. This endpoint response returns a JSON object with the collection metadata.`)
    .requiredOption(`--database-id <database-id>`, `Database ID.`)
...
databases
    ...
    .description(`[**DEPRECATED** - This command is deprecated. Please use 'tables update' instead] Update a collection by its unique ID.`)
    .requiredOption(`--database-id <database-id>`, `Database ID.`)
    .requiredOption(`--collection-id <collection-id>`, `Collection ID.`)
    .requiredOption(`--name <name>`, `Collection name. Max length: 128 chars.`)
...
databases
    ...
    .description(`[**DEPRECATED** - This command is deprecated. Please use 'tables delete' instead] Delete a collection by its unique ID. Only users with write permissions have access to delete this resource.`)
    .requiredOption(`--database-id <database-id>`, `Database ID.`)
    .requiredOption(`--collection-id <collection-id>`, `Collection ID.`)
...
databases
    ...
    .description(`[**DEPRECATED** - This command is deprecated. Please use 'tables list-columns' instead] List attributes in the collection.`)
    .requiredOption(`--database-id <database-id>`, `Database ID.`)
    .requiredOption(`--collection-id <collection-id>`, `Collection ID.`)
...
databases
    ...
    .description(`[**DEPRECATED** - This command is deprecated. Please use 'tables create-boolean-column' instead] Create a boolean attribute. `)
    .requiredOption(`--database-id <database-id>`, `Database ID.`)
...
databases
    ...
    .description(`[**DEPRECATED** - This command is deprecated. Please use 'tables update-boolean-column' instead] Update a boolean attribute. Changing the 'default' value will not update already existing documents.`)
    .requiredOption(`--database-id <database-id>`, `Database ID.`)
...
databases
    ...
    .description(`[**DEPRECATED** - This command is deprecated. Please use 'tables create-datetime-column' instead] Create a date time attribute according to the ISO 8601 standard.`)
    .requiredOption(`--database-id <database-id>`, `Database ID.`)
    .requiredOption(`--collection-id <collection-id>`, `Collection ID. You can create a new collection using the Database service [server integration](https://appwrite.io/docs/server/databases#createCollection).`)
    .requiredOption(`--key <key>`, `Attribute Key.`)
    .requiredOption(`--required [value]`, `Is attribute required?`, (value) => value === undefined ? true : parseBool(value))
...
databases
    ...
    .description(`[**DEPRECATED** - This command is deprecated. Please use 'tables update-datetime-column' instead] Update a date time attribute. Changing the 'default' value will not update already existing documents.`)
    .requiredOption(`--database-id <database-id>`, `Database ID.`)
    .requiredOption(`--collection-id <collection-id>`, `Collection ID.`)
    .requiredOption(`--key <key>`, `Attribute Key.`)
    .requiredOption(`--required [value]`, `Is attribute required?`, (value) => value === undefined ? true : parseBool(value))
...
databases
    ...
    .description(`[**DEPRECATED** - This command is deprecated. Please use 'tables create-email-column' instead] Create an email attribute. `)
    .requiredOption(`--database-id <database-id>`, `Database ID.`)
    .requiredOption(`--collection-id <collection-id>`, `Collection ID.`)
    .requiredOption(`--key <key>`, `Attribute Key.`)
    .requiredOption(`--required [value]`, `Is attribute required?`, (value) => value === undefined ? true : parseBool(value))
...
databases
    ...
    .description(`[**DEPRECATED** - This command is deprecated. Please use 'tables update-email-column' instead] Update an email attribute. Changing the 'default' value will not update already existing documents. `)
    .requiredOption(`--database-id <database-id>`, `Database ID.`)
    .requiredOption(`--collection-id <collection-id>`, `Collection ID.`)
    .requiredOption(`--key <key>`, `Attribute Key.`)
    .requiredOption(`--required [value]`, `Is attribute required?`, (value) => value === undefined ? true : parseBool(value))
...
databases
    ...
    .description(`[**DEPRECATED** - This command is deprecated. Please use 'tables create-enum-column' instead] Create an enum attribute. The 'elements' param acts as a white-list of accepted values for this attribute.  `)
    .requiredOption(`--database-id <database-id>`, `Database ID.`)
    .requiredOption(`--collection-id <collection-id>`, `Collection ID.`)
    .requiredOption(`--key <key>`, `Attribute Key.`)
...
databases
    ...
    .description(`[**DEPRECATED** - This command is deprecated. Please use 'tables update-enum-column' instead] Update an enum attribute. Changing the 'default' value will not update already existing documents. `)
    .requiredOption(`--database-id <database-id>`, `Database ID.`)
    .requiredOption(`--collection-id <collection-id>`, `Collection ID.`)
    .requiredOption(`--key <key>`, `Attribute Key.`)
...
databases
    ...
    .description(`[**DEPRECATED** - This command is deprecated. Please use 'tables create-float-column' instead] Create a float attribute. Optionally, minimum and maximum values can be provided. `)
    .requiredOption(`--database-id <database-id>`, `Database ID.`)
    .requiredOption(`--collection-id <collection-id>`, `Collection ID.`)
    .requiredOption(`--key <key>`, `Attribute Key.`)
    .requiredOption(`--required [value]`, `Is attribute required?`, (value) => value === undefined ? true : parseBool(value))
...
databases
    ...
    .description(`[**DEPRECATED** - This command is deprecated. Please use 'tables update-float-column' instead] Update a float attribute. Changing the 'default' value will not update already existing documents. `)
    .requiredOption(`--database-id <database-id>`, `Database ID.`)
    .requiredOption(`--collection-id <collection-id>`, `Collection ID.`)
    .requiredOption(`--key <key>`, `Attribute Key.`)
    .requiredOption(`--required [value]`, `Is attribute required?`, (value) => value === undefined ? true : parseBool(value))
...
databases
    ...
    .description(`[**DEPRECATED** - This command is deprecated. Please use 'tables create-integer-column' instead] Create an integer attribute. Optionally, minimum and maximum values can be provided. `)
    .requiredOption(`--database-id <database-id>`, `Database ID.`)
    .requiredOption(`--collection-id <collection-id>`, `Collection ID.`)
    .requiredOption(`--key <key>`, `Attribute Key.`)
    .requiredOption(`--required [value]`, `Is attribute required?`, (value) => value === undefined ? true : parseBool(value))
...
databases
    ...
    .description(`[**DEPRECATED** - This command is deprecated. Please use 'tables update-integer-column' instead] Update an integer attribute. Changing the 'default' value will not update already existing documents. `)
    .requiredOption(`--database-id <database-id>`, `Database ID.`)
    .requiredOption(`--collection-id <collection-id>`, `Collection ID.`)
    .requiredOption(`--key <key>`, `Attribute Key.`)
    .requiredOption(`--required [value]`, `Is attribute required?`, (value) => value === undefined ? true : parseBool(value))
...
databases
    ...
    .description(`[**DEPRECATED** - This command is deprecated. Please use 'tables create-ip-column' instead] Create IP address attribute. `)
    .requiredOption(`--database-id <database-id>`, `Database ID.`)
    .requiredOption(`--collection-id <collection-id>`, `Collection ID.`)
    .requiredOption(`--key <key>`, `Attribute Key.`)
    .requiredOption(`--required [value]`, `Is attribute required?`, (value) => value === undefined ? true : parseBool(value))
...
databases
    ...
    .description(`[**DEPRECATED** - This command is deprecated. Please use 'tables update-ip-column' instead] Update an ip attribute. Changing the 'default' value will not update already existing documents. `)
    .requiredOption(`--database-id <database-id>`, `Database ID.`)
    .requiredOption(`--collection-id <collection-id>`, `Collection ID.`)
    .requiredOption(`--key <key>`, `Attribute Key.`)
    .requiredOption(`--required [value]`, `Is attribute required?`, (value) => value === undefined ? true : parseBool(value))
...
databases
    ...
    .description(`[**DEPRECATED** - This command is deprecated. Please use 'tables create-relationship-column' instead] Create relationship attribute. [Learn more about relationship attributes](https://appwrite.io/docs/databases-relationships#relationship-attributes). `)
    .requiredOption(`--database-id <database-id>`, `Database ID.`)
    .requiredOption(`--collection-id <collection-id>`, `Collection ID.`)
...
databases
    ...
    .description(`[**DEPRECATED** - This command is deprecated. Please use 'tables create-string-column' instead] Create a string attribute. `)
    .requiredOption(`--database-id <database-id>`, `Database ID.`)
    .requiredOption(`--collection-id <collection-id>`, `Collection ID. You can create a new table using the Database service [server integration](https://appwrite.io/docs/server/databases#databasesCreateCollection).`)
    .requiredOption(`--key <key>`, `Attribute Key.`)
...
databases
    ...
    .description(`[**DEPRECATED** - This command is deprecated. Please use 'tables update-string-column' instead] Update a string attribute. Changing the 'default' value will not update already existing documents. `)
    .requiredOption(`--database-id <database-id>`, `Database ID.`)
    .requiredOption(`--collection-id <collection-id>`, `Collection ID. You can create a new table using the Database service [server integration](https://appwrite.io/docs/server/databases#databasesCreateCollection).`)
    .requiredOption(`--key <key>`, `Attribute Key.`)
    .requiredOption(`--required [value]`, `Is attribute required?`, (value) => value === undefined ? true : parseBool(value))
...
databases
    ...
    .description(`[**DEPRECATED** - This command is deprecated. Please use 'tables create-url-column' instead] Create a URL attribute. `)
    .requiredOption(`--database-id <database-id>`, `Database ID.`)
    .requiredOption(`--collection-id <collection-id>`, `Collection ID.`)
    .requiredOption(`--key <key>`, `Attribute Key.`)
    .requiredOption(`--required [value]`, `Is attribute required?`, (value) => value === undefined ? true : parseBool(value))
...
databases
    ...
    .description(`[**DEPRECATED** - This command is deprecated. Please use 'tables update-url-column' instead] Update an url attribute. Changing the 'default' value will not update already existing documents. `)
    .requiredOption(`--database-id <database-id>`, `Database ID.`)
    .requiredOption(`--collection-id <collection-id>`, `Collection ID.`)
    .requiredOption(`--key <key>`, `Attribute Key.`)
    .requiredOption(`--required [value]`, `Is attribute required?`, (value) => value === undefined ? true : parseBool(value))
...
databases
    ...
    .description(`[**DEPRECATED** - This command is deprecated. Please use 'tables get-column' instead] Get attribute by ID.`)
    .requiredOption(`--database-id <database-id>`, `Database ID.`)
    .requiredOption(`--collection-id <collection-id>`, `Collection ID.`)
    .requiredOption(`--key <key>`, `Attribute Key.`)
...
databases
    ...
    .description(`[**DEPRECATED** - This command is deprecated. Please use 'tables delete-column' instead] Deletes an attribute.`)
    .requiredOption(`--database-id <database-id>`, `Database ID.`)
    .requiredOption(`--collection-id <collection-id>`, `Collection ID.`)
    .requiredOption(`--key <key>`, `Attribute Key.`)
...
databases
    ...
    .description(`[**DEPRECATED** - This command is deprecated. Please use 'tables update-relationship-column' instead] Update relationship attribute. [Learn more about relationship attributes](https://appwrite.io/docs/databases-relationships#relationship-attributes). `)
    .requiredOption(`--database-id <database-id>`, `Database ID.`)
    .requiredOption(`--collection-id <collection-id>`, `Collection ID.`)
    .requiredOption(`--key <key>`, `Attribute Key.`)
    .option(`--on-delete <on-delete>`, `Constraints option`)
...
databases
    ...
    .description(`[**DEPRECATED** - This command is deprecated. Please use 'tables list-rows' instead] Get a list of all the user's documents in a given collection. You can use the query params to filter your results.`)
    .requiredOption(`--database-id <database-id>`, `Database ID.`)
...
databases
    ...
    .description(`[**DEPRECATED** - This command is deprecated. Please use 'tables create-row' instead] Create a new Document. Before using this route, you should create a new collection resource using either a [server integration](https://appwrite.io/docs/server/databases#databasesCreateCollection) API or directly from your database console.`)
    .requiredOption(`--database-id <database-id>`, `Database ID.`)
...
databases
    ...
    .description(`[**DEPRECATED** - This command is deprecated. Please use 'tables delete-rows' instead] **WARNING: Experimental Feature** - This endpoint is experimental and not yet officially supported. It may be subject to breaking changes or removal in future versions.  Bulk delete documents using queries, if no queries are passed then all documents are deleted.`)
    .requiredOption(`--database-id <database-id>`, `Database ID.`)
    .requiredOption(`--collection-id <collection-id>`, `Collection ID. You can create a new collection using the Database service [server integration](https://appwrite.io/docs/server/databases#databasesCreateCollection).`)
    .option(`--queries [queries...]`, `Array of query strings generated using the Query class provided by the SDK. [Learn more about queries](https://appwrite.io/docs/queries). Maximum of 100 queries are allowed, each 4096 characters long.`)
...
databases
    ...
    .description(`[**DEPRECATED** - This command is deprecated. Please use 'tables get-row' instead] Get a document by its unique ID. This endpoint response returns a JSON object with the document data.`)
    .requiredOption(`--database-id <database-id>`, `Database ID.`)
    .requiredOption(`--collection-id <collection-id>`, `Collection ID. You can create a new collection using the Database service [server integration](https://appwrite.io/docs/server/databases#databasesCreateCollection).`)
...
databases
    ...
    .description(`[**DEPRECATED** - This command is deprecated. Please use 'tables update-row' instead] Update a document by its unique ID. Using the patch method you can pass only specific fields that will get updated.`)
    .requiredOption(`--database-id <database-id>`, `Database ID.`)
    .requiredOption(`--collection-id <collection-id>`, `Collection ID.`)
    .requiredOption(`--document-id <document-id>`, `Document ID.`)
    .option(`--data <data>`, `Document data as JSON object. Include only attribute and value pairs to be updated.`)
...
databases
    ...
    .description(`[**DEPRECATED** - This command is deprecated. Please use 'tables delete-row' instead] Delete a document by its unique ID.`)
    .requiredOption(`--database-id <database-id>`, `Database ID.`)
    .requiredOption(`--collection-id <collection-id>`, `Collection ID. You can create a new collection using the Database service [server integration](https://appwrite.io/docs/server/databases#databasesCreateCollection).`)
    .requiredOption(`--document-id <document-id>`, `Document ID.`)
...
databases
    ...
    .description(`[**DEPRECATED** - This command is deprecated. Please use 'tables list-logs' instead] Get the document activity logs list by its unique ID.`)
    .requiredOption(`--database-id <database-id>`, `Database ID.`)
    .requiredOption(`--collection-id <collection-id>`, `Collection ID.`)
    .requiredOption(`--document-id <document-id>`, `Document ID.`)
...
databases
    ...
    .description(`[**DEPRECATED** - This command is deprecated. Please use 'tables decrement-row-column' instead] Decrement a specific attribute of a document by a given value.`)
    .requiredOption(`--database-id <database-id>`, `Database ID.`)
    .requiredOption(`--collection-id <collection-id>`, `Collection ID.`)
    .requiredOption(`--document-id <document-id>`, `Document ID.`)
...
databases
    ...
    .description(`[**DEPRECATED** - This command is deprecated. Please use 'tables increment-row-column' instead] Increment a specific attribute of a document by a given value.`)
    .requiredOption(`--database-id <database-id>`, `Database ID.`)
    .requiredOption(`--collection-id <collection-id>`, `Collection ID.`)
    .requiredOption(`--document-id <document-id>`, `Document ID.`)
    .requiredOption(`--attribute <attribute>`, `Attribute key.`)
...
databases
    ...
    .description(`[**DEPRECATED** - This command is deprecated. Please use 'tables list-indexes' instead] List indexes in the collection.`)
    .requiredOption(`--database-id <database-id>`, `Database ID.`)
    .requiredOption(`--collection-id <collection-id>`, `Collection ID. You can create a new collection using the Database service [server integration](https://appwrite.io/docs/server/databases#databasesCreateCollection).`)
...
databases
    ...
    .description(`[**DEPRECATED** - This command is deprecated. Please use 'tables create-index' instead] Creates an index on the attributes listed. Your index should include all the attributes you will query in a single request. Attributes can be 'key', 'fulltext', and 'unique'.`)
    .requiredOption(`--database-id <database-id>`, `Database ID.`)
    .requiredOption(`--collection-id <collection-id>`, `Collection ID. You can create a new collection using the Database service [server integration](https://appwrite.io/docs/server/databases#databasesCreateCollection).`)
...
databases
    .command(`get-index`)
    .description(`[**DEPRECATED** - This command is deprecated. Please use 'tables get-index' instead] Get index by ID.`)
    .requiredOption(`--database-id <database-id>`, `Database ID.`)
    .requiredOption(`--collection-id <collection-id>`, `Collection ID. You can create a new collection using the Database service [server integration](https://appwrite.io/docs/server/databases#databasesCreateCollection).`)
    .requiredOption(`--key <key>`, `Index Key.`)
...
databases
    ...
    .description(`[**DEPRECATED** - This command is deprecated. Please use 'tables delete-index' instead] Delete an index.`)
    .requiredOption(`--database-id <database-id>`, `Database ID.`)
    .requiredOption(`--collection-id <collection-id>`, `Collection ID. You can create a new collection using the Database service [server integration](https://appwrite.io/docs/server/databases#databasesCreateCollection).`)
    .requiredOption(`--key <key>`, `Index Key.`)
...
databases
    ...
    .description(`[**DEPRECATED** - This command is deprecated. Please use 'tables list-logs' instead] Get the collection activity logs list by its unique ID.`)
    .requiredOption(`--database-id <database-id>`, `Database ID.`)
    .requiredOption(`--collection-id <collection-id>`, `Collection ID.`)
    .option(`--queries [queries...]`, `Array of query strings generated using the Query class provided by the SDK. [Learn more about queries](https://appwrite.io/docs/queries). Only supported methods are limit and offset`)
...
databases
    ...
    .description(`[**DEPRECATED** - This command is deprecated. Please use 'tables get-usage' instead] Get usage metrics and statistics for a collection. Returning the total number of documents. The response includes both current totals and historical data over time. Use the optional range parameter to specify the time window for historical data: 24h (last 24 hours), 30d (last 30 days), or 90d (last 90 days). If not specified, range defaults to 30 days.`)
    .requiredOption(`--database-id <database-id>`, `Database ID.`)
    .requiredOption(`--collection-id <collection-id>`, `Collection ID.`)
    .option(`--range <range>`, `Date range.`)
