...
/**
 * @typedef {Object} UsersListFactorsRequestParams
 * @property {string} userId User ID.
 * @property {boolean} parseOutput
 * @property {libClient | undefined} sdk
 */
...
/**
 * @param {UsersListFactorsRequestParams} params
 */
const usersListFactors = async ({ userId, parseOutput = true, sdk = undefined}) => {
    let client = !sdk ? await sdkForProject() : sdk;
...
/**
 * @typedef {Object} UsersDeleteAuthenticatorRequestParams
 * @property {string} userId User ID.
...
/**
 * @param {UsersDeleteAuthenticatorRequestParams} params
 */
const usersDeleteAuthenticator = async ({ userId, type, otp, parseOutput = true, sdk = undefined}) => {
    let client = !sdk ? await sdkForProject() : sdk;
    
    let apiPath = '/users/{userId}/mfa/{type}'.replace('{userId}', userId).replace('{type}', type);
    let payload = {};
...
users
    ...
    .description(``)
    .requiredOption(`--userId <userId>`, `User ID.`)
    .action(actionRunner(usersListFactors))
...
users
    ...
    .action(actionRunner(usersDeleteAuthenticator))
