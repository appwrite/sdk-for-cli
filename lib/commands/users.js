...
users
    .command(`update-mfa`)
    .description(`[**DEPRECATED** - This command is deprecated. Please use 'update-mfa' instead] Enable or disable MFA on a user account.`)
    .requiredOption(`--user-id <user-id>`, `User ID.`)
...
users
    ...
    .description(`[**DEPRECATED** - This command is deprecated. Please use 'delete-mfa-authenticator' instead] Delete an authenticator app.`)
    .requiredOption(`--user-id <user-id>`, `User ID.`)
...
users
    ...
    .description(`[**DEPRECATED** - This command is deprecated. Please use 'create-mfa-recovery-codes' instead] Generate recovery codes used as backup for MFA flow for User ID. Recovery codes can be used as a MFA verification type in [createMfaChallenge](/docs/references/cloud/client-web/account#createMfaChallenge) method by client SDK.`)
    .requiredOption(`--user-id <user-id>`, `User ID.`)
