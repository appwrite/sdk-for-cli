...
users
    .command(`update-mfa`)
    .description(`[**DEPRECATED** - This command is deprecated. Please use 'users update-mfa' instead] Enable or disable MFA on a user account.`)
    .requiredOption(`--user-id <user-id>`, `User ID.`)
...
users
    ...
    .description(`[**DEPRECATED** - This command is deprecated. Please use 'users delete-mfa-authenticator' instead] Delete an authenticator app.`)
    .requiredOption(`--user-id <user-id>`, `User ID.`)
...
users
    ...
    .description(`[**DEPRECATED** - This command is deprecated. Please use 'users list-mfa-factors' instead] List the factors available on the account to be used as a MFA challange.`)
    .requiredOption(`--user-id <user-id>`, `User ID.`)
...
users
    ...
    .description(`[**DEPRECATED** - This command is deprecated. Please use 'users get-mfa-recovery-codes' instead] Get recovery codes that can be used as backup for MFA flow by User ID. Before getting codes, they must be generated using [createMfaRecoveryCodes](/docs/references/cloud/client-web/account#createMfaRecoveryCodes) method.`)
    .requiredOption(`--user-id <user-id>`, `User ID.`)
...
users
    ...
    .description(`[**DEPRECATED** - This command is deprecated. Please use 'users update-mfa-recovery-codes' instead] Regenerate recovery codes that can be used as backup for MFA flow by User ID. Before regenerating codes, they must be first generated using [createMfaRecoveryCodes](/docs/references/cloud/client-web/account#createMfaRecoveryCodes) method.`)
    .requiredOption(`--user-id <user-id>`, `User ID.`)
...
users
    ...
    .description(`[**DEPRECATED** - This command is deprecated. Please use 'users create-mfa-recovery-codes' instead] Generate recovery codes used as backup for MFA flow for User ID. Recovery codes can be used as a MFA verification type in [createMfaChallenge](/docs/references/cloud/client-web/account#createMfaChallenge) method by client SDK.`)
    .requiredOption(`--user-id <user-id>`, `User ID.`)
