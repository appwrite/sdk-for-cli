...
export const projectGetUsage = async ({
  startDate,
  endDate,
  period,
  parseOutput = true,
  ...
  sdk = undefined,
}: ProjectGetUsageRequestParams): Promise<any> => {
...
export const projectListVariables = async ({
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: ProjectListVariablesRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const projectCreateVariable = async ({
  key,
  value,
  secret,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: ProjectCreateVariableRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/project/variables";
  let payload = {};
...
export const projectGetVariable = async ({
  variableId,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: ProjectGetVariableRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/project/variables/{variableId}".replace(
    "{variableId}",
    variableId,
  );
  let payload = {};
...
export const projectUpdateVariable = async ({
  variableId,
  key,
  value,
  secret,
  ...
  overrideForCli = false,
  sdk = undefined,
}: ProjectUpdateVariableRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/project/variables/{variableId}".replace(
    "{variableId}",
    variableId,
...
export const projectDeleteVariable = async ({
  variableId,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: ProjectDeleteVariableRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/project/variables/{variableId}".replace(
    "{variableId}",
    variableId,
