...
export const storageListBuckets = async ({
  queries,
  search,
  total,
  parseOutput = true,
  ...
  sdk = undefined,
  console: showConsole,
}: StorageListBucketsRequestParams): Promise<any> => {
...
export const storageCreateBucket = async ({
  bucketId,
  name,
  permissions,
  fileSecurity,
  ...
  overrideForCli = false,
  sdk = undefined,
}: StorageCreateBucketRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/storage/buckets";
  let payload = {};
  ...
  allowedFileExtensions =
    (allowedFileExtensions as unknown) === true ? [] : allowedFileExtensions;
...
export const storageGetBucket = async ({
  bucketId,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
  console: showConsole,
}: StorageGetBucketRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const storageUpdateBucket = async ({
  bucketId,
  name,
  permissions,
  fileSecurity,
  ...
  overrideForCli = false,
  sdk = undefined,
}: StorageUpdateBucketRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/storage/buckets/{bucketId}".replace("{bucketId}", bucketId);
  let payload = {};
  if (typeof name !== "undefined") {
...
export const storageDeleteBucket = async ({
  bucketId,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: StorageDeleteBucketRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/storage/buckets/{bucketId}".replace("{bucketId}", bucketId);
  let payload = {};
...
export const storageListFiles = async ({
  bucketId,
  queries,
  search,
  total,
  ...
  sdk = undefined,
  console: showConsole,
}: StorageListFilesRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/storage/buckets/{bucketId}/files".replace(
    "{bucketId}",
    bucketId,
  );
  let payload = {};
...
export const storageCreateFile = async ({
  bucketId,
  fileId,
  file,
  permissions,
...
}: StorageCreateFileRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/storage/buckets/{bucketId}/files".replace(
    "{bucketId}",
    bucketId,
...
export const storageGetFile = async ({
  bucketId,
  fileId,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
  console: showConsole,
}: StorageGetFileRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const storageUpdateFile = async ({
  bucketId,
  fileId,
  name,
  permissions,
  ...
  overrideForCli = false,
  sdk = undefined,
}: StorageUpdateFileRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/storage/buckets/{bucketId}/files/{fileId}"
    .replace("{bucketId}", bucketId)
    .replace("{fileId}", fileId);
...
export const storageDeleteFile = async ({
  bucketId,
  fileId,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: StorageDeleteFileRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/storage/buckets/{bucketId}/files/{fileId}"
    .replace("{bucketId}", bucketId)
    .replace("{fileId}", fileId);
...
export const storageGetFileDownload = async ({
  bucketId,
  fileId,
  token,
  parseOutput = true,
  ...
  sdk = undefined,
  destination,
}: StorageGetFileDownloadRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const storageGetFilePreview = async ({
  bucketId,
  fileId,
  width,
  height,
  ...
  sdk = undefined,
  destination,
}: StorageGetFilePreviewRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const storageGetFileView = async ({
  bucketId,
  fileId,
  token,
  parseOutput = true,
  ...
  sdk = undefined,
  destination,
}: StorageGetFileViewRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const storageGetUsage = async ({
  range,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: StorageGetUsageRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const storageGetBucketUsage = async ({
  bucketId,
  range,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
  console: showConsole,
}: StorageGetBucketUsageRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
