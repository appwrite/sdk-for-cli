...
class Databases {
  ...
  async list(queries?: any[], search?: string, total?: boolean): Promise<any> {
    return { result: 'GET:/v1/databases:passed' };
  }

  async create(databaseId: string, name: string, enabled?: boolean): Promise<any> {
    return { result: 'POST:/v1/databases:passed' };
  }

  async listTransactions(queries?: any[]): Promise<any> {
    return { result: 'GET:/v1/databases/transactions:passed' };
  }

  async createTransaction(ttl?: number): Promise<any> {
    return { result: 'POST:/v1/databases/transactions:passed' };
  }

  async getTransaction(transactionId: string): Promise<any> {
    return { result: 'GET:/v1/databases/transactions/{transactionId}:passed' };
  }

  async updateTransaction(transactionId: string, commit?: boolean, rollback?: boolean): Promise<any> {
    return { result: 'PATCH:/v1/databases/transactions/{transactionId}:passed' };
  }

  async deleteTransaction(transactionId: string): Promise<any> {
    return { result: 'DELETE:/v1/databases/transactions/{transactionId}:passed' };
  }

  async createOperations(transactionId: string, operations?: any[]): Promise<any> {
    return { result: 'POST:/v1/databases/transactions/{transactionId}/operations:passed' };
  }

  async listUsage(range?: string): Promise<any> {
    return { result: 'GET:/v1/databases/usage:passed' };
  }

  async get(databaseId: string): Promise<any> {
    return { result: 'GET:/v1/databases/{databaseId}:passed' };
  }

  async update(databaseId: string, name: string, enabled?: boolean): Promise<any> {
    return { result: 'PUT:/v1/databases/{databaseId}:passed' };
  }

  async delete(databaseId: string): Promise<any> {
    return { result: 'DELETE:/v1/databases/{databaseId}:passed' };
  }

  async listCollections(databaseId: string, queries?: any[], search?: string, total?: boolean): Promise<any> {
    return { result: 'GET:/v1/databases/{databaseId}/collections:passed' };
  }

  async createCollection(databaseId: string, collectionId: string, name: string, permissions?: any[], documentSecurity?: boolean, enabled?: boolean, attributes?: any[], indexes?: any[]): Promise<any> {
    return { result: 'POST:/v1/databases/{databaseId}/collections:passed' };
  }

  async getCollection(databaseId: string, collectionId: string): Promise<any> {
    return { result: 'GET:/v1/databases/{databaseId}/collections/{collectionId}:passed' };
  }

  async updateCollection(databaseId: string, collectionId: string, name: string, permissions?: any[], documentSecurity?: boolean, enabled?: boolean): Promise<any> {
    return { result: 'PUT:/v1/databases/{databaseId}/collections/{collectionId}:passed' };
  }

  async deleteCollection(databaseId: string, collectionId: string): Promise<any> {
    return { result: 'DELETE:/v1/databases/{databaseId}/collections/{collectionId}:passed' };
  }

  async listAttributes(databaseId: string, collectionId: string, queries?: any[], total?: boolean): Promise<any> {
    return { result: 'GET:/v1/databases/{databaseId}/collections/{collectionId}/attributes:passed' };
  }

  async createBooleanAttribute(databaseId: string, collectionId: string, key: string, required: boolean, xDefault?: boolean, array?: boolean): Promise<any> {
    return { result: 'POST:/v1/databases/{databaseId}/collections/{collectionId}/attributes/boolean:passed' };
  }

  async updateBooleanAttribute(databaseId: string, collectionId: string, key: string, required: boolean, xDefault: boolean, newKey?: string): Promise<any> {
    return { result: 'PATCH:/v1/databases/{databaseId}/collections/{collectionId}/attributes/boolean/{key}:passed' };
  }

  async createDatetimeAttribute(databaseId: string, collectionId: string, key: string, required: boolean, xDefault?: string, array?: boolean): Promise<any> {
    return { result: 'POST:/v1/databases/{databaseId}/collections/{collectionId}/attributes/datetime:passed' };
  }

  async updateDatetimeAttribute(databaseId: string, collectionId: string, key: string, required: boolean, xDefault: string, newKey?: string): Promise<any> {
    return { result: 'PATCH:/v1/databases/{databaseId}/collections/{collectionId}/attributes/datetime/{key}:passed' };
  }

  async createEmailAttribute(databaseId: string, collectionId: string, key: string, required: boolean, xDefault?: string, array?: boolean): Promise<any> {
    return { result: 'POST:/v1/databases/{databaseId}/collections/{collectionId}/attributes/email:passed' };
  }

  async updateEmailAttribute(databaseId: string, collectionId: string, key: string, required: boolean, xDefault: string, newKey?: string): Promise<any> {
    return { result: 'PATCH:/v1/databases/{databaseId}/collections/{collectionId}/attributes/email/{key}:passed' };
  }

  async createEnumAttribute(databaseId: string, collectionId: string, key: string, elements: any[], required: boolean, xDefault?: string, array?: boolean): Promise<any> {
    return { result: 'POST:/v1/databases/{databaseId}/collections/{collectionId}/attributes/enum:passed' };
  }

  async updateEnumAttribute(databaseId: string, collectionId: string, key: string, elements: any[], required: boolean, xDefault: string, newKey?: string): Promise<any> {
    return { result: 'PATCH:/v1/databases/{databaseId}/collections/{collectionId}/attributes/enum/{key}:passed' };
  }

  async createFloatAttribute(databaseId: string, collectionId: string, key: string, required: boolean, min?: number, max?: number, xDefault?: number, array?: boolean): Promise<any> {
    return { result: 'POST:/v1/databases/{databaseId}/collections/{collectionId}/attributes/float:passed' };
  }

  async updateFloatAttribute(databaseId: string, collectionId: string, key: string, required: boolean, xDefault: number, min?: number, max?: number, newKey?: string): Promise<any> {
    return { result: 'PATCH:/v1/databases/{databaseId}/collections/{collectionId}/attributes/float/{key}:passed' };
  }

  async createIntegerAttribute(databaseId: string, collectionId: string, key: string, required: boolean, min?: number, max?: number, xDefault?: number, array?: boolean): Promise<any> {
    return { result: 'POST:/v1/databases/{databaseId}/collections/{collectionId}/attributes/integer:passed' };
  }

  async updateIntegerAttribute(databaseId: string, collectionId: string, key: string, required: boolean, xDefault: number, min?: number, max?: number, newKey?: string): Promise<any> {
    return { result: 'PATCH:/v1/databases/{databaseId}/collections/{collectionId}/attributes/integer/{key}:passed' };
  }

  async createIpAttribute(databaseId: string, collectionId: string, key: string, required: boolean, xDefault?: string, array?: boolean): Promise<any> {
    return { result: 'POST:/v1/databases/{databaseId}/collections/{collectionId}/attributes/ip:passed' };
  }

  async updateIpAttribute(databaseId: string, collectionId: string, key: string, required: boolean, xDefault: string, newKey?: string): Promise<any> {
    return { result: 'PATCH:/v1/databases/{databaseId}/collections/{collectionId}/attributes/ip/{key}:passed' };
  }

  async createLineAttribute(databaseId: string, collectionId: string, key: string, required: boolean, xDefault?: any[]): Promise<any> {
    return { result: 'POST:/v1/databases/{databaseId}/collections/{collectionId}/attributes/line:passed' };
  }

  async updateLineAttribute(databaseId: string, collectionId: string, key: string, required: boolean, xDefault?: any[], newKey?: string): Promise<any> {
    return { result: 'PATCH:/v1/databases/{databaseId}/collections/{collectionId}/attributes/line/{key}:passed' };
  }

  async createPointAttribute(databaseId: string, collectionId: string, key: string, required: boolean, xDefault?: any[]): Promise<any> {
    return { result: 'POST:/v1/databases/{databaseId}/collections/{collectionId}/attributes/point:passed' };
  }

  async updatePointAttribute(databaseId: string, collectionId: string, key: string, required: boolean, xDefault?: any[], newKey?: string): Promise<any> {
    return { result: 'PATCH:/v1/databases/{databaseId}/collections/{collectionId}/attributes/point/{key}:passed' };
  }

  async createPolygonAttribute(databaseId: string, collectionId: string, key: string, required: boolean, xDefault?: any[]): Promise<any> {
    return { result: 'POST:/v1/databases/{databaseId}/collections/{collectionId}/attributes/polygon:passed' };
  }

  async updatePolygonAttribute(databaseId: string, collectionId: string, key: string, required: boolean, xDefault?: any[], newKey?: string): Promise<any> {
    return { result: 'PATCH:/v1/databases/{databaseId}/collections/{collectionId}/attributes/polygon/{key}:passed' };
  }

  async createRelationshipAttribute(databaseId: string, collectionId: string, relatedCollectionId: string, type: string, twoWay?: boolean, key?: string, twoWayKey?: string, onDelete?: string): Promise<any> {
    return { result: 'POST:/v1/databases/{databaseId}/collections/{collectionId}/attributes/relationship:passed' };
  }

  async createStringAttribute(databaseId: string, collectionId: string, key: string, size: number, required: boolean, xDefault?: string, array?: boolean, encrypt?: boolean): Promise<any> {
    return { result: 'POST:/v1/databases/{databaseId}/collections/{collectionId}/attributes/string:passed' };
  }

  async updateStringAttribute(databaseId: string, collectionId: string, key: string, required: boolean, xDefault: string, size?: number, newKey?: string): Promise<any> {
    return { result: 'PATCH:/v1/databases/{databaseId}/collections/{collectionId}/attributes/string/{key}:passed' };
  }

  async createUrlAttribute(databaseId: string, collectionId: string, key: string, required: boolean, xDefault?: string, array?: boolean): Promise<any> {
    return { result: 'POST:/v1/databases/{databaseId}/collections/{collectionId}/attributes/url:passed' };
  }

  async updateUrlAttribute(databaseId: string, collectionId: string, key: string, required: boolean, xDefault: string, newKey?: string): Promise<any> {
    return { result: 'PATCH:/v1/databases/{databaseId}/collections/{collectionId}/attributes/url/{key}:passed' };
  }

  async getAttribute(databaseId: string, collectionId: string, key: string): Promise<any> {
    return { result: 'GET:/v1/databases/{databaseId}/collections/{collectionId}/attributes/{key}:passed' };
  }

  async deleteAttribute(databaseId: string, collectionId: string, key: string): Promise<any> {
    return { result: 'DELETE:/v1/databases/{databaseId}/collections/{collectionId}/attributes/{key}:passed' };
  }

  async updateRelationshipAttribute(databaseId: string, collectionId: string, key: string, onDelete?: string, newKey?: string): Promise<any> {
    return { result: 'PATCH:/v1/databases/{databaseId}/collections/{collectionId}/attributes/{key}/relationship:passed' };
  }

  async listDocuments(databaseId: string, collectionId: string, queries?: any[], transactionId?: string, total?: boolean): Promise<any> {
    return { result: 'GET:/v1/databases/{databaseId}/collections/{collectionId}/documents:passed' };
  }

  async createDocument(databaseId: string, collectionId: string, documentId: string, data: any, permissions?: any[], transactionId?: string): Promise<any> {
    return { result: 'POST:/v1/databases/{databaseId}/collections/{collectionId}/documents:passed' };
  }

  async createDocuments(databaseId: string, collectionId: string, documents: any[], transactionId?: string): Promise<any> {
    return { result: 'POST:/v1/databases/{databaseId}/collections/{collectionId}/documents:passed' };
  }

  async upsertDocuments(databaseId: string, collectionId: string, documents: any[], transactionId?: string): Promise<any> {
    return { result: 'PUT:/v1/databases/{databaseId}/collections/{collectionId}/documents:passed' };
  }

  async updateDocuments(databaseId: string, collectionId: string, data?: any, queries?: any[], transactionId?: string): Promise<any> {
    return { result: 'PATCH:/v1/databases/{databaseId}/collections/{collectionId}/documents:passed' };
  }

  async deleteDocuments(databaseId: string, collectionId: string, queries?: any[], transactionId?: string): Promise<any> {
    return { result: 'DELETE:/v1/databases/{databaseId}/collections/{collectionId}/documents:passed' };
  }

  async getDocument(databaseId: string, collectionId: string, documentId: string, queries?: any[], transactionId?: string): Promise<any> {
    return { result: 'GET:/v1/databases/{databaseId}/collections/{collectionId}/documents/{documentId}:passed' };
  }

  async upsertDocument(databaseId: string, collectionId: string, documentId: string, data?: any, permissions?: any[], transactionId?: string): Promise<any> {
    return { result: 'PUT:/v1/databases/{databaseId}/collections/{collectionId}/documents/{documentId}:passed' };
  }

  async updateDocument(databaseId: string, collectionId: string, documentId: string, data?: any, permissions?: any[], transactionId?: string): Promise<any> {
    return { result: 'PATCH:/v1/databases/{databaseId}/collections/{collectionId}/documents/{documentId}:passed' };
  }

  async deleteDocument(databaseId: string, collectionId: string, documentId: string, transactionId?: string): Promise<any> {
    return { result: 'DELETE:/v1/databases/{databaseId}/collections/{collectionId}/documents/{documentId}:passed' };
  }

  async listDocumentLogs(databaseId: string, collectionId: string, documentId: string, queries?: any[]): Promise<any> {
    return { result: 'GET:/v1/databases/{databaseId}/collections/{collectionId}/documents/{documentId}/logs:passed' };
  }

  async decrementDocumentAttribute(databaseId: string, collectionId: string, documentId: string, attribute: string, value?: number, min?: number, transactionId?: string): Promise<any> {
    return { result: 'PATCH:/v1/databases/{databaseId}/collections/{collectionId}/documents/{documentId}/{attribute}/decrement:passed' };
  }

  async incrementDocumentAttribute(databaseId: string, collectionId: string, documentId: string, attribute: string, value?: number, max?: number, transactionId?: string): Promise<any> {
    return { result: 'PATCH:/v1/databases/{databaseId}/collections/{collectionId}/documents/{documentId}/{attribute}/increment:passed' };
  }

  async listIndexes(databaseId: string, collectionId: string, queries?: any[], total?: boolean): Promise<any> {
    return { result: 'GET:/v1/databases/{databaseId}/collections/{collectionId}/indexes:passed' };
  }

  async createIndex(databaseId: string, collectionId: string, key: string, type: string, attributes: any[], orders?: any[], lengths?: any[]): Promise<any> {
    return { result: 'POST:/v1/databases/{databaseId}/collections/{collectionId}/indexes:passed' };
  }

  async getIndex(databaseId: string, collectionId: string, key: string): Promise<any> {
    return { result: 'GET:/v1/databases/{databaseId}/collections/{collectionId}/indexes/{key}:passed' };
  }

  async deleteIndex(databaseId: string, collectionId: string, key: string): Promise<any> {
    return { result: 'DELETE:/v1/databases/{databaseId}/collections/{collectionId}/indexes/{key}:passed' };
  }

  async listCollectionLogs(databaseId: string, collectionId: string, queries?: any[]): Promise<any> {
    return { result: 'GET:/v1/databases/{databaseId}/collections/{collectionId}/logs:passed' };
  }

  async getCollectionUsage(databaseId: string, collectionId: string, range?: string): Promise<any> {
    return { result: 'GET:/v1/databases/{databaseId}/collections/{collectionId}/usage:passed' };
  }

  async listLogs(databaseId: string, queries?: any[]): Promise<any> {
    return { result: 'GET:/v1/databases/{databaseId}/logs:passed' };
  }

  async getUsage(databaseId: string, range?: string): Promise<any> {
    return { result: 'GET:/v1/databases/{databaseId}/usage:passed' };
  }
}
...
`)
  .requiredOption(`--databaseid <databaseid>`, `Database ID.`)
  .requiredOption(`--collectionid <collectionid>`, `Collection ID. You can create a new table using the Database service [server integration](https://appwrite.io/docs/server/databases#databasesCreateCollection).`)
...
databases
  ...
  .requiredOption(`--databaseid <databaseid>`, `Database ID.`)
  .requiredOption(`--collectionid <collectionid>`, `Collection ID. You can create a new collection using the Database service [server integration](https://appwrite.io/docs/server/databases#createCollection).`)
  .requiredOption(`--key <key>`, `Attribute Key.`)
  .requiredOption(`--required <required>`, `Is attribute required?`, parseBool)
  ...
  .option(`--newkey <newkey>`, `New attribute key.`)
  .action(
    actionRunner(
...
`)
  .requiredOption(`--databaseid <databaseid>`, `Database ID.`)
  .requiredOption(`--collectionid <collectionid>`, `Collection ID.`)
  .requiredOption(`--relatedcollectionid <relatedcollectionid>`, `Related Collection ID.`)
