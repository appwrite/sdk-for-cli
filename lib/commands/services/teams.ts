  ...
  .action(
    actionRunner(
      async ({ queries, search, total, filter, where, sortAsc, sortDesc, cursorAfter, cursorBefore, limit, offset }) =>
        parse(await (await getTeamsClient()).list(buildQueries({ queries, filter, where, sortAsc, sortDesc, cursorAfter, cursorBefore, limit, offset }), search, total)),
    ),
  );
...
const teamsListInstallationsCommand = teams
  ...
  .action(
    actionRunner(
      async ({ teamId, queries, total, filter, where, sortAsc, sortDesc, cursorAfter, cursorBefore, limit, offset }) =>
        parse(await (await getTeamsClient()).listInstallations(teamId, buildQueries({ queries, filter, where, sortAsc, sortDesc, cursorAfter, cursorBefore, limit, offset }), total)),
    ),
  );


const teamsCreateInstallationCommand = teams
  ...
  .action(
    actionRunner(
      async ({ teamId, appId, authorizationDetails }) =>
        parse(await (await getTeamsClient()).createInstallation(teamId, appId, authorizationDetails)),
    ),
  );


const teamsGetInstallationCommand = teams
  ...
  .action(
    actionRunner(
      async ({ teamId, installationId }) =>
        parse(await (await getTeamsClient()).getInstallation(teamId, installationId)),
    ),
  );


const teamsUpdateInstallationCommand = teams
  ...
  .action(
    actionRunner(
      async ({ teamId, installationId, authorizationDetails }) =>
        parse(await (await getTeamsClient()).updateInstallation(teamId, installationId, authorizationDetails)),
    ),
  );


const teamsDeleteInstallationCommand = teams
  ...
  .action(
    actionRunner(
      async ({ teamId, installationId }) =>
        parse(await (await getTeamsClient()).deleteInstallation(teamId, installationId)),
    ),
  );
...
const teamsListMembershipsCommand = teams
  ...
  .action(
    actionRunner(
      async ({ teamId, queries, search, total, filter, where, sortAsc, sortDesc, cursorAfter, cursorBefore, limit, offset }) =>
        parse(await (await getTeamsClient()).listMemberships(teamId, buildQueries({ queries, filter, where, sortAsc, sortDesc, cursorAfter, cursorBefore, limit, offset }), search, total)),
    ),
  );
