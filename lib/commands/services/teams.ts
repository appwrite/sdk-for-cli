  ...
  .action(
    actionRunner(
      async ({ queries, search, total }) =>
        await (await getTeamsClient()).list(queries, search, total),
    ),
  );
  ...
  .action(
    actionRunner(
      async ({ teamId, name, roles }) =>
        await (await getTeamsClient()).create(teamId, name, roles),
    ),
  );
...
teams
  ...
  .action(
    actionRunner(
      async ({ teamId }) => await (await getTeamsClient()).get(teamId),
    ),
  );
...
teams
  ...
  .action(
    actionRunner(
      async ({ teamId, name }) =>
        await (await getTeamsClient()).updateName(teamId, name),
    ),
  );
...
teams
  ...
  .action(
    actionRunner(
      async ({ teamId }) => await (await getTeamsClient()).delete(teamId),
    ),
  );
  ...
  .action(
    actionRunner(
      async ({ teamId, queries, total }) =>
        await (await getTeamsClient()).listLogs(teamId, queries, total),
    ),
  );
  ...
  .action(
    actionRunner(
      async ({ teamId, queries, search, total }) =>
        ...
        ).listMemberships(teamId, queries, search, total),
    ),
  );
...
`,
  ...
  .action(
    actionRunner(
      async ({ teamId, email, userId, phone, roles, url, name }) =>
        await (
          await getTeamsClient()
        ).createMembership(teamId, email, userId, phone, roles, url, name),
    ),
  );
  ...
  .action(
    actionRunner(
      async ({ teamId, membershipId }) =>
        await (await getTeamsClient()).getMembership(teamId, membershipId),
    ),
  );
...
teams
  ...
  .action(
    actionRunner(
      async ({ teamId, membershipId }) =>
        await (await getTeamsClient()).deleteMembership(teamId, membershipId),
    ),
  );
...
teams
  ...
  .action(
    actionRunner(
      async ({ teamId }) => await (await getTeamsClient()).getPrefs(teamId),
    ),
  );
...
teams
  ...
  .action(
    actionRunner(
      async ({ teamId, prefs }) =>
        await (await getTeamsClient()).updatePrefs(teamId, JSON.parse(prefs)),
    ),
  );
