...
class Users {
  ...
  async list(queries?: any[], search?: string, total?: boolean): Promise<any> {
    return { result: 'GET:/v1/users:passed' };
  }

  async create(userId: string, email?: string, phone?: string, password?: string, name?: string): Promise<any> {
    return { result: 'POST:/v1/users:passed' };
  }

  async createArgon2User(userId: string, email: string, password: string, name?: string): Promise<any> {
    return { result: 'POST:/v1/users/argon2:passed' };
  }

  async createBcryptUser(userId: string, email: string, password: string, name?: string): Promise<any> {
    return { result: 'POST:/v1/users/bcrypt:passed' };
  }

  async listIdentities(queries?: any[], search?: string, total?: boolean): Promise<any> {
    return { result: 'GET:/v1/users/identities:passed' };
  }

  async deleteIdentity(identityId: string): Promise<any> {
    return { result: 'DELETE:/v1/users/identities/{identityId}:passed' };
  }

  async createMD5User(userId: string, email: string, password: string, name?: string): Promise<any> {
    return { result: 'POST:/v1/users/md5:passed' };
  }

  async createPHPassUser(userId: string, email: string, password: string, name?: string): Promise<any> {
    return { result: 'POST:/v1/users/phpass:passed' };
  }

  async createScryptUser(userId: string, email: string, password: string, passwordSalt: string, passwordCpu: number, passwordMemory: number, passwordParallel: number, passwordLength: number, name?: string): Promise<any> {
    return { result: 'POST:/v1/users/scrypt:passed' };
  }

  async createScryptModifiedUser(userId: string, email: string, password: string, passwordSalt: string, passwordSaltSeparator: string, passwordSignerKey: string, name?: string): Promise<any> {
    return { result: 'POST:/v1/users/scrypt-modified:passed' };
  }

  async createSHAUser(userId: string, email: string, password: string, passwordVersion?: string, name?: string): Promise<any> {
    return { result: 'POST:/v1/users/sha:passed' };
  }

  async getUsage(range?: string): Promise<any> {
    return { result: 'GET:/v1/users/usage:passed' };
  }

  async get(userId: string): Promise<any> {
    return { result: 'GET:/v1/users/{userId}:passed' };
  }

  async delete(userId: string): Promise<any> {
    return { result: 'DELETE:/v1/users/{userId}:passed' };
  }

  async updateEmail(userId: string, email: string): Promise<any> {
    return { result: 'PATCH:/v1/users/{userId}/email:passed' };
  }

  async createJWT(userId: string, sessionId?: string, duration?: number): Promise<any> {
    return { result: 'POST:/v1/users/{userId}/jwts:passed' };
  }

  async updateLabels(userId: string, labels: any[]): Promise<any> {
    return { result: 'PUT:/v1/users/{userId}/labels:passed' };
  }

  async listLogs(userId: string, queries?: any[], total?: boolean): Promise<any> {
    return { result: 'GET:/v1/users/{userId}/logs:passed' };
  }

  async listMemberships(userId: string, queries?: any[], search?: string, total?: boolean): Promise<any> {
    return { result: 'GET:/v1/users/{userId}/memberships:passed' };
  }

  async updateMfa(userId: string, mfa: boolean): Promise<any> {
    return { result: 'PATCH:/v1/users/{userId}/mfa:passed' };
  }
  ...
  async deleteMfaAuthenticator(userId: string, type: string): Promise<any> {
    return { result: 'DELETE:/v1/users/{userId}/mfa/authenticators/{type}:passed' };
  }
  ...
  async listMfaFactors(userId: string): Promise<any> {
    return { result: 'GET:/v1/users/{userId}/mfa/factors:passed' };
  }
  ...
  async getMfaRecoveryCodes(userId: string): Promise<any> {
    return { result: 'GET:/v1/users/{userId}/mfa/recovery-codes:passed' };
  }
  ...
  async updateMfaRecoveryCodes(userId: string): Promise<any> {
    return { result: 'PUT:/v1/users/{userId}/mfa/recovery-codes:passed' };
  }
  ...
  async createMfaRecoveryCodes(userId: string): Promise<any> {
    return { result: 'PATCH:/v1/users/{userId}/mfa/recovery-codes:passed' };
  }
  ...
  async updateName(userId: string, name: string): Promise<any> {
    return { result: 'PATCH:/v1/users/{userId}/name:passed' };
  }

  async updatePassword(userId: string, password: string): Promise<any> {
    return { result: 'PATCH:/v1/users/{userId}/password:passed' };
  }

  async updatePhone(userId: string, number: string): Promise<any> {
    return { result: 'PATCH:/v1/users/{userId}/phone:passed' };
  }

  async getPrefs(userId: string): Promise<any> {
    return { result: 'GET:/v1/users/{userId}/prefs:passed' };
  }

  async updatePrefs(userId: string, prefs: any): Promise<any> {
    return { result: 'PATCH:/v1/users/{userId}/prefs:passed' };
  }

  async listSessions(userId: string, total?: boolean): Promise<any> {
    return { result: 'GET:/v1/users/{userId}/sessions:passed' };
  }

  async createSession(userId: string): Promise<any> {
    return { result: 'POST:/v1/users/{userId}/sessions:passed' };
  }

  async deleteSessions(userId: string): Promise<any> {
    return { result: 'DELETE:/v1/users/{userId}/sessions:passed' };
  }

  async deleteSession(userId: string, sessionId: string): Promise<any> {
    return { result: 'DELETE:/v1/users/{userId}/sessions/{sessionId}:passed' };
  }

  async updateStatus(userId: string, status: boolean): Promise<any> {
    return { result: 'PATCH:/v1/users/{userId}/status:passed' };
  }

  async listTargets(userId: string, queries?: any[], total?: boolean): Promise<any> {
    return { result: 'GET:/v1/users/{userId}/targets:passed' };
  }

  async createTarget(userId: string, targetId: string, providerType: string, identifier: string, providerId?: string, name?: string): Promise<any> {
    return { result: 'POST:/v1/users/{userId}/targets:passed' };
  }

  async getTarget(userId: string, targetId: string): Promise<any> {
    return { result: 'GET:/v1/users/{userId}/targets/{targetId}:passed' };
  }

  async updateTarget(userId: string, targetId: string, identifier?: string, providerId?: string, name?: string): Promise<any> {
    return { result: 'PATCH:/v1/users/{userId}/targets/{targetId}:passed' };
  }

  async deleteTarget(userId: string, targetId: string): Promise<any> {
    return { result: 'DELETE:/v1/users/{userId}/targets/{targetId}:passed' };
  }

  async createToken(userId: string, length?: number, expire?: number): Promise<any> {
    return { result: 'POST:/v1/users/{userId}/tokens:passed' };
  }

  async updateEmailVerification(userId: string, emailVerification: boolean): Promise<any> {
    return { result: 'PATCH:/v1/users/{userId}/verification:passed' };
  }

  async updatePhoneVerification(userId: string, phoneVerification: boolean): Promise<any> {
    return { result: 'PATCH:/v1/users/{userId}/verification/phone:passed' };
  }
}
