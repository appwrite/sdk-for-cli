...
class Functions {
  ...
  async list(queries?: any[], search?: string, total?: boolean): Promise<any> {
    return { result: 'GET:/v1/functions:passed' };
  }

  async create(functionId: string, name: string, runtime: string, execute?: any[], events?: any[], schedule?: string, timeout?: number, enabled?: boolean, logging?: boolean, entrypoint?: string, commands?: string, scopes?: any[], installationId?: string, providerRepositoryId?: string, providerBranch?: string, providerSilentMode?: boolean, providerRootDirectory?: string, specification?: string): Promise<any> {
    return { result: 'POST:/v1/functions:passed' };
  }

  async listRuntimes(): Promise<any> {
    return { result: 'GET:/v1/functions/runtimes:passed' };
  }

  async listSpecifications(): Promise<any> {
    return { result: 'GET:/v1/functions/specifications:passed' };
  }

  async listTemplates(runtimes?: any[], useCases?: any[], limit?: number, offset?: number, total?: boolean): Promise<any> {
    return { result: 'GET:/v1/functions/templates:passed' };
  }

  async getTemplate(templateId: string): Promise<any> {
    return { result: 'GET:/v1/functions/templates/{templateId}:passed' };
  }

  async listUsage(range?: string): Promise<any> {
    return { result: 'GET:/v1/functions/usage:passed' };
  }

  async get(functionId: string): Promise<any> {
    return { result: 'GET:/v1/functions/{functionId}:passed' };
  }
  ...
  async update(functionId: string, name: string, runtime?: string, execute?: any[], events?: any[], schedule?: string, timeout?: number, enabled?: boolean, logging?: boolean, entrypoint?: string, commands?: string, scopes?: any[], installationId?: string, providerRepositoryId?: string, providerBranch?: string, providerSilentMode?: boolean, providerRootDirectory?: string, specification?: string): Promise<any> {
    return { result: 'PUT:/v1/functions/{functionId}:passed' };
  }

  async delete(functionId: string): Promise<any> {
    return { result: 'DELETE:/v1/functions/{functionId}:passed' };
  }

  async updateFunctionDeployment(functionId: string, deploymentId: string): Promise<any> {
    return { result: 'PATCH:/v1/functions/{functionId}/deployment:passed' };
  }

  async listDeployments(functionId: string, queries?: any[], search?: string, total?: boolean): Promise<any> {
    return { result: 'GET:/v1/functions/{functionId}/deployments:passed' };
  }

  async createDeployment(functionId: string, code: any, activate: boolean, entrypoint?: string, commands?: string): Promise<any> {
    return { result: 'POST:/v1/functions/{functionId}/deployments:passed' };
  }

  async createDuplicateDeployment(functionId: string, deploymentId: string, buildId?: string): Promise<any> {
    return { result: 'POST:/v1/functions/{functionId}/deployments/duplicate:passed' };
  }

  async createTemplateDeployment(functionId: string, repository: string, owner: string, rootDirectory: string, type: string, reference: string, activate?: boolean): Promise<any> {
    return { result: 'POST:/v1/functions/{functionId}/deployments/template:passed' };
  }

  async createVcsDeployment(functionId: string, type: string, reference: string, activate?: boolean): Promise<any> {
    return { result: 'POST:/v1/functions/{functionId}/deployments/vcs:passed' };
  }

  async getDeployment(functionId: string, deploymentId: string): Promise<any> {
    return { result: 'GET:/v1/functions/{functionId}/deployments/{deploymentId}:passed' };
  }

  async deleteDeployment(functionId: string, deploymentId: string): Promise<any> {
    return { result: 'DELETE:/v1/functions/{functionId}/deployments/{deploymentId}:passed' };
  }

  async getDeploymentDownload(functionId: string, deploymentId: string, type?: string): Promise<any> {
    return { result: 'GET:/v1/functions/{functionId}/deployments/{deploymentId}/download:passed' };
  }

  async updateDeploymentStatus(functionId: string, deploymentId: string): Promise<any> {
    return { result: 'PATCH:/v1/functions/{functionId}/deployments/{deploymentId}/status:passed' };
  }

  async listExecutions(functionId: string, queries?: any[], total?: boolean): Promise<any> {
    return { result: 'GET:/v1/functions/{functionId}/executions:passed' };
  }

  async createExecution(functionId: string, body?: string, async?: boolean, path?: string, method?: string, headers?: any, scheduledAt?: string): Promise<any> {
    return { result: 'POST:/v1/functions/{functionId}/executions:passed' };
  }

  async getExecution(functionId: string, executionId: string): Promise<any> {
    return { result: 'GET:/v1/functions/{functionId}/executions/{executionId}:passed' };
  }

  async deleteExecution(functionId: string, executionId: string): Promise<any> {
    return { result: 'DELETE:/v1/functions/{functionId}/executions/{executionId}:passed' };
  }

  async getUsage(functionId: string, range?: string): Promise<any> {
    return { result: 'GET:/v1/functions/{functionId}/usage:passed' };
  }

  async listVariables(functionId: string): Promise<any> {
    return { result: 'GET:/v1/functions/{functionId}/variables:passed' };
  }

  async createVariable(functionId: string, key: string, value: string, secret?: boolean): Promise<any> {
    return { result: 'POST:/v1/functions/{functionId}/variables:passed' };
  }

  async getVariable(functionId: string, variableId: string): Promise<any> {
    return { result: 'GET:/v1/functions/{functionId}/variables/{variableId}:passed' };
  }

  async updateVariable(functionId: string, variableId: string, key: string, value?: string, secret?: boolean): Promise<any> {
    return { result: 'PUT:/v1/functions/{functionId}/variables/{variableId}:passed' };
  }

  async deleteVariable(functionId: string, variableId: string): Promise<any> {
    return { result: 'DELETE:/v1/functions/{functionId}/variables/{variableId}:passed' };
  }
}
