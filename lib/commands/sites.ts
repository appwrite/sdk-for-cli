...
export const sitesList = async ({
  ...
  sdk = undefined,
  console: showConsole,
}: SitesListRequestParams): Promise<any> => {
...
export const sitesCreate = async ({
  siteId,
  name,
  framework,
  buildRuntime,
  ...
  overrideForCli = false,
  sdk = undefined,
}: SitesCreateRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/sites";
  let payload = {};
...
export const sitesListFrameworks = async ({
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
  console: showConsole,
}: SitesListFrameworksRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const sitesListSpecifications = async ({
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
  console: showConsole,
}: SitesListSpecificationsRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const sitesListTemplates = async ({
  frameworks,
  useCases,
  limit,
  offset,
  ...
  sdk = undefined,
  console: showConsole,
}: SitesListTemplatesRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const sitesGetTemplate = async ({
  templateId,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
  console: showConsole,
}: SitesGetTemplateRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/sites/templates/{templateId}".replace(
    "{templateId}",
    templateId,
  );
  let payload = {};
...
export const sitesListUsage = async ({
  range,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
  console: showConsole,
}: SitesListUsageRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const sitesGet = async ({
  siteId,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
  console: showConsole,
}: SitesGetRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const sitesUpdate = async ({
  siteId,
  name,
  framework,
  enabled,
  ...
  overrideForCli = false,
  sdk = undefined,
}: SitesUpdateRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/sites/{siteId}".replace("{siteId}", siteId);
  let payload = {};
  if (typeof name !== "undefined") {
...
export const sitesDelete = async ({
  siteId,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: SitesDeleteRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/sites/{siteId}".replace("{siteId}", siteId);
  let payload = {};
...
export const sitesUpdateSiteDeployment = async ({
  siteId,
  deploymentId,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: SitesUpdateSiteDeploymentRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const sitesListDeployments = async ({
  siteId,
  queries,
  search,
  total,
  ...
  sdk = undefined,
  console: showConsole,
}: SitesListDeploymentsRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const sitesCreateDeployment = async ({
  siteId,
  code,
  activate,
  installCommand,
...
}: SitesCreateDeploymentRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/sites/{siteId}/deployments".replace("{siteId}", siteId);
  let payload = {};
  if (typeof installCommand !== "undefined") {
...
export const sitesCreateDuplicateDeployment = async ({
  siteId,
  deploymentId,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: SitesCreateDuplicateDeploymentRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/sites/{siteId}/deployments/duplicate".replace(
    "{siteId}",
    siteId,
  );
  let payload = {};
...
export const sitesCreateTemplateDeployment = async ({
  siteId,
  repository,
  owner,
  rootDirectory,
  ...
  overrideForCli = false,
  sdk = undefined,
}: SitesCreateTemplateDeploymentRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/sites/{siteId}/deployments/template".replace(
    "{siteId}",
    siteId,
  );
  let payload = {};
...
export const sitesCreateVcsDeployment = async ({
  siteId,
  type,
  reference,
  activate,
  ...
  overrideForCli = false,
  sdk = undefined,
}: SitesCreateVcsDeploymentRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const sitesGetDeployment = async ({
  siteId,
  deploymentId,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
  console: showConsole,
}: SitesGetDeploymentRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const sitesDeleteDeployment = async ({
  siteId,
  deploymentId,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: SitesDeleteDeploymentRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/sites/{siteId}/deployments/{deploymentId}"
    .replace("{siteId}", siteId)
    .replace("{deploymentId}", deploymentId);
...
export const sitesGetDeploymentDownload = async ({
  siteId,
  deploymentId,
  type,
  parseOutput = true,
  ...
  destination,
  console: showConsole,
}: SitesGetDeploymentDownloadRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const sitesUpdateDeploymentStatus = async ({
  siteId,
  deploymentId,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: SitesUpdateDeploymentStatusRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const sitesListLogs = async ({
  siteId,
  queries,
  total,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: SitesListLogsRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const sitesGetLog = async ({
  siteId,
  logId,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
  console: showConsole,
}: SitesGetLogRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const sitesDeleteLog = async ({
  siteId,
  logId,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: SitesDeleteLogRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/sites/{siteId}/logs/{logId}"
    .replace("{siteId}", siteId)
    .replace("{logId}", logId);
...
export const sitesGetUsage = async ({
  siteId,
  range,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: SitesGetUsageRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const sitesListVariables = async ({
  siteId,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: SitesListVariablesRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const sitesCreateVariable = async ({
  siteId,
  key,
  value,
  secret,
  ...
  overrideForCli = false,
  sdk = undefined,
}: SitesCreateVariableRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/sites/{siteId}/variables".replace("{siteId}", siteId);
  let payload = {};
...
export const sitesGetVariable = async ({
  siteId,
  variableId,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: SitesGetVariableRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const sitesUpdateVariable = async ({
  siteId,
  variableId,
  key,
  value,
  ...
  overrideForCli = false,
  sdk = undefined,
}: SitesUpdateVariableRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/sites/{siteId}/variables/{variableId}"
    .replace("{siteId}", siteId)
    .replace("{variableId}", variableId);
...
export const sitesDeleteVariable = async ({
  siteId,
  variableId,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: SitesDeleteVariableRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/sites/{siteId}/variables/{variableId}"
    .replace("{siteId}", siteId)
    .replace("{variableId}", variableId);
