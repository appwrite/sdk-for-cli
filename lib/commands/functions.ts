...
export const functionsList = async ({
  queries,
  search,
  total,
  parseOutput = true,
  ...
  sdk = undefined,
  console: showConsole,
}: FunctionsListRequestParams): Promise<any> => {
...
export const functionsCreate = async ({
  ...
  overrideForCli = false,
  sdk = undefined,
}: FunctionsCreateRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/functions";
  let payload = {};
...
export const functionsListRuntimes = async ({
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: FunctionsListRuntimesRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const functionsListSpecifications = async ({
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
  console: showConsole,
}: FunctionsListSpecificationsRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const functionsListTemplates = async ({
  runtimes,
  useCases,
  limit,
  offset,
  ...
  sdk = undefined,
  console: showConsole,
}: FunctionsListTemplatesRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const functionsGetTemplate = async ({
  templateId,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
  console: showConsole,
}: FunctionsGetTemplateRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/functions/templates/{templateId}".replace(
    "{templateId}",
    templateId,
  );
  let payload = {};
...
export const functionsListUsage = async ({
  range,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
  console: showConsole,
}: FunctionsListUsageRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const functionsGet = async ({
  functionId,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
  console: showConsole,
}: FunctionsGetRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const functionsUpdate = async ({
  functionId,
  name,
  runtime,
  execute,
  ...
  overrideForCli = false,
  sdk = undefined,
}: FunctionsUpdateRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/functions/{functionId}".replace("{functionId}", functionId);
  let payload = {};
  if (typeof name !== "undefined") {
...
export const functionsDelete = async ({
  functionId,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: FunctionsDeleteRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/functions/{functionId}".replace("{functionId}", functionId);
  let payload = {};
...
export const functionsUpdateFunctionDeployment = async ({
  functionId,
  deploymentId,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: FunctionsUpdateFunctionDeploymentRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/functions/{functionId}/deployment".replace(
    "{functionId}",
    functionId,
  );
  let payload = {};
...
export const functionsListDeployments = async ({
  functionId,
  queries,
  search,
  total,
  ...
  sdk = undefined,
  console: showConsole,
}: FunctionsListDeploymentsRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/functions/{functionId}/deployments".replace(
    "{functionId}",
    functionId,
  );
  let payload = {};
...
export const functionsCreateDeployment = async ({
  functionId,
  code,
  activate,
  entrypoint,
...
}: FunctionsCreateDeploymentRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/functions/{functionId}/deployments".replace(
    "{functionId}",
    functionId,
  ...
  const uploadChunk = async (lastUpload = false) => {
    ...
    if (onProgress !== null) {
      onProgress({
        $id: response["$id"],
        progress:
          (Math.min(currentChunk * client.CHUNK_SIZE, size) / size) * 100,
        sizeUploaded: end + 1,
...
export const functionsCreateDuplicateDeployment = async ({
  functionId,
  deploymentId,
  buildId,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: FunctionsCreateDuplicateDeploymentRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/functions/{functionId}/deployments/duplicate".replace(
    "{functionId}",
    functionId,
  );
  let payload = {};
...
export const functionsCreateTemplateDeployment = async ({
  functionId,
  repository,
  owner,
  rootDirectory,
  ...
  overrideForCli = false,
  sdk = undefined,
}: FunctionsCreateTemplateDeploymentRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/functions/{functionId}/deployments/template".replace(
    "{functionId}",
    functionId,
  );
  let payload = {};
...
export const functionsCreateVcsDeployment = async ({
  functionId,
  type,
  reference,
  activate,
  ...
  overrideForCli = false,
  sdk = undefined,
}: FunctionsCreateVcsDeploymentRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/functions/{functionId}/deployments/vcs".replace(
    "{functionId}",
    functionId,
  );
  let payload = {};
...
export const functionsGetDeployment = async ({
  functionId,
  deploymentId,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
  console: showConsole,
}: FunctionsGetDeploymentRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const functionsDeleteDeployment = async ({
  functionId,
  deploymentId,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: FunctionsDeleteDeploymentRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/functions/{functionId}/deployments/{deploymentId}"
    .replace("{functionId}", functionId)
    .replace("{deploymentId}", deploymentId);
...
export const functionsGetDeploymentDownload = async ({
  functionId,
  deploymentId,
  type,
  parseOutput = true,
  ...
  destination,
  console: showConsole,
}: FunctionsGetDeploymentDownloadRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const functionsUpdateDeploymentStatus = async ({
  functionId,
  deploymentId,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: FunctionsUpdateDeploymentStatusRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const functionsListExecutions = async ({
  functionId,
  queries,
  total,
  parseOutput = true,
  ...
  sdk = undefined,
  console: showConsole,
}: FunctionsListExecutionsRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/functions/{functionId}/executions".replace(
    "{functionId}",
    functionId,
  );
  let payload = {};
...
export const functionsCreateExecution = async ({
  functionId,
  body,
  async,
  xpath,
  ...
  overrideForCli = false,
  sdk = undefined,
}: FunctionsCreateExecutionRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/functions/{functionId}/executions".replace(
    "{functionId}",
    functionId,
...
export const functionsGetExecution = async ({
  functionId,
  executionId,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
  console: showConsole,
}: FunctionsGetExecutionRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const functionsDeleteExecution = async ({
  functionId,
  executionId,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: FunctionsDeleteExecutionRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/functions/{functionId}/executions/{executionId}"
    .replace("{functionId}", functionId)
    .replace("{executionId}", executionId);
...
export const functionsGetUsage = async ({
  functionId,
  range,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: FunctionsGetUsageRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/functions/{functionId}/usage".replace(
    "{functionId}",
    functionId,
  );
  let payload = {};
...
export const functionsListVariables = async ({
  functionId,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: FunctionsListVariablesRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/functions/{functionId}/variables".replace(
    "{functionId}",
    functionId,
  );
  let payload = {};
...
export const functionsCreateVariable = async ({
  functionId,
  key,
  value,
  secret,
  ...
  overrideForCli = false,
  sdk = undefined,
}: FunctionsCreateVariableRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/functions/{functionId}/variables".replace(
    "{functionId}",
    functionId,
...
export const functionsGetVariable = async ({
  functionId,
  variableId,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: FunctionsGetVariableRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const functionsUpdateVariable = async ({
  functionId,
  variableId,
  key,
  value,
  ...
  overrideForCli = false,
  sdk = undefined,
}: FunctionsUpdateVariableRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/functions/{functionId}/variables/{variableId}"
    .replace("{functionId}", functionId)
    .replace("{variableId}", variableId);
...
export const functionsDeleteVariable = async ({
  functionId,
  variableId,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: FunctionsDeleteVariableRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/functions/{functionId}/variables/{variableId}"
    .replace("{functionId}", functionId)
    .replace("{variableId}", variableId);
