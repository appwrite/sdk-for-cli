...
export const databasesList = async ({
  queries,
  search,
  total,
  parseOutput = true,
  ...
  sdk = undefined,
  console: showConsole,
}: DatabasesListRequestParams): Promise<any> => {
...
export const databasesCreate = async ({
  databaseId,
  name,
  enabled,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: DatabasesCreateRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/databases";
  let payload = {};
...
export const databasesListTransactions = async ({
  queries,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
  console: showConsole,
}: DatabasesListTransactionsRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const databasesCreateTransaction = async ({
  ttl,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: DatabasesCreateTransactionRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/databases/transactions";
  let payload = {};
...
export const databasesGetTransaction = async ({
  transactionId,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
  console: showConsole,
}: DatabasesGetTransactionRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/databases/transactions/{transactionId}".replace(
    "{transactionId}",
    transactionId,
  );
  let payload = {};
...
export const databasesUpdateTransaction = async ({
  transactionId,
  commit,
  rollback,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: DatabasesUpdateTransactionRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/databases/transactions/{transactionId}".replace(
    "{transactionId}",
    transactionId,
...
export const databasesDeleteTransaction = async ({
  transactionId,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: DatabasesDeleteTransactionRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/databases/transactions/{transactionId}".replace(
    "{transactionId}",
    transactionId,
...
export const databasesCreateOperations = async ({
  transactionId,
  operations,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: DatabasesCreateOperationsRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/databases/transactions/{transactionId}/operations".replace(
    "{transactionId}",
    transactionId,
  );
  let payload = {};
...
export const databasesListUsage = async ({
  range,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
  console: showConsole,
}: DatabasesListUsageRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const databasesGet = async ({
  databaseId,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
  console: showConsole,
}: DatabasesGetRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const databasesUpdate = async ({
  databaseId,
  name,
  enabled,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: DatabasesUpdateRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/databases/{databaseId}".replace("{databaseId}", databaseId);
  let payload = {};
  if (typeof name !== "undefined") {
...
export const databasesDelete = async ({
  databaseId,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: DatabasesDeleteRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/databases/{databaseId}".replace("{databaseId}", databaseId);
  let payload = {};
...
export const databasesListCollections = async ({
  databaseId,
  queries,
  search,
  total,
  ...
  sdk = undefined,
  console: showConsole,
}: DatabasesListCollectionsRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/databases/{databaseId}/collections".replace(
    "{databaseId}",
    databaseId,
  );
  let payload = {};
...
export const databasesCreateCollection = async ({
  databaseId,
  collectionId,
  name,
  permissions,
  ...
  overrideForCli = false,
  sdk = undefined,
}: DatabasesCreateCollectionRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/databases/{databaseId}/collections".replace(
    "{databaseId}",
    databaseId,
...
export const databasesGetCollection = async ({
  databaseId,
  collectionId,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
  console: showConsole,
}: DatabasesGetCollectionRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const databasesUpdateCollection = async ({
  databaseId,
  collectionId,
  name,
  permissions,
  ...
  overrideForCli = false,
  sdk = undefined,
}: DatabasesUpdateCollectionRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/databases/{databaseId}/collections/{collectionId}"
    .replace("{databaseId}", databaseId)
    .replace("{collectionId}", collectionId);
...
export const databasesDeleteCollection = async ({
  databaseId,
  collectionId,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: DatabasesDeleteCollectionRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/databases/{databaseId}/collections/{collectionId}"
    .replace("{databaseId}", databaseId)
    .replace("{collectionId}", collectionId);
...
export const databasesListAttributes = async ({
  databaseId,
  collectionId,
  queries,
  total,
  ...
  sdk = undefined,
  console: showConsole,
}: DatabasesListAttributesRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const databasesCreateBooleanAttribute = async ({
  databaseId,
  collectionId,
  key,
  required,
  ...
  overrideForCli = false,
  sdk = undefined,
}: DatabasesCreateBooleanAttributeRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath =
...
export const databasesUpdateBooleanAttribute = async ({
  databaseId,
  collectionId,
  key,
  required,
  ...
  overrideForCli = false,
  sdk = undefined,
}: DatabasesUpdateBooleanAttributeRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath =
...
export const databasesCreateDatetimeAttribute = async ({
  databaseId,
  collectionId,
  key,
  required,
  ...
  overrideForCli = false,
  sdk = undefined,
}: DatabasesCreateDatetimeAttributeRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath =
...
export const databasesUpdateDatetimeAttribute = async ({
  databaseId,
  collectionId,
  key,
  required,
  ...
  overrideForCli = false,
  sdk = undefined,
}: DatabasesUpdateDatetimeAttributeRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath =
...
export const databasesCreateEmailAttribute = async ({
  databaseId,
  collectionId,
  key,
  required,
  ...
  overrideForCli = false,
  sdk = undefined,
}: DatabasesCreateEmailAttributeRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath =
...
export const databasesUpdateEmailAttribute = async ({
  databaseId,
  collectionId,
  key,
  required,
  ...
  overrideForCli = false,
  sdk = undefined,
}: DatabasesUpdateEmailAttributeRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath =
...
export const databasesCreateEnumAttribute = async ({
  databaseId,
  collectionId,
  key,
  elements,
  ...
  overrideForCli = false,
  sdk = undefined,
}: DatabasesCreateEnumAttributeRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath =
...
export const databasesUpdateEnumAttribute = async ({
  databaseId,
  collectionId,
  key,
  elements,
  ...
  overrideForCli = false,
  sdk = undefined,
}: DatabasesUpdateEnumAttributeRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath =
...
export const databasesCreateFloatAttribute = async ({
  databaseId,
  collectionId,
  key,
  required,
  ...
  overrideForCli = false,
  sdk = undefined,
}: DatabasesCreateFloatAttributeRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath =
...
export const databasesUpdateFloatAttribute = async ({
  databaseId,
  collectionId,
  key,
  required,
  ...
  overrideForCli = false,
  sdk = undefined,
}: DatabasesUpdateFloatAttributeRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath =
...
export const databasesCreateIntegerAttribute = async ({
  databaseId,
  collectionId,
  key,
  required,
  ...
  overrideForCli = false,
  sdk = undefined,
}: DatabasesCreateIntegerAttributeRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath =
...
export const databasesUpdateIntegerAttribute = async ({
  databaseId,
  collectionId,
  key,
  required,
  ...
  overrideForCli = false,
  sdk = undefined,
}: DatabasesUpdateIntegerAttributeRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath =
...
export const databasesCreateIpAttribute = async ({
  databaseId,
  collectionId,
  key,
  required,
  ...
  overrideForCli = false,
  sdk = undefined,
}: DatabasesCreateIpAttributeRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath =
...
export const databasesUpdateIpAttribute = async ({
  databaseId,
  collectionId,
  key,
  required,
  ...
  overrideForCli = false,
  sdk = undefined,
}: DatabasesUpdateIpAttributeRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath =
...
export const databasesCreateLineAttribute = async ({
  databaseId,
  collectionId,
  key,
  required,
  ...
  overrideForCli = false,
  sdk = undefined,
}: DatabasesCreateLineAttributeRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath =
...
export const databasesUpdateLineAttribute = async ({
  databaseId,
  collectionId,
  key,
  required,
  ...
  overrideForCli = false,
  sdk = undefined,
}: DatabasesUpdateLineAttributeRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath =
...
export const databasesCreatePointAttribute = async ({
  databaseId,
  collectionId,
  key,
  required,
  ...
  overrideForCli = false,
  sdk = undefined,
}: DatabasesCreatePointAttributeRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath =
...
export const databasesUpdatePointAttribute = async ({
  databaseId,
  collectionId,
  key,
  required,
  ...
  overrideForCli = false,
  sdk = undefined,
}: DatabasesUpdatePointAttributeRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath =
...
export const databasesCreatePolygonAttribute = async ({
  databaseId,
  collectionId,
  key,
  required,
  ...
  overrideForCli = false,
  sdk = undefined,
}: DatabasesCreatePolygonAttributeRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath =
...
export const databasesUpdatePolygonAttribute = async ({
  databaseId,
  collectionId,
  key,
  required,
  ...
  overrideForCli = false,
  sdk = undefined,
}: DatabasesUpdatePolygonAttributeRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath =
...
export const databasesCreateRelationshipAttribute = async ({
  databaseId,
  collectionId,
  relatedCollectionId,
  type,
  ...
  overrideForCli = false,
  sdk = undefined,
}: DatabasesCreateRelationshipAttributeRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath =
...
export const databasesCreateStringAttribute = async ({
  databaseId,
  collectionId,
  key,
  size,
  ...
  overrideForCli = false,
  sdk = undefined,
}: DatabasesCreateStringAttributeRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath =
...
export const databasesUpdateStringAttribute = async ({
  databaseId,
  collectionId,
  key,
  required,
  ...
  overrideForCli = false,
  sdk = undefined,
}: DatabasesUpdateStringAttributeRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath =
...
export const databasesCreateUrlAttribute = async ({
  databaseId,
  collectionId,
  key,
  required,
  ...
  overrideForCli = false,
  sdk = undefined,
}: DatabasesCreateUrlAttributeRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath =
...
export const databasesUpdateUrlAttribute = async ({
  databaseId,
  collectionId,
  key,
  required,
  ...
  overrideForCli = false,
  sdk = undefined,
}: DatabasesUpdateUrlAttributeRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath =
...
export const databasesGetAttribute = async ({
  databaseId,
  collectionId,
  key,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: DatabasesGetAttributeRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath =
...
export const databasesDeleteAttribute = async ({
  databaseId,
  collectionId,
  key,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: DatabasesDeleteAttributeRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath =
    "/databases/{databaseId}/collections/{collectionId}/attributes/{key}"
      .replace("{databaseId}", databaseId)
...
export const databasesUpdateRelationshipAttribute = async ({
  databaseId,
  collectionId,
  key,
  onDelete,
  ...
  overrideForCli = false,
  sdk = undefined,
}: DatabasesUpdateRelationshipAttributeRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath =
...
export const databasesListDocuments = async ({
  databaseId,
  collectionId,
  queries,
  transactionId,
  ...
  sdk = undefined,
  console: showConsole,
}: DatabasesListDocumentsRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const databasesCreateDocument = async ({
  databaseId,
  collectionId,
  documentId,
  data,
  ...
  overrideForCli = false,
  sdk = undefined,
}: DatabasesCreateDocumentRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/databases/{databaseId}/collections/{collectionId}/documents"
    .replace("{databaseId}", databaseId)
    .replace("{collectionId}", collectionId);
...
export const databasesCreateDocuments = async ({
  databaseId,
  collectionId,
  documents,
  transactionId,
  ...
  overrideForCli = false,
  sdk = undefined,
}: DatabasesCreateDocumentsRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/databases/{databaseId}/collections/{collectionId}/documents"
    .replace("{databaseId}", databaseId)
    .replace("{collectionId}", collectionId);
...
export const databasesUpsertDocuments = async ({
  databaseId,
  collectionId,
  documents,
  transactionId,
  ...
  overrideForCli = false,
  sdk = undefined,
}: DatabasesUpsertDocumentsRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/databases/{databaseId}/collections/{collectionId}/documents"
    .replace("{databaseId}", databaseId)
    .replace("{collectionId}", collectionId);
...
export const databasesUpdateDocuments = async ({
  databaseId,
  collectionId,
  data,
  queries,
  ...
  overrideForCli = false,
  sdk = undefined,
}: DatabasesUpdateDocumentsRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/databases/{databaseId}/collections/{collectionId}/documents"
    .replace("{databaseId}", databaseId)
    .replace("{collectionId}", collectionId);
...
export const databasesDeleteDocuments = async ({
  databaseId,
  collectionId,
  queries,
  transactionId,
  ...
  overrideForCli = false,
  sdk = undefined,
}: DatabasesDeleteDocumentsRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/databases/{databaseId}/collections/{collectionId}/documents"
    .replace("{databaseId}", databaseId)
    .replace("{collectionId}", collectionId);
...
export const databasesGetDocument = async ({
  databaseId,
  collectionId,
  documentId,
  queries,
  ...
  sdk = undefined,
  console: showConsole,
}: DatabasesGetDocumentRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath =
...
export const databasesUpsertDocument = async ({
  databaseId,
  collectionId,
  documentId,
  data,
  ...
  overrideForCli = false,
  sdk = undefined,
}: DatabasesUpsertDocumentRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath =
    "/databases/{databaseId}/collections/{collectionId}/documents/{documentId}"
      .replace("{databaseId}", databaseId)
...
export const databasesUpdateDocument = async ({
  databaseId,
  collectionId,
  documentId,
  data,
  ...
  overrideForCli = false,
  sdk = undefined,
}: DatabasesUpdateDocumentRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath =
    "/databases/{databaseId}/collections/{collectionId}/documents/{documentId}"
      .replace("{databaseId}", databaseId)
...
export const databasesDeleteDocument = async ({
  databaseId,
  collectionId,
  documentId,
  transactionId,
  ...
  overrideForCli = false,
  sdk = undefined,
}: DatabasesDeleteDocumentRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath =
    "/databases/{databaseId}/collections/{collectionId}/documents/{documentId}"
      .replace("{databaseId}", databaseId)
...
export const databasesListDocumentLogs = async ({
  databaseId,
  collectionId,
  documentId,
  queries,
  ...
  overrideForCli = false,
  sdk = undefined,
}: DatabasesListDocumentLogsRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath =
...
export const databasesDecrementDocumentAttribute = async ({
  databaseId,
  collectionId,
  documentId,
  attribute,
  ...
  overrideForCli = false,
  sdk = undefined,
}: DatabasesDecrementDocumentAttributeRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath =
...
export const databasesIncrementDocumentAttribute = async ({
  databaseId,
  collectionId,
  documentId,
  attribute,
  ...
  overrideForCli = false,
  sdk = undefined,
}: DatabasesIncrementDocumentAttributeRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath =
...
export const databasesListIndexes = async ({
  databaseId,
  collectionId,
  queries,
  total,
  ...
  sdk = undefined,
  console: showConsole,
}: DatabasesListIndexesRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const databasesCreateIndex = async ({
  databaseId,
  collectionId,
  key,
  type,
  ...
  overrideForCli = false,
  sdk = undefined,
}: DatabasesCreateIndexRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/databases/{databaseId}/collections/{collectionId}/indexes"
    .replace("{databaseId}", databaseId)
    .replace("{collectionId}", collectionId);
...
export const databasesGetIndex = async ({
  databaseId,
  collectionId,
  key,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: DatabasesGetIndexRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath =
...
export const databasesDeleteIndex = async ({
  databaseId,
  collectionId,
  key,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: DatabasesDeleteIndexRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath =
    "/databases/{databaseId}/collections/{collectionId}/indexes/{key}"
      .replace("{databaseId}", databaseId)
...
export const databasesListCollectionLogs = async ({
  databaseId,
  collectionId,
  queries,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: DatabasesListCollectionLogsRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const databasesGetCollectionUsage = async ({
  databaseId,
  collectionId,
  range,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: DatabasesGetCollectionUsageRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
...
export const databasesListLogs = async ({
  databaseId,
  queries,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: DatabasesListLogsRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/databases/{databaseId}/logs".replace(
    "{databaseId}",
    databaseId,
  );
  let payload = {};
...
export const databasesGetUsage = async ({
  databaseId,
  range,
  parseOutput = true,
  overrideForCli = false,
  sdk = undefined,
}: DatabasesGetUsageRequestParams): Promise<any> => {
  let client = !sdk ? await sdkForProject() : sdk;
  let apiPath = "/databases/{databaseId}/usage".replace(
    "{databaseId}",
    databaseId,
  );
  let payload = {};
...
databases
  .command(`list`)
  .description(
    `[**DEPRECATED** - This command is deprecated. Please use 'tables-db list' instead] Get a list of all databases from the current Appwrite project. You can use the search parameter to filter your results.`,
  )
  .option(
    `--queries [queries...]`,
...
databases
  .command(`create`)
  .description(
    `[**DEPRECATED** - This command is deprecated. Please use 'tables-db create' instead] Create a new Database. `,
  )
  .requiredOption(
...
databases
  .command(`get`)
  .description(
    `[**DEPRECATED** - This command is deprecated. Please use 'tables-db get' instead] Get a database by its unique ID. This endpoint response returns a JSON object with the database metadata.`,
  )
...
databases
  .command(`update`)
  .description(
    `[**DEPRECATED** - This command is deprecated. Please use 'tables-db update' instead] Update a database by its unique ID.`,
  )
  .requiredOption(`--database-id <database-id>`, `Database ID.`)
  .requiredOption(`--name <name>`, `Database name. Max length: 128 chars.`)
  .option(
...
databases
  .command(`delete`)
  .description(
    `[**DEPRECATED** - This command is deprecated. Please use 'tables-db delete' instead] Delete a database by its unique ID. Only API keys with with databases.write scope can delete a database.`,
  )
  .requiredOption(`--database-id <database-id>`, `Database ID.`)
...
databases
  ...
  .description(
    `[**DEPRECATED** - This command is deprecated. Please use 'tables-db list-tables' instead] Get a list of all collections that belong to the provided databaseId. You can use the search parameter to filter your results.`,
  )
  .requiredOption(`--database-id <database-id>`, `Database ID.`)
  .option(
    `--queries [queries...]`,
...
databases
  ...
  .description(
    `[**DEPRECATED** - This command is deprecated. Please use 'tables-db create-table' instead] Create a new Collection. Before using this route, you should create a new database resource using either a [server integration](https://appwrite.io/docs/server/databases#databasesCreateCollection) API or directly from your database console.`,
  )
  .requiredOption(`--database-id <database-id>`, `Database ID.`)
  .requiredOption(
...
databases
  ...
  .description(
    `[**DEPRECATED** - This command is deprecated. Please use 'tables-db get-table' instead] Get a collection by its unique ID. This endpoint response returns a JSON object with the collection metadata.`,
  )
  .requiredOption(`--database-id <database-id>`, `Database ID.`)
...
databases
  ...
  .description(
    `[**DEPRECATED** - This command is deprecated. Please use 'tables-db update-table' instead] Update a collection by its unique ID.`,
  )
  .requiredOption(`--database-id <database-id>`, `Database ID.`)
  .requiredOption(`--collection-id <collection-id>`, `Collection ID.`)
  .requiredOption(`--name <name>`, `Collection name. Max length: 128 chars.`)
...
databases
  ...
  .description(
    `[**DEPRECATED** - This command is deprecated. Please use 'tables-db delete-table' instead] Delete a collection by its unique ID. Only users with write permissions have access to delete this resource.`,
  )
  .requiredOption(`--database-id <database-id>`, `Database ID.`)
  .requiredOption(`--collection-id <collection-id>`, `Collection ID.`)
...
databases
  ...
  .description(
    `[**DEPRECATED** - This command is deprecated. Please use 'tables-db list-columns' instead] List attributes in the collection.`,
  )
  .requiredOption(`--database-id <database-id>`, `Database ID.`)
  .requiredOption(`--collection-id <collection-id>`, `Collection ID.`)
  .option(
...
databases
  ...
  .description(
    `[**DEPRECATED** - This command is deprecated. Please use 'tables-db create-boolean-column' instead] Create a boolean attribute. `,
  )
  .requiredOption(`--database-id <database-id>`, `Database ID.`)
  .requiredOption(
    `--collection-id <collection-id>`,
...
databases
  ...
  .description(
    `[**DEPRECATED** - This command is deprecated. Please use 'tables-db update-boolean-column' instead] Update a boolean attribute. Changing the 'default' value will not update already existing documents.`,
  )
  .requiredOption(`--database-id <database-id>`, `Database ID.`)
  .requiredOption(
    `--collection-id <collection-id>`,
...
databases
  ...
  .description(
    `[**DEPRECATED** - This command is deprecated. Please use 'tables-db create-datetime-column' instead] Create a date time attribute according to the ISO 8601 standard.`,
  )
  .requiredOption(`--database-id <database-id>`, `Database ID.`)
  .requiredOption(
    `--collection-id <collection-id>`,
...
databases
  ...
  .description(
    `[**DEPRECATED** - This command is deprecated. Please use 'tables-db update-datetime-column' instead] Update a date time attribute. Changing the 'default' value will not update already existing documents.`,
  )
  .requiredOption(`--database-id <database-id>`, `Database ID.`)
  .requiredOption(`--collection-id <collection-id>`, `Collection ID.`)
  .requiredOption(`--key <key>`, `Attribute Key.`)
...
databases
  ...
  .description(
    `[**DEPRECATED** - This command is deprecated. Please use 'tables-db create-email-column' instead] Create an email attribute. `,
  )
  .requiredOption(`--database-id <database-id>`, `Database ID.`)
  .requiredOption(`--collection-id <collection-id>`, `Collection ID.`)
  .requiredOption(`--key <key>`, `Attribute Key.`)
...
databases
  ...
  .description(
    `[**DEPRECATED** - This command is deprecated. Please use 'tables-db update-email-column' instead] Update an email attribute. Changing the 'default' value will not update already existing documents. `,
  )
  .requiredOption(`--database-id <database-id>`, `Database ID.`)
  .requiredOption(`--collection-id <collection-id>`, `Collection ID.`)
  .requiredOption(`--key <key>`, `Attribute Key.`)
...
databases
  ...
  .description(
    `[**DEPRECATED** - This command is deprecated. Please use 'tables-db create-enum-column' instead] Create an enum attribute. The 'elements' param acts as a white-list of accepted values for this attribute.  `,
  )
  .requiredOption(`--database-id <database-id>`, `Database ID.`)
  .requiredOption(`--collection-id <collection-id>`, `Collection ID.`)
  .requiredOption(`--key <key>`, `Attribute Key.`)
...
databases
  ...
  .description(
    `[**DEPRECATED** - This command is deprecated. Please use 'tables-db update-enum-column' instead] Update an enum attribute. Changing the 'default' value will not update already existing documents. `,
  )
  .requiredOption(`--database-id <database-id>`, `Database ID.`)
  .requiredOption(`--collection-id <collection-id>`, `Collection ID.`)
  .requiredOption(`--key <key>`, `Attribute Key.`)
...
databases
  ...
  .description(
    `[**DEPRECATED** - This command is deprecated. Please use 'tables-db create-float-column' instead] Create a float attribute. Optionally, minimum and maximum values can be provided. `,
  )
  .requiredOption(`--database-id <database-id>`, `Database ID.`)
  .requiredOption(`--collection-id <collection-id>`, `Collection ID.`)
  .requiredOption(`--key <key>`, `Attribute Key.`)
...
databases
  ...
  .description(
    `[**DEPRECATED** - This command is deprecated. Please use 'tables-db update-float-column' instead] Update a float attribute. Changing the 'default' value will not update already existing documents. `,
  )
  .requiredOption(`--database-id <database-id>`, `Database ID.`)
  .requiredOption(`--collection-id <collection-id>`, `Collection ID.`)
  .requiredOption(`--key <key>`, `Attribute Key.`)
...
databases
  ...
  .description(
    `[**DEPRECATED** - This command is deprecated. Please use 'tables-db create-integer-column' instead] Create an integer attribute. Optionally, minimum and maximum values can be provided. `,
  )
  .requiredOption(`--database-id <database-id>`, `Database ID.`)
  .requiredOption(`--collection-id <collection-id>`, `Collection ID.`)
  .requiredOption(`--key <key>`, `Attribute Key.`)
...
databases
  ...
  .description(
    `[**DEPRECATED** - This command is deprecated. Please use 'tables-db update-integer-column' instead] Update an integer attribute. Changing the 'default' value will not update already existing documents. `,
  )
  .requiredOption(`--database-id <database-id>`, `Database ID.`)
  .requiredOption(`--collection-id <collection-id>`, `Collection ID.`)
  .requiredOption(`--key <key>`, `Attribute Key.`)
...
databases
  ...
  .description(
    `[**DEPRECATED** - This command is deprecated. Please use 'tables-db create-ip-column' instead] Create IP address attribute. `,
  )
  .requiredOption(`--database-id <database-id>`, `Database ID.`)
  .requiredOption(`--collection-id <collection-id>`, `Collection ID.`)
  .requiredOption(`--key <key>`, `Attribute Key.`)
...
databases
  ...
  .description(
    `[**DEPRECATED** - This command is deprecated. Please use 'tables-db update-ip-column' instead] Update an ip attribute. Changing the 'default' value will not update already existing documents. `,
  )
  .requiredOption(`--database-id <database-id>`, `Database ID.`)
  .requiredOption(`--collection-id <collection-id>`, `Collection ID.`)
  .requiredOption(`--key <key>`, `Attribute Key.`)
...
databases
  ...
  .description(
    `[**DEPRECATED** - This command is deprecated. Please use 'tables-db create-line-column' instead] Create a geometric line attribute.`,
  )
  .requiredOption(`--database-id <database-id>`, `Database ID.`)
  .requiredOption(
    `--collection-id <collection-id>`,
...
databases
  ...
  .description(
    `[**DEPRECATED** - This command is deprecated. Please use 'tables-db update-line-column' instead] Update a line attribute. Changing the 'default' value will not update already existing documents.`,
  )
  .requiredOption(`--database-id <database-id>`, `Database ID.`)
  .requiredOption(
    `--collection-id <collection-id>`,
...
databases
  ...
  .description(
    `[**DEPRECATED** - This command is deprecated. Please use 'tables-db create-point-column' instead] Create a geometric point attribute.`,
  )
  .requiredOption(`--database-id <database-id>`, `Database ID.`)
  .requiredOption(
    `--collection-id <collection-id>`,
...
databases
  ...
  .description(
    `[**DEPRECATED** - This command is deprecated. Please use 'tables-db update-point-column' instead] Update a point attribute. Changing the 'default' value will not update already existing documents.`,
  )
  .requiredOption(`--database-id <database-id>`, `Database ID.`)
  .requiredOption(
    `--collection-id <collection-id>`,
...
databases
  ...
  .description(
    `[**DEPRECATED** - This command is deprecated. Please use 'tables-db create-polygon-column' instead] Create a geometric polygon attribute.`,
  )
  .requiredOption(`--database-id <database-id>`, `Database ID.`)
  .requiredOption(
    `--collection-id <collection-id>`,
...
databases
  ...
  .description(
    `[**DEPRECATED** - This command is deprecated. Please use 'tables-db update-polygon-column' instead] Update a polygon attribute. Changing the 'default' value will not update already existing documents.`,
  )
  .requiredOption(`--database-id <database-id>`, `Database ID.`)
  .requiredOption(
    `--collection-id <collection-id>`,
...
databases
  ...
  .description(
    `[**DEPRECATED** - This command is deprecated. Please use 'tables-db create-relationship-column' instead] Create relationship attribute. [Learn more about relationship attributes](https://appwrite.io/docs/databases-relationships#relationship-attributes). `,
  )
  .requiredOption(`--database-id <database-id>`, `Database ID.`)
  .requiredOption(`--collection-id <collection-id>`, `Collection ID.`)
  .requiredOption(
...
databases
  ...
  .description(
    `[**DEPRECATED** - This command is deprecated. Please use 'tables-db update-string-column' instead] Update a string attribute. Changing the 'default' value will not update already existing documents. `,
  )
  .requiredOption(`--database-id <database-id>`, `Database ID.`)
  .requiredOption(
    `--collection-id <collection-id>`,
...
databases
  ...
  .description(
    `[**DEPRECATED** - This command is deprecated. Please use 'tables-db create-url-column' instead] Create a URL attribute. `,
  )
  .requiredOption(`--database-id <database-id>`, `Database ID.`)
  .requiredOption(`--collection-id <collection-id>`, `Collection ID.`)
  .requiredOption(`--key <key>`, `Attribute Key.`)
...
databases
  ...
  .description(
    `[**DEPRECATED** - This command is deprecated. Please use 'tables-db update-url-column' instead] Update an url attribute. Changing the 'default' value will not update already existing documents. `,
  )
  .requiredOption(`--database-id <database-id>`, `Database ID.`)
  .requiredOption(`--collection-id <collection-id>`, `Collection ID.`)
  .requiredOption(`--key <key>`, `Attribute Key.`)
...
databases
  ...
  .description(
    `[**DEPRECATED** - This command is deprecated. Please use 'tables-db get-column' instead] Get attribute by ID.`,
  )
  .requiredOption(`--database-id <database-id>`, `Database ID.`)
  .requiredOption(`--collection-id <collection-id>`, `Collection ID.`)
  .requiredOption(`--key <key>`, `Attribute Key.`)
...
databases
  ...
  .description(
    `[**DEPRECATED** - This command is deprecated. Please use 'tables-db delete-column' instead] Deletes an attribute.`,
  )
  .requiredOption(`--database-id <database-id>`, `Database ID.`)
  .requiredOption(`--collection-id <collection-id>`, `Collection ID.`)
  .requiredOption(`--key <key>`, `Attribute Key.`)
...
databases
  ...
  .description(
    `[**DEPRECATED** - This command is deprecated. Please use 'tables-db update-relationship-column' instead] Update relationship attribute. [Learn more about relationship attributes](https://appwrite.io/docs/databases-relationships#relationship-attributes). `,
  )
  .requiredOption(`--database-id <database-id>`, `Database ID.`)
  .requiredOption(`--collection-id <collection-id>`, `Collection ID.`)
  .requiredOption(`--key <key>`, `Attribute Key.`)
...
databases
  ...
  .description(
    `[**DEPRECATED** - This command is deprecated. Please use 'tables-db list-rows' instead] Get a list of all the user's documents in a given collection. You can use the query params to filter your results.`,
  )
  .requiredOption(`--database-id <database-id>`, `Database ID.`)
  .requiredOption(
    `--collection-id <collection-id>`,
...
databases
  ...
  .description(
    `[**DEPRECATED** - This command is deprecated. Please use 'tables-db create-row' instead] Create a new Document. Before using this route, you should create a new collection resource using either a [server integration](https://appwrite.io/docs/server/databases#databasesCreateCollection) API or directly from your database console.`,
  )
  .requiredOption(`--database-id <database-id>`, `Database ID.`)
  .requiredOption(
    `--collection-id <collection-id>`,
...
databases
  ...
  .description(
    `[**DEPRECATED** - This command is deprecated. Please use 'tables-db upsert-rows' instead] Create or update Documents. Before using this route, you should create a new collection resource using either a [server integration](https://appwrite.io/docs/server/databases#databasesCreateCollection) API or directly from your database console. `,
  )
  .requiredOption(`--database-id <database-id>`, `Database ID.`)
  .requiredOption(`--collection-id <collection-id>`, `Collection ID.`)
  .requiredOption(
...
databases
  ...
  .description(
    `[**DEPRECATED** - This command is deprecated. Please use 'tables-db update-rows' instead] Update all documents that match your queries, if no queries are submitted then all documents are updated. You can pass only specific fields to be updated.`,
  )
  .requiredOption(`--database-id <database-id>`, `Database ID.`)
  .requiredOption(`--collection-id <collection-id>`, `Collection ID.`)
  .option(
...
databases
  ...
  .description(
    `[**DEPRECATED** - This command is deprecated. Please use 'tables-db delete-rows' instead] Bulk delete documents using queries, if no queries are passed then all documents are deleted.`,
  )
  .requiredOption(`--database-id <database-id>`, `Database ID.`)
  .requiredOption(
    `--collection-id <collection-id>`,
...
databases
  ...
  .description(
    `[**DEPRECATED** - This command is deprecated. Please use 'tables-db get-row' instead] Get a document by its unique ID. This endpoint response returns a JSON object with the document data.`,
  )
  .requiredOption(`--database-id <database-id>`, `Database ID.`)
  .requiredOption(
    `--collection-id <collection-id>`,
...
databases
  ...
  .description(
    `[**DEPRECATED** - This command is deprecated. Please use 'tables-db upsert-row' instead] Create or update a Document. Before using this route, you should create a new collection resource using either a [server integration](https://appwrite.io/docs/server/databases#databasesCreateCollection) API or directly from your database console.`,
  )
  .requiredOption(`--database-id <database-id>`, `Database ID.`)
  .requiredOption(`--collection-id <collection-id>`, `Collection ID.`)
  .requiredOption(`--document-id <document-id>`, `Document ID.`)
...
databases
  ...
  .description(
    `[**DEPRECATED** - This command is deprecated. Please use 'tables-db update-row' instead] Update a document by its unique ID. Using the patch method you can pass only specific fields that will get updated.`,
  )
  .requiredOption(`--database-id <database-id>`, `Database ID.`)
  .requiredOption(`--collection-id <collection-id>`, `Collection ID.`)
  .requiredOption(`--document-id <document-id>`, `Document ID.`)
...
databases
  ...
  .description(
    `[**DEPRECATED** - This command is deprecated. Please use 'tables-db delete-row' instead] Delete a document by its unique ID.`,
  )
  .requiredOption(`--database-id <database-id>`, `Database ID.`)
  .requiredOption(
    `--collection-id <collection-id>`,
...
databases
  ...
  .description(
    `[**DEPRECATED** - This command is deprecated. Please use 'tables-db list-row-logs' instead] Get the document activity logs list by its unique ID.`,
  )
  .requiredOption(`--database-id <database-id>`, `Database ID.`)
  .requiredOption(`--collection-id <collection-id>`, `Collection ID.`)
  .requiredOption(`--document-id <document-id>`, `Document ID.`)
...
databases
  ...
  .description(
    `[**DEPRECATED** - This command is deprecated. Please use 'tables-db decrement-row-column' instead] Decrement a specific attribute of a document by a given value.`,
  )
  .requiredOption(`--database-id <database-id>`, `Database ID.`)
  .requiredOption(`--collection-id <collection-id>`, `Collection ID.`)
  .requiredOption(`--document-id <document-id>`, `Document ID.`)
...
databases
  ...
  .description(
    `[**DEPRECATED** - This command is deprecated. Please use 'tables-db increment-row-column' instead] Increment a specific attribute of a document by a given value.`,
  )
  .requiredOption(`--database-id <database-id>`, `Database ID.`)
  .requiredOption(`--collection-id <collection-id>`, `Collection ID.`)
  .requiredOption(`--document-id <document-id>`, `Document ID.`)
...
databases
  ...
  .description(
    `[**DEPRECATED** - This command is deprecated. Please use 'tables-db list-indexes' instead] List indexes in the collection.`,
  )
  .requiredOption(`--database-id <database-id>`, `Database ID.`)
  .requiredOption(
    `--collection-id <collection-id>`,
...
databases
  ...
  .description(
    `[**DEPRECATED** - This command is deprecated. Please use 'tables-db create-index' instead] Creates an index on the attributes listed. Your index should include all the attributes you will query in a single request. Attributes can be 'key', 'fulltext', and 'unique'.`,
  )
  .requiredOption(`--database-id <database-id>`, `Database ID.`)
  .requiredOption(
    `--collection-id <collection-id>`,
...
databases
  .command(`get-index`)
  .description(
    `[**DEPRECATED** - This command is deprecated. Please use 'tables-db get-index' instead] Get an index by its unique ID.`,
  )
  .requiredOption(`--database-id <database-id>`, `Database ID.`)
  .requiredOption(
    `--collection-id <collection-id>`,
...
databases
  ...
  .description(
    `[**DEPRECATED** - This command is deprecated. Please use 'tables-db delete-index' instead] Delete an index.`,
  )
  .requiredOption(`--database-id <database-id>`, `Database ID.`)
  .requiredOption(
    `--collection-id <collection-id>`,
...
databases
  ...
  .description(
    `[**DEPRECATED** - This command is deprecated. Please use 'tables-db list-table-logs' instead] Get the collection activity logs list by its unique ID.`,
  )
  .requiredOption(`--database-id <database-id>`, `Database ID.`)
  .requiredOption(`--collection-id <collection-id>`, `Collection ID.`)
  .option(
...
databases
  ...
  .description(
    `[**DEPRECATED** - This command is deprecated. Please use 'tables-db get-table-usage' instead] Get usage metrics and statistics for a collection. Returning the total number of documents. The response includes both current totals and historical data over time. Use the optional range parameter to specify the time window for historical data: 24h (last 24 hours), 30d (last 30 days), or 90d (last 90 days). If not specified, range defaults to 30 days.`,
  )
  .requiredOption(`--database-id <database-id>`, `Database ID.`)
  .requiredOption(`--collection-id <collection-id>`, `Collection ID.`)
  .option(`--range <range>`, `Date range.`)
...
databases
  .command(`list-logs`)
  .description(
    `[**DEPRECATED** - This command is deprecated. Please use 'tables-db list-database-logs' instead] Get the database activity logs list by its unique ID.`,
  )
  .requiredOption(`--database-id <database-id>`, `Database ID.`)
  .option(
    `--queries [queries...]`,
...
databases
  .command(`get-usage`)
  .description(
    `[**DEPRECATED** - This command is deprecated. Please use 'tables-db get-usage' instead] Get usage metrics and statistics for a database. You can view the total number of collections, documents, and storage usage. The response includes both current totals and historical data over time. Use the optional range parameter to specify the time window for historical data: 24h (last 24 hours), 30d (last 30 days), or 90d (last 90 days). If not specified, range defaults to 30 days.`,
  )
  .requiredOption(`--database-id <database-id>`, `Database ID.`)
  .option(`--range <range>`, `Date range.`)
