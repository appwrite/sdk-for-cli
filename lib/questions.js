...
const questionsFlutterConfigure = [
    {
        type: "list",
        name: "start",
        when(answers) {
        ...
        choices: [
            ...
            {
                name: "Link this Flutter project to an existing Appwrite project",
                value: "existing",
            },
        ],
    },
...
const questionsFlutterSelectPlatforms = [
    {
        type: "checkbox",
        name: "platforms",
        message: "Choose your Platforms to configure.",
        choices: [
            'Android',
            'iOS',
            'Web',
...
const questionsGeneratorChooseProject = [
    {
        type: "list",
        name: "project",
        message: "Choose Appwrite project.",
        choices: async () => {
            let response = await projectsList({
                parseOutput: false
            })
...
const questionsGeneratorChooseDatabase = [
    {
        type: "checkbox",
        name: "databases",
        message: "Select databases to generate classes.",
        choices: async () => {
            let response = await databasesList({
                parseOutput: false
            })
            ...
            if (choices.length == 0) {
                throw new Error("No databases found. Please create databases and collections.")
            }
