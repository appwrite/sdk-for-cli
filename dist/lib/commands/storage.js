...
export const storageListBuckets = async ({ queries, search, total, parseOutput = true, overrideForCli = false, sdk = undefined, console: showConsole, }) => {
...
export const storageCreateBucket = async ({ bucketId, name, permissions, fileSecurity, enabled, maximumFileSize, allowedFileExtensions, compression, encryption, antivirus, transformations, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
    let apiPath = "/storage/buckets";
    let payload = {};
    ...
    allowedFileExtensions =
        allowedFileExtensions === true ? [] : allowedFileExtensions;
...
export const storageGetBucket = async ({ bucketId, parseOutput = true, overrideForCli = false, sdk = undefined, console: showConsole, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
...
export const storageUpdateBucket = async ({ bucketId, name, permissions, fileSecurity, enabled, maximumFileSize, allowedFileExtensions, compression, encryption, antivirus, transformations, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
    let apiPath = "/storage/buckets/{bucketId}".replace("{bucketId}", bucketId);
    let payload = {};
    if (typeof name !== "undefined") {
...
export const storageDeleteBucket = async ({ bucketId, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
    let apiPath = "/storage/buckets/{bucketId}".replace("{bucketId}", bucketId);
    let payload = {};
    let response = undefined;
...
export const storageListFiles = async ({ bucketId, queries, search, total, parseOutput = true, overrideForCli = false, sdk = undefined, console: showConsole, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
...
export const storageCreateFile = async ({ bucketId, fileId, file, permissions, parseOutput = true, overrideForCli = false, sdk = undefined, onProgress = (progress) => { }, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
    let apiPath = "/storage/buckets/{bucketId}/files".replace("{bucketId}", bucketId);
    let payload = {};
    ...
    const uploadChunk = async (lastUpload = false) => {
        ...
        payload["file"] = {
            type: "file",
            file: new File([uploadableChunkTrimmed], fileUpload.filename),
...
export const storageGetFile = async ({ bucketId, fileId, parseOutput = true, overrideForCli = false, sdk = undefined, console: showConsole, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
    let apiPath = "/storage/buckets/{bucketId}/files/{fileId}"
...
export const storageUpdateFile = async ({ bucketId, fileId, name, permissions, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
    let apiPath = "/storage/buckets/{bucketId}/files/{fileId}"
        .replace("{bucketId}", bucketId)
        .replace("{fileId}", fileId);
...
export const storageDeleteFile = async ({ bucketId, fileId, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
    let apiPath = "/storage/buckets/{bucketId}/files/{fileId}"
        .replace("{bucketId}", bucketId)
        .replace("{fileId}", fileId);
...
export const storageGetFileDownload = async ({ bucketId, fileId, token, parseOutput = true, overrideForCli = false, sdk = undefined, destination, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
    let apiPath = "/storage/buckets/{bucketId}/files/{fileId}/download"
        .replace("{bucketId}", bucketId)
        .replace("{fileId}", fileId);
    let payload = {};
...
export const storageGetFilePreview = async ({ bucketId, fileId, width, height, gravity, quality, borderWidth, borderColor, borderRadius, opacity, rotation, background, output, token, parseOutput = true, overrideForCli = false, sdk = undefined, destination, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
    let apiPath = "/storage/buckets/{bucketId}/files/{fileId}/preview"
        .replace("{bucketId}", bucketId)
        .replace("{fileId}", fileId);
    let payload = {};
...
export const storageGetFileView = async ({ bucketId, fileId, token, parseOutput = true, overrideForCli = false, sdk = undefined, destination, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
    let apiPath = "/storage/buckets/{bucketId}/files/{fileId}/view"
        .replace("{bucketId}", bucketId)
        .replace("{fileId}", fileId);
    let payload = {};
    if (typeof token !== "undefined") {
...
export const storageGetUsage = async ({ range, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
...
export const storageGetBucketUsage = async ({ bucketId, range, parseOutput = true, overrideForCli = false, sdk = undefined, console: showConsole, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
