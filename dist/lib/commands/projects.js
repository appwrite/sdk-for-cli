...
export const projectsList = async ({ queries, search, total, parseOutput = true, overrideForCli = false, sdk = undefined, console: showConsole, }) => {
...
export const projectsCreate = async ({ projectId, name, teamId, region, description, logo, url, legalName, legalCountry, legalState, legalCity, legalAddress, legalTaxId, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForConsole() : sdk;
    let apiPath = "/projects";
    let payload = {};
...
export const projectsGet = async ({ projectId, parseOutput = true, overrideForCli = false, sdk = undefined, console: showConsole, }) => {
    let client = !sdk ? await sdkForConsole() : sdk;
...
export const projectsUpdate = async ({ projectId, name, description, logo, url, legalName, legalCountry, legalState, legalCity, legalAddress, legalTaxId, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForConsole() : sdk;
    let apiPath = "/projects/{projectId}".replace("{projectId}", projectId);
    let payload = {};
    if (typeof name !== "undefined") {
...
export const projectsDelete = async ({ projectId, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForConsole() : sdk;
    let apiPath = "/projects/{projectId}".replace("{projectId}", projectId);
    let payload = {};
    let response = undefined;
...
export const projectsUpdateAPIStatus = async ({ projectId, api, status, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForConsole() : sdk;
...
export const projectsUpdateAPIStatusAll = async ({ projectId, status, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForConsole() : sdk;
...
export const projectsUpdateAuthDuration = async ({ projectId, duration, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForConsole() : sdk;
...
export const projectsUpdateAuthLimit = async ({ projectId, limit, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForConsole() : sdk;
...
export const projectsUpdateAuthSessionsLimit = async ({ projectId, limit, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForConsole() : sdk;
...
export const projectsUpdateMembershipsPrivacy = async ({ projectId, userName, userEmail, mfa, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForConsole() : sdk;
...
export const projectsUpdateMockNumbers = async ({ projectId, numbers, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForConsole() : sdk;
...
export const projectsUpdateAuthPasswordDictionary = async ({ projectId, enabled, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForConsole() : sdk;
...
export const projectsUpdateAuthPasswordHistory = async ({ projectId, limit, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForConsole() : sdk;
...
export const projectsUpdatePersonalDataCheck = async ({ projectId, enabled, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForConsole() : sdk;
...
export const projectsUpdateSessionAlerts = async ({ projectId, alerts, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForConsole() : sdk;
...
export const projectsUpdateSessionInvalidation = async ({ projectId, enabled, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForConsole() : sdk;
...
export const projectsUpdateAuthStatus = async ({ projectId, method, status, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForConsole() : sdk;
    let apiPath = "/projects/{projectId}/auth/{method}"
...
export const projectsListDevKeys = async ({ projectId, queries, parseOutput = true, overrideForCli = false, sdk = undefined, console: showConsole, }) => {
    let client = !sdk ? await sdkForConsole() : sdk;
...
export const projectsCreateDevKey = async ({ projectId, name, expire, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForConsole() : sdk;
    let apiPath = "/projects/{projectId}/dev-keys".replace("{projectId}", projectId);
    let payload = {};
    if (typeof name !== "undefined") {
...
export const projectsGetDevKey = async ({ projectId, keyId, parseOutput = true, overrideForCli = false, sdk = undefined, console: showConsole, }) => {
    let client = !sdk ? await sdkForConsole() : sdk;
    let apiPath = "/projects/{projectId}/dev-keys/{keyId}"
        .replace("{projectId}", projectId)
        .replace("{keyId}", keyId);
    let payload = {};
    let response = undefined;
...
export const projectsUpdateDevKey = async ({ projectId, keyId, name, expire, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForConsole() : sdk;
    let apiPath = "/projects/{projectId}/dev-keys/{keyId}"
        .replace("{projectId}", projectId)
        .replace("{keyId}", keyId);
...
export const projectsDeleteDevKey = async ({ projectId, keyId, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForConsole() : sdk;
    let apiPath = "/projects/{projectId}/dev-keys/{keyId}"
        .replace("{projectId}", projectId)
        .replace("{keyId}", keyId);
...
export const projectsCreateJWT = async ({ projectId, scopes, duration, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForConsole() : sdk;
...
export const projectsListKeys = async ({ projectId, total, parseOutput = true, overrideForCli = false, sdk = undefined, console: showConsole, }) => {
    let client = !sdk ? await sdkForConsole() : sdk;
...
export const projectsCreateKey = async ({ projectId, name, scopes, expire, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForConsole() : sdk;
    let apiPath = "/projects/{projectId}/keys".replace("{projectId}", projectId);
    let payload = {};
    if (typeof name !== "undefined") {
...
export const projectsGetKey = async ({ projectId, keyId, parseOutput = true, overrideForCli = false, sdk = undefined, console: showConsole, }) => {
    let client = !sdk ? await sdkForConsole() : sdk;
    let apiPath = "/projects/{projectId}/keys/{keyId}"
        .replace("{projectId}", projectId)
        .replace("{keyId}", keyId);
    let payload = {};
    let response = undefined;
...
export const projectsUpdateKey = async ({ projectId, keyId, name, scopes, expire, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForConsole() : sdk;
    let apiPath = "/projects/{projectId}/keys/{keyId}"
        .replace("{projectId}", projectId)
        .replace("{keyId}", keyId);
...
export const projectsDeleteKey = async ({ projectId, keyId, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForConsole() : sdk;
    let apiPath = "/projects/{projectId}/keys/{keyId}"
        .replace("{projectId}", projectId)
        .replace("{keyId}", keyId);
...
export const projectsUpdateOAuth2 = async ({ projectId, provider, appId, secret, enabled, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForConsole() : sdk;
...
export const projectsListPlatforms = async ({ projectId, total, parseOutput = true, overrideForCli = false, sdk = undefined, console: showConsole, }) => {
    let client = !sdk ? await sdkForConsole() : sdk;
...
export const projectsCreatePlatform = async ({ projectId, type, name, key, store, hostname, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForConsole() : sdk;
    let apiPath = "/projects/{projectId}/platforms".replace("{projectId}", projectId);
    let payload = {};
...
export const projectsGetPlatform = async ({ projectId, platformId, parseOutput = true, overrideForCli = false, sdk = undefined, console: showConsole, }) => {
    let client = !sdk ? await sdkForConsole() : sdk;
    let apiPath = "/projects/{projectId}/platforms/{platformId}"
        .replace("{projectId}", projectId)
...
export const projectsUpdatePlatform = async ({ projectId, platformId, name, key, store, hostname, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForConsole() : sdk;
    let apiPath = "/projects/{projectId}/platforms/{platformId}"
        .replace("{projectId}", projectId)
        .replace("{platformId}", platformId);
...
export const projectsDeletePlatform = async ({ projectId, platformId, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForConsole() : sdk;
    let apiPath = "/projects/{projectId}/platforms/{platformId}"
        .replace("{projectId}", projectId)
        .replace("{platformId}", platformId);
...
export const projectsUpdateServiceStatus = async ({ projectId, service, status, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForConsole() : sdk;
...
export const projectsUpdateServiceStatusAll = async ({ projectId, status, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForConsole() : sdk;
...
export const projectsUpdateSMTP = async ({ projectId, enabled, senderName, senderEmail, replyTo, host, port, username, password, secure, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForConsole() : sdk;
...
export const projectsCreateSMTPTest = async ({ projectId, emails, senderName, senderEmail, host, replyTo, port, username, password, secure, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForConsole() : sdk;
...
export const projectsUpdateTeam = async ({ projectId, teamId, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForConsole() : sdk;
...
export const projectsGetEmailTemplate = async ({ projectId, type, locale, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForConsole() : sdk;
    let apiPath = "/projects/{projectId}/templates/email/{type}/{locale}"
        .replace("{projectId}", projectId)
        .replace("{type}", type)
...
export const projectsUpdateEmailTemplate = async ({ projectId, type, locale, subject, message, senderName, senderEmail, replyTo, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForConsole() : sdk;
    let apiPath = "/projects/{projectId}/templates/email/{type}/{locale}"
        .replace("{projectId}", projectId)
        .replace("{type}", type)
...
export const projectsDeleteEmailTemplate = async ({ projectId, type, locale, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForConsole() : sdk;
    let apiPath = "/projects/{projectId}/templates/email/{type}/{locale}"
        .replace("{projectId}", projectId)
        .replace("{type}", type)
...
export const projectsGetSMSTemplate = async ({ projectId, type, locale, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForConsole() : sdk;
    let apiPath = "/projects/{projectId}/templates/sms/{type}/{locale}"
        .replace("{projectId}", projectId)
        .replace("{type}", type)
        .replace("{locale}", locale);
    let payload = {};
...
export const projectsUpdateSMSTemplate = async ({ projectId, type, locale, message, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForConsole() : sdk;
    let apiPath = "/projects/{projectId}/templates/sms/{type}/{locale}"
        .replace("{projectId}", projectId)
        .replace("{type}", type)
...
export const projectsDeleteSMSTemplate = async ({ projectId, type, locale, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForConsole() : sdk;
    let apiPath = "/projects/{projectId}/templates/sms/{type}/{locale}"
        .replace("{projectId}", projectId)
        .replace("{type}", type)
...
export const projectsListWebhooks = async ({ projectId, total, parseOutput = true, overrideForCli = false, sdk = undefined, console: showConsole, }) => {
    let client = !sdk ? await sdkForConsole() : sdk;
...
export const projectsCreateWebhook = async ({ projectId, name, events, url, security, enabled, httpUser, httpPass, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForConsole() : sdk;
    let apiPath = "/projects/{projectId}/webhooks".replace("{projectId}", projectId);
    let payload = {};
    if (typeof name !== "undefined") {
...
export const projectsGetWebhook = async ({ projectId, webhookId, parseOutput = true, overrideForCli = false, sdk = undefined, console: showConsole, }) => {
    let client = !sdk ? await sdkForConsole() : sdk;
    let apiPath = "/projects/{projectId}/webhooks/{webhookId}"
        .replace("{projectId}", projectId)
...
export const projectsUpdateWebhook = async ({ projectId, webhookId, name, events, url, security, enabled, httpUser, httpPass, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForConsole() : sdk;
    let apiPath = "/projects/{projectId}/webhooks/{webhookId}"
        .replace("{projectId}", projectId)
        .replace("{webhookId}", webhookId);
...
export const projectsDeleteWebhook = async ({ projectId, webhookId, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForConsole() : sdk;
    let apiPath = "/projects/{projectId}/webhooks/{webhookId}"
        .replace("{projectId}", projectId)
        .replace("{webhookId}", webhookId);
...
export const projectsUpdateWebhookSignature = async ({ projectId, webhookId, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForConsole() : sdk;
    let apiPath = "/projects/{projectId}/webhooks/{webhookId}/signature"
        .replace("{projectId}", projectId)
        .replace("{webhookId}", webhookId);
    let payload = {};
    let response = undefined;
