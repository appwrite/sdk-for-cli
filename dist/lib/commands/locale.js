...
import { Locale as LocaleService } from "@appwrite.io/console";
let localeClient = null;
const getLocaleClient = async () => {
    if (!localeClient) {
        const projectClient = await sdkForProject();
        localeClient = new LocaleService(projectClient);
    }
    return localeClient;
};
...
locale
    ...
    .action(actionRunner(async () => await (await getLocaleClient()).listCodes()));
locale
    ...
    .action(actionRunner(async () => await (await getLocaleClient()).listContinents()));
locale
    ...
    .action(actionRunner(async () => await (await getLocaleClient()).listCountries()));
locale
    ...
    .action(actionRunner(async () => await (await getLocaleClient()).listCountriesEU()));
locale
    ...
    .action(actionRunner(async () => await (await getLocaleClient()).listCountriesPhones()));
locale
    ...
    .action(actionRunner(async () => await (await getLocaleClient()).listCurrencies()));
locale
    ...
    .action(actionRunner(async () => await (await getLocaleClient()).listLanguages()));
