...
export const sitesList = async ({ queries, search, total, parseOutput = true, overrideForCli = false, sdk = undefined, console: showConsole, }) => {
...
export const sitesListFrameworks = async ({ parseOutput = true, overrideForCli = false, sdk = undefined, console: showConsole, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
...
export const sitesListSpecifications = async ({ parseOutput = true, overrideForCli = false, sdk = undefined, console: showConsole, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
...
export const sitesListTemplates = async ({ frameworks, useCases, limit, offset, parseOutput = true, overrideForCli = false, sdk = undefined, console: showConsole, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
...
export const sitesGetTemplate = async ({ templateId, parseOutput = true, overrideForCli = false, sdk = undefined, console: showConsole, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
...
export const sitesListUsage = async ({ range, parseOutput = true, overrideForCli = false, sdk = undefined, console: showConsole, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
...
export const sitesGet = async ({ siteId, parseOutput = true, overrideForCli = false, sdk = undefined, console: showConsole, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
...
export const sitesDelete = async ({ siteId, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
    let apiPath = "/sites/{siteId}".replace("{siteId}", siteId);
    let payload = {};
    let response = undefined;
...
export const sitesUpdateSiteDeployment = async ({ siteId, deploymentId, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
...
export const sitesListDeployments = async ({ siteId, queries, search, total, parseOutput = true, overrideForCli = false, sdk = undefined, console: showConsole, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
...
export const sitesCreateDeployment = async ({ siteId, code, activate, installCommand, buildCommand, outputDirectory, parseOutput = true, overrideForCli = false, sdk = undefined, onProgress = (progress) => { }, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
    let apiPath = "/sites/{siteId}/deployments".replace("{siteId}", siteId);
    let payload = {};
    if (typeof installCommand !== "undefined") {
...
export const sitesCreateDuplicateDeployment = async ({ siteId, deploymentId, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
...
export const sitesCreateTemplateDeployment = async ({ siteId, repository, owner, rootDirectory, type, reference, activate, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
...
export const sitesCreateVcsDeployment = async ({ siteId, type, reference, activate, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
...
export const sitesGetDeployment = async ({ siteId, deploymentId, parseOutput = true, overrideForCli = false, sdk = undefined, console: showConsole, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
    let apiPath = "/sites/{siteId}/deployments/{deploymentId}"
...
export const sitesDeleteDeployment = async ({ siteId, deploymentId, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
    let apiPath = "/sites/{siteId}/deployments/{deploymentId}"
        .replace("{siteId}", siteId)
        .replace("{deploymentId}", deploymentId);
...
export const sitesGetDeploymentDownload = async ({ siteId, deploymentId, type, parseOutput = true, overrideForCli = false, sdk = undefined, destination, console: showConsole, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
    let apiPath = "/sites/{siteId}/deployments/{deploymentId}/download"
        .replace("{siteId}", siteId)
        .replace("{deploymentId}", deploymentId);
    let payload = {};
    if (typeof type !== "undefined") {
...
export const sitesUpdateDeploymentStatus = async ({ siteId, deploymentId, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
    let apiPath = "/sites/{siteId}/deployments/{deploymentId}/status"
        .replace("{siteId}", siteId)
        .replace("{deploymentId}", deploymentId);
    let payload = {};
    let response = undefined;
...
export const sitesListLogs = async ({ siteId, queries, total, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
...
export const sitesGetLog = async ({ siteId, logId, parseOutput = true, overrideForCli = false, sdk = undefined, console: showConsole, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
    let apiPath = "/sites/{siteId}/logs/{logId}"
        .replace("{siteId}", siteId)
        .replace("{logId}", logId);
    let payload = {};
    let response = undefined;
...
export const sitesDeleteLog = async ({ siteId, logId, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
    let apiPath = "/sites/{siteId}/logs/{logId}"
        .replace("{siteId}", siteId)
        .replace("{logId}", logId);
...
export const sitesGetUsage = async ({ siteId, range, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
...
export const sitesListVariables = async ({ siteId, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
...
export const sitesCreateVariable = async ({ siteId, key, value, secret, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
    let apiPath = "/sites/{siteId}/variables".replace("{siteId}", siteId);
    let payload = {};
...
export const sitesGetVariable = async ({ siteId, variableId, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
    let apiPath = "/sites/{siteId}/variables/{variableId}"
        .replace("{siteId}", siteId)
...
export const sitesUpdateVariable = async ({ siteId, variableId, key, value, secret, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
    let apiPath = "/sites/{siteId}/variables/{variableId}"
        .replace("{siteId}", siteId)
        .replace("{variableId}", variableId);
...
export const sitesDeleteVariable = async ({ siteId, variableId, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
    let apiPath = "/sites/{siteId}/variables/{variableId}"
        .replace("{siteId}", siteId)
        .replace("{variableId}", variableId);
