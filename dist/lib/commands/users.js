...
export const usersList = async ({ queries, search, total, parseOutput = true, overrideForCli = false, sdk = undefined, console: showConsole, }) => {
...
export const usersCreate = async ({ userId, email, phone, password, name, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
    let apiPath = "/users";
    let payload = {};
...
export const usersCreateArgon2User = async ({ userId, email, password, name, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
...
export const usersCreateBcryptUser = async ({ userId, email, password, name, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
...
export const usersListIdentities = async ({ queries, search, total, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
...
export const usersDeleteIdentity = async ({ identityId, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
...
export const usersCreateMD5User = async ({ userId, email, password, name, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
...
export const usersCreatePHPassUser = async ({ userId, email, password, name, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
...
export const usersCreateScryptUser = async ({ userId, email, password, passwordSalt, passwordCpu, passwordMemory, passwordParallel, passwordLength, name, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
...
export const usersCreateScryptModifiedUser = async ({ userId, email, password, passwordSalt, passwordSaltSeparator, passwordSignerKey, name, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
...
export const usersCreateSHAUser = async ({ userId, email, password, passwordVersion, name, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
...
export const usersGetUsage = async ({ range, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
...
export const usersGet = async ({ userId, parseOutput = true, overrideForCli = false, sdk = undefined, console: showConsole, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
...
export const usersDelete = async ({ userId, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
    let apiPath = "/users/{userId}".replace("{userId}", userId);
    let payload = {};
    let response = undefined;
...
export const usersUpdateEmail = async ({ userId, email, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
...
export const usersCreateJWT = async ({ userId, sessionId, duration, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
...
export const usersUpdateLabels = async ({ userId, labels, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
...
export const usersListLogs = async ({ userId, queries, total, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
...
export const usersListMemberships = async ({ userId, queries, search, total, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
...
export const usersUpdateMFA = async ({ userId, mfa, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
...
export const usersDeleteMFAAuthenticator = async ({ userId, type, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
    let apiPath = "/users/{userId}/mfa/authenticators/{type}"
...
export const usersListMFAFactors = async ({ userId, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
...
export const usersGetMFARecoveryCodes = async ({ userId, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
...
export const usersUpdateMFARecoveryCodes = async ({ userId, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
    let apiPath = "/users/{userId}/mfa/recovery-codes".replace("{userId}", userId);
    let payload = {};
    let response = undefined;
...
export const usersCreateMFARecoveryCodes = async ({ userId, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
    let apiPath = "/users/{userId}/mfa/recovery-codes".replace("{userId}", userId);
    let payload = {};
    let response = undefined;
...
export const usersUpdateName = async ({ userId, name, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
...
export const usersUpdatePassword = async ({ userId, password, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
...
export const usersUpdatePhone = async ({ userId, number, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
...
export const usersGetPrefs = async ({ userId, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
...
export const usersUpdatePrefs = async ({ userId, prefs, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
    let apiPath = "/users/{userId}/prefs".replace("{userId}", userId);
    let payload = {};
...
export const usersListSessions = async ({ userId, total, parseOutput = true, overrideForCli = false, sdk = undefined, console: showConsole, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
...
export const usersCreateSession = async ({ userId, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
    let apiPath = "/users/{userId}/sessions".replace("{userId}", userId);
    let payload = {};
    let response = undefined;
...
export const usersDeleteSessions = async ({ userId, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
    let apiPath = "/users/{userId}/sessions".replace("{userId}", userId);
    let payload = {};
    let response = undefined;
...
export const usersDeleteSession = async ({ userId, sessionId, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
    let apiPath = "/users/{userId}/sessions/{sessionId}"
        .replace("{userId}", userId)
...
export const usersUpdateStatus = async ({ userId, status, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
...
export const usersListTargets = async ({ userId, queries, total, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
...
export const usersCreateTarget = async ({ userId, targetId, providerType, identifier, providerId, name, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
    let apiPath = "/users/{userId}/targets".replace("{userId}", userId);
    let payload = {};
...
export const usersGetTarget = async ({ userId, targetId, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
    let apiPath = "/users/{userId}/targets/{targetId}"
        .replace("{userId}", userId)
...
export const usersUpdateTarget = async ({ userId, targetId, identifier, providerId, name, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
    let apiPath = "/users/{userId}/targets/{targetId}"
        .replace("{userId}", userId)
        .replace("{targetId}", targetId);
...
export const usersDeleteTarget = async ({ userId, targetId, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
    let apiPath = "/users/{userId}/targets/{targetId}"
        .replace("{userId}", userId)
        .replace("{targetId}", targetId);
...
export const usersCreateToken = async ({ userId, length, expire, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
...
export const usersUpdateEmailVerification = async ({ userId, emailVerification, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
...
export const usersUpdatePhoneVerification = async ({ userId, phoneVerification, parseOutput = true, overrideForCli = false, sdk = undefined, }) => {
    let client = !sdk ? await sdkForProject() : sdk;
