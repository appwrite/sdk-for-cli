...
vcs
    ...
    .action(actionRunner(async ({ installationId, providerRepositoryId, xType, providerRootDirectory, }) => await (await getVcsClient()).createRepositoryDetection(installationId, providerRepositoryId, xType, providerRootDirectory)));
vcs
    ...
    .action(actionRunner(async ({ installationId, xType, search, queries }) => await (await getVcsClient()).listRepositories(installationId, xType, search, queries)));
vcs
    ...
    .requiredOption(`--private <private>`, `Mark repository public or private`, parseBool)
