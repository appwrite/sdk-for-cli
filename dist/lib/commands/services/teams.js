...
teams
    ...
    .action(actionRunner(async ({ teamId, name, roles }) => await (await getTeamsClient()).create(teamId, name, roles)));
teams
    .command(`get`)
...
`)
    ...
    .action(actionRunner(async ({ teamId, email, userId, phone, roles, url, name }) => await (await getTeamsClient()).createMembership(teamId, email, userId, phone, roles, url, name)));
teams
...
`)
    ...
    .action(actionRunner(async ({ teamId, membershipId, roles }) => await (await getTeamsClient()).updateMembership(teamId, membershipId, roles)));
teams
