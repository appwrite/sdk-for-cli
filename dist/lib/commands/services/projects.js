...
projects
    ...
    .action(actionRunner(async ({ queries, search, total }) => await (await getProjectsClient()).list(queries, search, total)));
projects
    .command(`create`)
    ...
    .action(actionRunner(async ({ projectId, name, teamId, region, description, logo, url, legalName, legalCountry, legalState, legalCity, legalAddress, legalTaxId, }) => await (await getProjectsClient()).create(projectId, name, teamId, region, description, logo, url, legalName, legalCountry, legalState, legalCity, legalAddress, legalTaxId)));
projects
    .command(`get`)
    ...
    .action(actionRunner(async ({ projectId }) => await (await getProjectsClient()).get(projectId)));
projects
    .command(`update`)
    ...
    .option(`--legal-address <legal-address>`, `Project legal address. Max length: 256 chars.`)
    .option(`--legal-tax-id <legal-tax-id>`, `Project legal tax ID. Max length: 256 chars.`)
    .action(actionRunner(async ({ projectId, name, description, logo, url, legalName, legalCountry, legalState, legalCity, legalAddress, legalTaxId, }) => await (await getProjectsClient()).update(projectId, name, description, logo, url, legalName, legalCountry, legalState, legalCity, legalAddress, legalTaxId)));
projects
    .command(`delete`)
    .description(`Delete a project by its unique ID.`)
    .requiredOption(`--project-id <project-id>`, `Project unique ID.`)
    .action(actionRunner(async ({ projectId }) => await (await getProjectsClient()).delete(projectId)));
projects
    .command(`update-api-status`)
    .description(`[**DEPRECATED** - This command is deprecated. Please use 'projects updateApiStatus' instead] Update the status of a specific API type. Use this endpoint to enable or disable API types such as REST, GraphQL and Realtime.`)
    .requiredOption(`--project-id <project-id>`, `Project unique ID.`)
    .requiredOption(`--api <api>`, `API name.`)
    .requiredOption(`--status <status>`, `API status.`, parseBool)
    .action(actionRunner(async ({ projectId, api, status }) => await (await getProjectsClient()).updateApiStatus(projectId, api, status)));
projects
    .command(`update-api-status-all`)
    .description(`[**DEPRECATED** - This command is deprecated. Please use 'projects updateApiStatusAll' instead] Update the status of all API types. Use this endpoint to enable or disable API types such as REST, GraphQL and Realtime all at once.`)
    .requiredOption(`--project-id <project-id>`, `Project unique ID.`)
    .requiredOption(`--status <status>`, `API status.`, parseBool)
    .action(actionRunner(async ({ projectId, status }) => await (await getProjectsClient()).updateApiStatusAll(projectId, status)));
projects
    ...
    .action(actionRunner(async ({ projectId, duration }) => await (await getProjectsClient()).updateAuthDuration(projectId, duration)));
projects
    ...
    .action(actionRunner(async ({ projectId, limit }) => await (await getProjectsClient()).updateAuthLimit(projectId, limit)));
projects
    ...
    .action(actionRunner(async ({ projectId, limit }) => await (await getProjectsClient()).updateAuthSessionsLimit(projectId, limit)));
projects
    ...
    .action(actionRunner(async ({ projectId, userName, userEmail, mfa }) => await (await getProjectsClient()).updateMembershipsPrivacy(projectId, userName, userEmail, mfa)));
projects
    ...
    .action(actionRunner(async ({ projectId, numbers }) => await (await getProjectsClient()).updateMockNumbers(projectId, numbers)));
projects
    ...
    .action(actionRunner(async ({ projectId, enabled }) => await (await getProjectsClient()).updateAuthPasswordDictionary(projectId, enabled)));
projects
    ...
    .action(actionRunner(async ({ projectId, limit }) => await (await getProjectsClient()).updateAuthPasswordHistory(projectId, limit)));
projects
    ...
    .action(actionRunner(async ({ projectId, enabled }) => await (await getProjectsClient()).updatePersonalDataCheck(projectId, enabled)));
projects
    ...
    .action(actionRunner(async ({ projectId, alerts }) => await (await getProjectsClient()).updateSessionAlerts(projectId, alerts)));
projects
    ...
    .action(actionRunner(async ({ projectId, enabled }) => await (await getProjectsClient()).updateSessionInvalidation(projectId, enabled)));
projects
    ...
    .action(actionRunner(async ({ projectId, method, status }) => await (await getProjectsClient()).updateAuthStatus(projectId, method, status)));
projects
    ...
    .action(actionRunner(async ({ projectId, queries }) => await (await getProjectsClient()).listDevKeys(projectId, queries)));
projects
    ...
    .action(actionRunner(async ({ projectId, name, expire }) => await (await getProjectsClient()).createDevKey(projectId, name, expire)));
projects
    .command(`get-dev-key`)
    ...
    .action(actionRunner(async ({ projectId, keyId }) => await (await getProjectsClient()).getDevKey(projectId, keyId)));
projects
    ...
    .requiredOption(`--name <name>`, `Key name. Max length: 128 chars.`)
    .requiredOption(`--expire <expire>`, `Expiration time in [ISO 8601](https://www.iso.org/iso-8601-date-and-time-format.html) format.`)
    .action(actionRunner(async ({ projectId, keyId, name, expire }) => await (await getProjectsClient()).updateDevKey(projectId, keyId, name, expire)));
projects
    ...
    .requiredOption(`--project-id <project-id>`, `Project unique ID.`)
    .requiredOption(`--key-id <key-id>`, `Key unique ID.`)
    .action(actionRunner(async ({ projectId, keyId }) => await (await getProjectsClient()).deleteDevKey(projectId, keyId)));
projects
    .command(`create-jwt`)
    ...
    .action(actionRunner(async ({ projectId, scopes, duration }) => await (await getProjectsClient()).createJWT(projectId, scopes, duration)));
projects
    .command(`list-keys`)
    .description(`Get a list of all API keys from the current project. `)
    .requiredOption(`--project-id <project-id>`, `Project unique ID.`)
    .option(`--total [value]`, `When set to false, the total count returned will be 0 and will not be calculated.`, (value) => value === undefined ? true : parseBool(value))
    .action(actionRunner(async ({ projectId, total }) => await (await getProjectsClient()).listKeys(projectId, total)));
projects
    .command(`create-key`)
    ...
    .action(actionRunner(async ({ projectId, name, scopes, expire }) => await (await getProjectsClient()).createKey(projectId, name, scopes, expire)));
projects
    .command(`get-key`)
    ...
    .requiredOption(`--project-id <project-id>`, `Project unique ID.`)
    .requiredOption(`--key-id <key-id>`, `Key unique ID.`)
    .action(actionRunner(async ({ projectId, keyId }) => await (await getProjectsClient()).getKey(projectId, keyId)));
projects
    .command(`update-key`)
    ...
    .option(`--expire <expire>`, `Expiration time in [ISO 8601](https://www.iso.org/iso-8601-date-and-time-format.html) format. Use null for unlimited expiration.`)
    .action(actionRunner(async ({ projectId, keyId, name, scopes, expire }) => await (await getProjectsClient()).updateKey(projectId, keyId, name, scopes, expire)));
projects
    .command(`delete-key`)
    .description(`Delete a key by its unique ID. Once deleted, the key can no longer be used to authenticate API calls. `)
    .requiredOption(`--project-id <project-id>`, `Project unique ID.`)
    .requiredOption(`--key-id <key-id>`, `Key unique ID.`)
    .action(actionRunner(async ({ projectId, keyId }) => await (await getProjectsClient()).deleteKey(projectId, keyId)));
projects
    ...
    .action(actionRunner(async ({ projectId, provider, appId, secret, enabled }) => await (await getProjectsClient()).updateOAuth2(projectId, provider, appId, secret, enabled)));
projects
    ...
    .requiredOption(`--project-id <project-id>`, `Project unique ID.`)
    .option(`--total [value]`, `When set to false, the total count returned will be 0 and will not be calculated.`, (value) => value === undefined ? true : parseBool(value))
    .action(actionRunner(async ({ projectId, total }) => await (await getProjectsClient()).listPlatforms(projectId, total)));
projects
    ...
    .action(actionRunner(async ({ projectId, xType, name, key, store, hostname }) => await (await getProjectsClient()).createPlatform(projectId, xType, name, key, store, hostname)));
projects
    ...
    .action(actionRunner(async ({ projectId, platformId }) => await (await getProjectsClient()).getPlatform(projectId, platformId)));
projects
    ...
    .action(actionRunner(async ({ projectId, platformId, name, key, store, hostname }) => await (await getProjectsClient()).updatePlatform(projectId, platformId, name, key, store, hostname)));
projects
    ...
    .requiredOption(`--project-id <project-id>`, `Project unique ID.`)
    .requiredOption(`--platform-id <platform-id>`, `Platform unique ID.`)
    .action(actionRunner(async ({ projectId, platformId }) => await (await getProjectsClient()).deletePlatform(projectId, platformId)));
projects
    ...
    .action(actionRunner(async ({ projectId, service, status }) => await (await getProjectsClient()).updateServiceStatus(projectId, service, status)));
projects
    ...
    .requiredOption(`--project-id <project-id>`, `Project unique ID.`)
    .requiredOption(`--status <status>`, `Service status.`, parseBool)
    .action(actionRunner(async ({ projectId, status }) => await (await getProjectsClient()).updateServiceStatusAll(projectId, status)));
projects
    .command(`update-smtp`)
    .description(`[**DEPRECATED** - This command is deprecated. Please use 'projects updateSmtp' instead] Update the SMTP configuration for your project. Use this endpoint to configure your project's SMTP provider with your custom settings for sending transactional emails. `)
    .requiredOption(`--project-id <project-id>`, `Project unique ID.`)
    ...
    .action(actionRunner(async ({ projectId, enabled, senderName, senderEmail, replyTo, host, port, username, password, secure, }) => await (await getProjectsClient()).updateSmtp(projectId, enabled, senderName, senderEmail, replyTo, host, port, username, password, secure)));
projects
    .command(`create-smtp-test`)
    .description(`[**DEPRECATED** - This command is deprecated. Please use 'projects createSmtpTest' instead] Send a test email to verify SMTP configuration. `)
    .requiredOption(`--project-id <project-id>`, `Project unique ID.`)
    ...
    .option(`--password <password>`, `SMTP server password`)
    .option(`--secure <secure>`, `Does SMTP server use secure connection`)
    .action(actionRunner(async ({ projectId, emails, senderName, senderEmail, replyTo, host, port, username, password, secure, }) => await (await getProjectsClient()).createSmtpTest(projectId, emails, senderName, senderEmail, replyTo, host, port, username, password, secure)));
projects
    .command(`update-team`)
    ...
    .action(actionRunner(async ({ projectId, teamId }) => await (await getProjectsClient()).updateTeam(projectId, teamId)));
projects
    ...
    .action(actionRunner(async ({ projectId, xType, locale }) => await (await getProjectsClient()).getEmailTemplate(projectId, xType, locale)));
projects
    ...
    .option(`--sender-email <sender-email>`, `Email of the sender`)
    .option(`--reply-to <reply-to>`, `Reply to email`)
    .action(actionRunner(async ({ projectId, xType, locale, subject, message, senderName, senderEmail, replyTo, }) => await (await getProjectsClient()).updateEmailTemplate(projectId, xType, locale, subject, message, senderName, senderEmail, replyTo)));
projects
    ...
    .requiredOption(`--type <type>`, `Template type`)
    .requiredOption(`--locale <locale>`, `Template locale`)
    .action(actionRunner(async ({ projectId, xType, locale }) => await (await getProjectsClient()).deleteEmailTemplate(projectId, xType, locale)));
projects
    .command(`get-sms-template`)
    .description(`[**DEPRECATED** - This command is deprecated. Please use 'projects getSmsTemplate' instead] Get a custom SMS template for the specified locale and type returning it's contents.`)
    .requiredOption(`--project-id <project-id>`, `Project unique ID.`)
    .requiredOption(`--type <type>`, `Template type`)
    .requiredOption(`--locale <locale>`, `Template locale`)
    .action(actionRunner(async ({ projectId, xType, locale }) => await (await getProjectsClient()).getSmsTemplate(projectId, xType, locale)));
projects
    .command(`update-sms-template`)
    .description(`[**DEPRECATED** - This command is deprecated. Please use 'projects updateSmsTemplate' instead] Update a custom SMS template for the specified locale and type. Use this endpoint to modify the content of your SMS templates. `)
    .requiredOption(`--project-id <project-id>`, `Project unique ID.`)
    .requiredOption(`--type <type>`, `Template type`)
    .requiredOption(`--locale <locale>`, `Template locale`)
    .requiredOption(`--message <message>`, `Template message`)
    .action(actionRunner(async ({ projectId, xType, locale, message }) => await (await getProjectsClient()).updateSmsTemplate(projectId, xType, locale, message)));
projects
    .command(`delete-sms-template`)
    .description(`[**DEPRECATED** - This command is deprecated. Please use 'projects deleteSmsTemplate' instead] Reset a custom SMS template to its default value. This endpoint removes any custom message and restores the template to its original state. `)
    .requiredOption(`--project-id <project-id>`, `Project unique ID.`)
    .requiredOption(`--type <type>`, `Template type`)
    .requiredOption(`--locale <locale>`, `Template locale`)
    .action(actionRunner(async ({ projectId, xType, locale }) => await (await getProjectsClient()).deleteSmsTemplate(projectId, xType, locale)));
projects
    ...
    .requiredOption(`--project-id <project-id>`, `Project unique ID.`)
    .option(`--total [value]`, `When set to false, the total count returned will be 0 and will not be calculated.`, (value) => value === undefined ? true : parseBool(value))
    .action(actionRunner(async ({ projectId, total }) => await (await getProjectsClient()).listWebhooks(projectId, total)));
projects
    ...
    .action(actionRunner(async ({ projectId, name, enabled, events, url, security, httpUser, httpPass, }) => await (await getProjectsClient()).createWebhook(projectId, name, enabled, events, url, security, httpUser, httpPass)));
projects
    .command(`get-webhook`)
    ...
    .action(actionRunner(async ({ projectId, webhookId }) => await (await getProjectsClient()).getWebhook(projectId, webhookId)));
projects
    ...
    .option(`--http-user <http-user>`, `Webhook HTTP user. Max length: 256 chars.`)
    .option(`--http-pass <http-pass>`, `Webhook HTTP password. Max length: 256 chars.`)
    .action(actionRunner(async ({ projectId, webhookId, name, enabled, events, url, security, httpUser, httpPass, }) => await (await getProjectsClient()).updateWebhook(projectId, webhookId, name, enabled, events, url, security, httpUser, httpPass)));
projects
    ...
    .requiredOption(`--project-id <project-id>`, `Project unique ID.`)
    .requiredOption(`--webhook-id <webhook-id>`, `Webhook unique ID.`)
    .action(actionRunner(async ({ projectId, webhookId }) => await (await getProjectsClient()).deleteWebhook(projectId, webhookId)));
projects
    ...
    .requiredOption(`--project-id <project-id>`, `Project unique ID.`)
    .requiredOption(`--webhook-id <webhook-id>`, `Webhook unique ID.`)
    .action(actionRunner(async ({ projectId, webhookId }) => await (await getProjectsClient()).updateWebhookSignature(projectId, webhookId)));
