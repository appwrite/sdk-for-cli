...
import { LanguageMeta, detectLanguage, } from "../type-generation/languages/language.js";
...
const typesOutputArgument = new Argument("<output-directory>", "The directory to write the types to");
const typesLanguageOption = new Option("-l, --language <language>", "The language of the types")
    .choices(["auto", "ts", "js", "php", "kotlin", "swift", "java", "dart", "cs"])
    .default("auto");
const typesStrictOption = new Option("-s, --strict", "Enable strict mode to automatically convert field names to follow language conventions").default(false);
