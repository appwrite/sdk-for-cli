...
# REPO
$GITHUB_x64_URL = "https://github.com/appwrite/sdk-for-cli/releases/download/4.2.0-rc.1/appwrite-cli-win-x64.exe"
$GITHUB_arm64_URL = "https://github.com/appwrite/sdk-for-cli/releases/download/4.2.0-rc.1/appwrite-cli-win-arm64.exe"
