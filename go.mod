module github.com/appwrite/sdk-for-cli
...
// Floor raised above the v1.3.6 huh v1.0.0 asks for, which misrepaints on resize.
require github.com/charmbracelet/bubbletea v1.3.10 // indirect
